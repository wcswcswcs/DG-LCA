"""Optimizer-owned wrapper for state-coupled functional geometry FU."""
...
class SCFGOptimizerWrapper:
    ...
    def diagnostics(self) -> dict[str, Any]:
        out = {
            ...
            "scfg_wrapper_step_calls": self.step_called,
            "scfg_wrapper_gradient_transform_calls": self.gradient_transform_inside_step_called,
