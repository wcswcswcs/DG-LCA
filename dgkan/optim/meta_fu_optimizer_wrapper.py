"""Optimizer-owned wrapper for Meta-FU gradient transforms."""
...
class MetaFUOptimizerWrapper:
    ...
    def diagnostics(self) -> dict[str, Any]:
        out = {
            ...
            "metafu_wrapper_step_calls": self.step_called,
            "metafu_wrapper_gradient_transform_calls": self.gradient_transform_inside_step_called,
...
__all__ = ["MetaFUOptimizerWrapper"]
