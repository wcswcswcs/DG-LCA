"""Optimizer-owned wrapper for Edge-State Controlled Gradient Flow."""
...
class EdgeStateFlowOptimizerWrapper:
    """Wrap a PyTorch optimizer and transform owned edge gradients in step()."""
    ...
    def diagnostics(self) -> dict[str, Any]:
        out = {
            ...
            "escgf_wrapper_step_calls": self.step_called,
            "escgf_wrapper_gradient_transform_calls": self.gradient_transform_inside_step_called,
...
__all__ = ["EdgeStateFlowOptimizerWrapper"]
