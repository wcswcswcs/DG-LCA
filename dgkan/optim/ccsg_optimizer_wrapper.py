"""Optimizer-owned wrapper for credit-conditioned self-geometry FU."""
...
class CCSGOptimizerWrapper:
    ...
    def diagnostics(self) -> dict[str, Any]:
        out = {
            ...
            "ccsg_wrapper_step_calls": self.step_called,
            "ccsg_wrapper_gradient_transform_calls": self.gradient_transform_inside_step_called,
