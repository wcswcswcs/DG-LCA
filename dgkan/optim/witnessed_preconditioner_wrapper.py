"""Optimizer-owned wrapper for v22.56 witnessed preconditioners."""
...
class WitnessedPreconditionerWrapper:
    """Wrap a PyTorch optimizer and transform gradients only inside step()."""
    ...
    def diagnostics(self) -> dict[str, Any]:
        out = {
            ...
            "tcwp_wrapper_step_calls": self.step_called,
            "tcwp_wrapper_gradient_transform_calls": self.gradient_transform_inside_step_called,
...
__all__ = ["WitnessedPreconditionerWrapper"]
