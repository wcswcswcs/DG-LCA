"""Optimizer-owned wrapper for edge generator dynamics."""
...
class EdgeGeneratorOptimizerWrapper:
    ...
    def diagnostics(self) -> dict[str, Any]:
        out = {
            ...
            "egd_wrapper_step_calls": self.step_called,
            "egd_wrapper_gradient_transform_calls": self.gradient_transform_inside_step_called,
...
__all__ = ["EdgeGeneratorOptimizerWrapper"]
