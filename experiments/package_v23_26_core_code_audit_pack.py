#!/usr/bin/env python3
"""Create the v23.26 core-code audit zip.

The package is source-focused: it includes the DG-KAN source tree, tests, the
v23.26 runner, the v23.26 plan/log/recap docs, and dependency hints. It does
not include generated result matrices, datasets, checkpoints, or older audit
archives.
"""
...
INCLUDE_FILES = (
    ...
    "experiments/package_v23_26_core_code_audit_pack.py",
    "requirement.txt",
)
...
def main() -> int:
    ...
    if not files:
        raise RuntimeError("No files selected for the v23.26 core-code audit package.")
