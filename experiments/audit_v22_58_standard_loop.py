#!/usr/bin/env python3
"""Static and runtime audit helpers for v22.58 standard training loops."""
...
OFFICIAL_FILES = [
    ROOT / "dgkan/fu/state_coupled_functional_geometry_operator.py",
    ROOT / "dgkan/optim/scfg_optimizer_wrapper.py",
    ROOT / "experiments/run_v22_58_state_coupled_functional_geometry_fu.py",
]
