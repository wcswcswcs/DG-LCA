#!/usr/bin/env python3
"""Static and runtime audit helpers for v22.61 standard training loops."""
...
OFFICIAL_FILES = [
    ROOT / "dgkan/fu/meta_fu_operator_mixture.py",
    ROOT / "dgkan/optim/meta_fu_optimizer_wrapper.py",
    ROOT / "experiments/run_v22_61_meta_fu_oracle_ceiling_operator_mixture.py",
]
