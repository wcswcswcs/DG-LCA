#!/usr/bin/env python3
"""Static and runtime audit helpers for v22.56 standard training loops."""
...
OFFICIAL_FILES = [
    ROOT / "dgkan/fu/witnessed_preconditioner_operator.py",
    ROOT / "dgkan/optim/witnessed_preconditioner_wrapper.py",
    ROOT / "experiments/run_v22_56_task_compatible_witnessed_preconditioner_fu.py",
]
