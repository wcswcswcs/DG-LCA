#!/usr/bin/env python3
"""Create the v23.27 core-code audit zip.

The package is source-focused: it includes the DG-KAN source tree, tests, the
v23.27 runner, the v23.26 runner it reuses for real data/carriers, the
v23.27/v23.26 docs needed for audit context, and dependency hints. It excludes
generated result matrices, datasets, checkpoints, and older audit archives.
"""
...
INCLUDE_FILES = (
    "experiments/run_v23_26_dche_dfou_intrinsic_radial_tangential_generator.py",
    "experiments/run_v23_27_persistent_compositional_curvature_lie_generator_fu.py",
    "experiments/package_v23_27_core_code_audit_pack.py",
    "requirement.txt",
)

INCLUDE_GLOBS = (
    "docs/DG-KAN_v23.26_*.md",
...
def main() -> int:
    ...
    if not files:
        raise RuntimeError("No files selected for the v23.27 core-code audit package.")
