#!/usr/bin/env python3
"""Static and runtime audit helpers for v22.57 standard training loops."""
...
OFFICIAL_FILES = [
    ROOT / "dgkan/fu/credit_conditioned_self_geometry_operator.py",
    ROOT / "dgkan/optim/ccsg_optimizer_wrapper.py",
    ROOT / "experiments/run_v22_57_credit_conditioned_self_geometry_fu.py",
]
