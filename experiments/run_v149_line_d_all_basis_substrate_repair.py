...
CONFIGS = [
    ...
    SubstrateConfig(
        ...
        "D-FOU",
        "D-FOU20-LowFreqIdentityResidualHealthSubstrate",
        "v16.1 low-frequency identity residual v7 multi-hypothesis substrate-only acceleration",
        output_geometry_repair="train_entropy_t085_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-FOU",
        "D-FOU16-FrequencyBandDampingSubstrate",
        "v16.1 bandwise SNR warmup v7 multi-hypothesis substrate-only acceleration",
        output_geometry_repair="train_entropy_t090_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-FOU",
        "D-FOU17-PhaseStabilityCorrectionSubstrate",
        "v16.1 phase-stable band mix v7 multi-hypothesis substrate-only acceleration",
        output_geometry_repair="train_topprob_t025_050_else100",
    ),
    SubstrateConfig(
        ...
        "D-FOU",
        "D-FOU13-FusedReadoutGradNoMaterialize-K2",
        "v16.1 no-materialize lifetime v7 multi-hypothesis substrate-only acceleration",
        output_geometry_repair="train_entropy_t080_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-FOU",
        "D-FOU19-HighFreqNoiseLeakVetoSubstrate",
        "v16.1 high-frequency quarantine v7 multi-hypothesis substrate-only acceleration",
        output_geometry_repair="train_entropy_t085_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-FOU",
        "D-FOU20-LowFreqIdentityResidualHealthSubstrate",
        "v16.2 low-frequency identity residual v8 multi-scheme substrate-only acceleration",
        output_geometry_repair="train_entropy_t085_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-FOU",
        "D-FOU16-FrequencyBandDampingSubstrate",
        "v16.2 bandwise SNR warmup v8 multi-scheme substrate-only acceleration",
        output_geometry_repair="train_entropy_t090_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-FOU",
        "D-FOU17-PhaseStabilityCorrectionSubstrate",
        "v16.2 phase-stable band mix v8 multi-scheme substrate-only acceleration",
        output_geometry_repair="train_topprob_t025_050_else100",
    ),
    SubstrateConfig(
        ...
        "D-FOU",
        "D-FOU13-FusedReadoutGradNoMaterialize-K2",
        "v16.2 no-materialize lifetime v8 multi-scheme substrate-only acceleration",
        output_geometry_repair="train_entropy_t080_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-FOU",
        "D-FOU19-HighFreqNoiseLeakVetoSubstrate",
        "v16.2 high-frequency quarantine v8 multi-scheme substrate-only acceleration",
        output_geometry_repair="train_entropy_t085_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-FOU",
        "D-FOU20-LowFreqIdentityResidualHealthSubstrate",
        "v16.2 split-consensus low-frequency metric smoke; substrate-only readback",
        output_geometry_repair="train_entropy_t090_100_else050",
    ),
    SubstrateConfig(
    ...
    SubstrateConfig(
        ...
        "D-RBF",
        "D-RBF12-CenterOccupancyRebalanceSubstrate",
        "v16.1 active-center occupancy v7 multi-hypothesis substrate-only acceleration",
        rbf_center_repair="quantile_width125",
        output_geometry_repair="train_entropy_t085_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-RBF",
        "D-RBF13-WidthConditionGuardSubstrate",
        "v16.1 width-condition guard v7 multi-hypothesis substrate-only acceleration",
        rbf_center_repair="quantile_width075",
        output_geometry_repair="train_entropy_t085_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-RBF",
        "D-RBF17-CompactCapacityK4HealthSubstrate",
        "v16.1 compact bump no-dense v7 multi-hypothesis substrate-only acceleration",
        rbf_center_repair="quantile_width125",
        output_geometry_repair="train_entropy_t090_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-RBF",
        "D-RBF17-CompactCapacityK4HealthSubstrate",
        "v16.1 Gaussian local K4 task-health v7 multi-hypothesis substrate-only acceleration",
        rbf_center_repair="quantile_width075",
        output_geometry_repair="train_topprob_t025_050_else100",
    ),
    SubstrateConfig(
        ...
        "D-RBF",
        "D-RBF13-WidthConditionGuardSubstrate",
        "v16.1 identity residual width warmup v7 multi-hypothesis substrate-only acceleration",
        rbf_center_repair="quantile_width100",
        output_geometry_repair="train_entropy_t080_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-RBF",
        "D-RBF12-CenterOccupancyRebalanceSubstrate",
        "v16.2 active-center occupancy v8 multi-scheme substrate-only acceleration",
        rbf_center_repair="quantile_width125",
        output_geometry_repair="train_entropy_t085_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-RBF",
        "D-RBF13-WidthConditionGuardSubstrate",
        "v16.2 width-condition guard v8 multi-scheme substrate-only acceleration",
        rbf_center_repair="quantile_width075",
        output_geometry_repair="train_entropy_t085_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-RBF",
        "D-RBF17-CompactCapacityK4HealthSubstrate",
        "v16.2 compact bump no-dense v8 multi-scheme substrate-only acceleration",
        rbf_center_repair="quantile_width125",
        output_geometry_repair="train_entropy_t090_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-RBF",
        "D-RBF17-CompactCapacityK4HealthSubstrate",
        "v16.2 Gaussian local K4 task-health v8 multi-scheme substrate-only acceleration",
        rbf_center_repair="quantile_width075",
        output_geometry_repair="train_topprob_t025_050_else100",
    ),
    SubstrateConfig(
        ...
        "D-RBF",
        "D-RBF12-CenterOccupancyRebalanceSubstrate",
        "v16.2 active-center second-moment v8 multi-scheme substrate-only acceleration",
        rbf_center_repair="quantile_width100",
        output_geometry_repair="train_entropy_t090_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-RBF",
        "D-RBF12-CenterOccupancyRebalanceSubstrate",
        "v16.2 split-consensus center metric smoke; substrate-only readback",
        rbf_center_repair="quantile_width125",
        output_geometry_repair="train_entropy_t085_100_else050",
    ),
    SubstrateConfig(
    ...
    SubstrateConfig(
        ...
        "D-WAV",
        "D-WAV16-SupportStableHatHealthSubstrate",
        "v16.1 triangular support v7 multi-hypothesis substrate-only acceleration",
        wavelet_support_repair="quantile_scale075",
        wavelet_role_constraint="linear_readout_grad050",
        output_geometry_repair="train_entropy_t080_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-WAV",
        "D-WAV11-ScaleEnergyBalanceSubstrate",
        "v16.1 scale occupancy v7 multi-hypothesis substrate-only acceleration",
        wavelet_support_repair="quantile_scale050",
        wavelet_role_constraint="linear_readout_grad025",
        output_geometry_repair="train_entropy_t085_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-WAV",
        "D-WAV13-LocalTailCoverageGuardSubstrate",
        "v16.1 support-overlap damping v7 multi-hypothesis substrate-only acceleration",
        wavelet_support_repair="scale075",
        wavelet_role_constraint="linear_readout_grad010",
        output_geometry_repair="train_entropy_t090_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-WAV",
        "D-WAV13-LocalTailCoverageGuardSubstrate",
        "v16.1 local tail coverage audit v7 substrate-only readback; no audit-metric direction",
        wavelet_support_repair="quantile_scale050",
        wavelet_role_constraint="linear_readout_grad010",
        output_geometry_repair="train_topprob_t020_050_else100",
    ),
    SubstrateConfig(
        ...
        "D-WAV",
        "D-WAV16-SupportStableHatHealthSubstrate",
        "v16.2 triangular support v8 multi-scheme substrate-only acceleration",
        wavelet_support_repair="quantile_scale075",
        wavelet_role_constraint="linear_readout_grad050",
        output_geometry_repair="train_entropy_t080_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-WAV",
        "D-WAV11-ScaleEnergyBalanceSubstrate",
        "v16.2 scale occupancy v8 multi-scheme substrate-only acceleration",
        wavelet_support_repair="quantile_scale050",
        wavelet_role_constraint="linear_readout_grad025",
        output_geometry_repair="train_entropy_t085_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-WAV",
        "D-WAV13-LocalTailCoverageGuardSubstrate",
        "v16.2 support-overlap damping v8 multi-scheme substrate-only acceleration",
        wavelet_support_repair="scale075",
        wavelet_role_constraint="linear_readout_grad010",
        output_geometry_repair="train_entropy_t090_100_else050",
    ),
    SubstrateConfig(
        ...
        "D-WAV",
        "D-WAV13-LocalTailCoverageGuardSubstrate",
        "v16.2 local tail coverage audit v8 substrate-only readback; no audit-metric direction",
        wavelet_support_repair="quantile_scale050",
        wavelet_role_constraint="linear_readout_grad010",
        output_geometry_repair="train_topprob_t020_050_else100",
    ),
    SubstrateConfig(
        ...
        "D-WAV",
        "D-WAV11-ScaleEnergyBalanceSubstrate",
        "v16.2 split-consensus scale metric smoke; substrate-only readback",
        wavelet_support_repair="quantile_scale050",
        wavelet_role_constraint="linear_readout_grad025",
        output_geometry_repair="train_entropy_t085_100_else050",
    ),
