...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7gj_b7gk_gainbracket_20260522T153000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.253754554275925` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8791890094349073` | `0.5961904761904762` | `0` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7845377700088826` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.9386692742528072` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8852474771587802` | `0.13` | `0` | `1` | `1` |
...
| `Rational` | `TaskBlocked` | `1.7099887397230693` | `1.233377325096253` | `False` | `True` | `family-specific fused L3 efficiency and A4 expression passed; A5 fused task triage failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7gj-RationalKAT-flashgroup-G16-h32-linearresGain16000-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `3.927593384085575` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7gj-RationalKAT-flashgroup-G16-h32-linearresGain16000-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.237961380683442` | `0.7638095238095238` | `1` | `1` | `measured` |
| `Rational` | `B7gk-RationalKAT-flashgroup-G16-h32-linearresGain14400-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.7099887397230693` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7gk-RationalKAT-flashgroup-G16-h32-linearresGain14400-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.233377325096253` | `0.7638095238095238` | `1` | `1` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7gj-RationalKAT-flashgroup-G16-h32-linearresGain16000-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7gk-RationalKAT-flashgroup-G16-h32-linearresGain14400-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `70bbefc81633` |
| `v1283_b109_auc_autopsy_trace.csv` | `1abdb34e7a1e` |
| `v1283_b109_fullstep_profile.csv` | `164773d38069` |
...
| `v1283_b109_fused_backward_correctness.csv` | `baa2febdfe83` |
| `v1283_b109_linec_coupling.csv` | `c2a3f825ac1f` |
| `v1283_b109_linec_diagnostics.csv` | `f7100d81f52d` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `a519a509f5e5` |
| `v1283_b109_task_autopsy_final.csv` | `60cd32febfee` |
| `v1283_family_component_profile.csv` | `45f0400e7fab` |
| `v1283_family_efficiency.csv` | `0babbcdbb5f0` |
| `v1283_family_expression.csv` | `3c8b16d2d9bb` |
| `v1283_family_failure_table.csv` | `8527eb64162a` |
| `v1283_family_functional_diagnostic.csv` | `625bb79a4a5e` |
