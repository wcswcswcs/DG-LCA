...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7gd_b7ge_diagrich_lowrank_20260522T044000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.304036627161001` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8208578440625525` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7971011960175282` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8604857233434022` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.81662845017896` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `ExpressionBlocked` | `1.068014010292504` | `1.105640571871841` | `False` | `True` | `family-specific fused L3 efficiency passed but A4 expression failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7gd-RationalKAT-flashgroup-G16-h32-linearresGain19200-diagPairCrossR64-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.068014010292504` | `0.8195238095238095` | `1` | `0` | `measured` |
| `Rational` | `B7gd-RationalKAT-flashgroup-G16-h32-linearresGain19200-diagPairCrossR64-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.1205328424933374` | `0.7576190476190476` | `1` | `1` | `measured` |
| `Rational` | `B7ge-RationalKAT-flashgroup-G16-h32-linearresGain19200-diagPairCrossR80-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.5037706633907961` | `0.8414285714285714` | `0` | `0` | `measured` |
| `Rational` | `B7ge-RationalKAT-flashgroup-G16-h32-linearresGain19200-diagPairCrossR80-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.105640571871841` | `0.7566666666666667` | `1` | `1` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7gd-RationalKAT-flashgroup-G16-h32-linearresGain19200-diagPairCrossR64-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7ge-RationalKAT-flashgroup-G16-h32-linearresGain19200-diagPairCrossR80-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `2c88befc5939` |
| `v1283_b109_auc_autopsy_trace.csv` | `13a727b594d2` |
| `v1283_b109_fullstep_profile.csv` | `b9918d3b58e4` |
...
| `v1283_b109_fused_backward_correctness.csv` | `eed2b44bffa9` |
| `v1283_b109_linec_coupling.csv` | `ab613100eeae` |
| `v1283_b109_linec_diagnostics.csv` | `d761ec9e77d5` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `57614d2f5eff` |
| `v1283_b109_task_autopsy_final.csv` | `445c23e1f91a` |
| `v1283_family_component_profile.csv` | `69644fb8418d` |
| `v1283_family_efficiency.csv` | `6d56e695b0d8` |
| `v1283_family_expression.csv` | `3d653c4b049d` |
| `v1283_family_failure_table.csv` | `f817713c8df7` |
| `v1283_family_functional_diagnostic.csv` | `d4ff54bd5618` |
