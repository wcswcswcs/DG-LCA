...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b244_b245_midfixedgain_20260523T022000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.1258037512708585` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7246094255775019` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6439435350306637` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.7028312986458809` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.6820647921196064` | `0.13` | `1` | `1` | `1` |
| `B244b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp110` | `B48a-existing-manual-ce-torch-reduction` | `1.0875161873042143` | `2.719047619047619` | `0` | `0` | `0` |
| `B244b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp110` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7102625103685616` | `0.5961904761904762` | `1` | `1` | `1` |
| `B244b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp110` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6500166629263028` | `0.1295238095238095` | `1` | `1` | `1` |
| `B245b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp115` | `B48a-existing-manual-ce-torch-reduction` | `1.3023239531817317` | `2.719047619047619` | `0` | `0` | `0` |
| `B245b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp115` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8102878277147613` | `0.5961904761904762` | `1` | `1` | `1` |
| `B245b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp115` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7758819447357019` | `0.1295238095238095` | `1` | `1` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `f0caa47020ff` |
| `v1283_b109_auc_autopsy_trace.csv` | `b221ab584806` |
| `v1283_b109_fullstep_profile.csv` | `b3a514d045e3` |
...
| `v1283_b109_fused_backward_correctness.csv` | `81376a9e78c2` |
| `v1283_b109_linec_coupling.csv` | `dfce3b874f3a` |
| `v1283_b109_linec_diagnostics.csv` | `8f6ab7f028d1` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `cf934913c432` |
| `v1283_b109_task_autopsy_final.csv` | `68d1038d139b` |
