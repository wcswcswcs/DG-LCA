...
```text
results/v12_5_2_efficiency_functional_manifold/smoke_v1252_simple_compiled_20260521T001500Z
```
...
5. No-fake audit rows checked = `178`，fake/proxy/cpu = `0` / `0` / `0`。
...
|---|---|---:|---:|---:|---:|
| `F0-current-B47-manual-autograd-forward` | `B47b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final050` | `10.573664397907232` | `1.0` | `0.0` | `0` |
| `F0b-current-B42-fastreuse-forward` | `B42b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-final075` | `11.618879339670116` | `1.0988507770276648` | `` | `0` |
| `K2-current-LiteGated-forward` | `B30b-LiteGatedLegendreQuadratic-h256-temp050-cosine-lr-final050` | `7.140050210710681` | `0.6752673379839689` | `` | `0` |
| `K3-SimpleFastTaskGeometry-forward` | `B48a-SimpleFastTaskGeometry-h128-temp075` | `4.127146114292622` | `0.39032316129775013` | `` | `0` |
| `K3-compiled-SimpleFastTaskGeometry-forward` | `B48a-SimpleFastTaskGeometry-h128-temp075` | `4.00980317738775` | `0.3792255008756833` | `2.384185791015625e-07` | `0` |
| `F2-triton-residual-input-norm-plus-legendre-basis` | `B47b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final050` | `1.274562061956531` | `0.1205411874249381` | `0.0009468495845794678` | `0` |
| `F3-triton-residual-input-norm-legendre-hidden-preactivation` | `B47b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final050` | `1.9186001726168889` | `0.18145082919376782` | `2.047792077064514e-05` | `0` |
| `F4-triton-hybrid-full-forward-with-torch-readouts` | `B47b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final050` | `9.745848338913863` | `0.9217096336860084` | `0.0005792379379272461` | `0` |
...
| `B47b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final050` | `5.736083216654808` | `1.9416868168641992` | `2.5360936448214044` | `1.0426508383306816` | `0` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `2.1692737622512452` | `1.0008887036504108` | `1.2204910401122377` | `1.0076693999102517` | `1` |
...
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `0.9998301432777111` | `0.9999499917030334` | `2.540525197982788` | `0.009143158793449402` |
...
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `1.2358207702636719` | `0.9724852442741394` | `0.021878404542803764` | `0.7024092674255371` |
...
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `-0.7204470904896001` | `0.27447639405727386` | `-0.994923484546874` | `0` |
...
| artifact | SHA256 |
|---|---|
| `v125_backward_kernel_truth.csv` | `4dd27d29abeed742d38814fcf22fb4e22472af2a36ef809e63429887098ce25a` |
| `v125_control_matrix.csv` | `87ac78d39591cc6af9ffdaf5c0a21c78c5425b631bda4c1c8b8f43812a68fc72` |
| `v125_forward_kernel_truth.csv` | `a29460abaed820ee2d3a5388a19f754ac58fcf9b1325d1803b01a9947d0874fb` |
| `v125_full_step_efficiency.csv` | `071f88a1c2934a29215542db82bcdca70245fd68da9a97829c50ec43e128e6f7` |
| `v125_provenance_audit.csv` | `c4fa39592f6750119a2ca6b8175f583b6dd0cf064ea28d989fd3fe2734b6de68` |
| `v125_route_decision.json` | `43630583310c717bf5c780ec06e7040fb41acb8943859012e545e1d214a68ef4` |
| `v125_signal_reservoir_sketch.csv` | `b0ddd2c31aad56a07474fb4c5bc25a9ea26bf2f98de2cc0975a33d3b1177c251` |
| `v125_train_probe_coupling.csv` | `f4fcfd64ab94d24d25a0ca3aa5a239e10707f2e5e59fff975fc3a47234b40240` |
