...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7fv_b7fw_pair112_hiddensq_20260522T035000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.3057581177363413` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8259562806393681` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7876681454452779` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8395610661301801` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8130596254024359` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `1.736942674939307` | `1.2859304113450591` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fv-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR112-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.736942674939307` | `0.8847619047619047` | `0` | `0` | `measured` |
| `Rational` | `B7fv-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR112-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.3136580744047321` | `0.7647619047619048` | `1` | `0` | `measured` |
| `Rational` | `B7fw-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairCrossR112-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.8917142272126315` | `0.8847619047619047` | `0` | `0` | `measured` |
| `Rational` | `B7fw-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairCrossR112-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.2859304113450591` | `0.7647619047619048` | `1` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fv-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR112-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7fw-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairCrossR112-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `ef2c95b0f6d2` |
| `v1283_b109_auc_autopsy_trace.csv` | `48852af9d900` |
| `v1283_b109_fullstep_profile.csv` | `53e69b1870f9` |
...
| `v1283_b109_fused_backward_correctness.csv` | `2574671e9208` |
| `v1283_b109_linec_coupling.csv` | `1c93503bef6f` |
| `v1283_b109_linec_diagnostics.csv` | `b04c13a76cf3` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `89e54e02b5b2` |
| `v1283_b109_task_autopsy_final.csv` | `9cae62c89e0b` |
| `v1283_family_component_profile.csv` | `5a4b5c353a38` |
| `v1283_family_efficiency.csv` | `845d61f22528` |
| `v1283_family_expression.csv` | `97aa82a47eba` |
| `v1283_family_failure_table.csv` | `ec0ae4eb44ab` |
| `v1283_family_functional_diagnostic.csv` | `fae544e86aa9` |
