...
B109_A5_best_candidate = B256b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp100
base_qualified = 0
functional_open = 0
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b256_confirm10_seed0to9_20260522T123000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.351876662586083` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8770536377360375` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.8234354774020852` | `0.5966666666666667` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.7976830998789389` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.7549823248352173` | `0.13` | `1` | `1` | `1` |
| `B256b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp100` | `B48a-existing-manual-ce-torch-reduction` | `0.6978983361696305` | `2.719047619047619` | `1` | `0` | `0` |
| `B256b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp100` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.43383803094528856` | `0.5961904761904762` | `1` | `1` | `1` |
| `B256b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp100` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.41442878388432886` | `0.1295238095238095` | `1` | `1` | `1` |
...
| `B256b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp100` | `0.018359375` | `-0.001953125` | `1.0` | `1` | `0` | `0` | `0` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `BSpline` | `KernelBlocked` | `2.2661575021779794` | `1.2847797897990112` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
| `Chebyshev` | `KernelBlocked` | `1.4897917487207102` | `1.4375357660203898` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
| `Fourier` | `KernelBlocked` | `1.811430089352145` | `1.260721820444106` | `True` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
| `RBF` | `KernelBlocked` | `2.660630602966512` | `1.4373694229492568` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
| `Rational` | `KernelBlocked` | `3.2770811492015985` | `1.8814606729722343` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
| `Wavelet` | `KernelBlocked` | `5.331162084146089` | `2.4062474479748484` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `BSpline` | `B6r-BSpline-order1-stream-K2-repair` | `L1-vectorized-or-stream-autograd` | `2.2661575021779794` | `1.48` | `0` | `0` | `measured` |
| `BSpline` | `B6r-BSpline-order1-stream-K2-repair` | `L3-analytic-manual-ce-torch-reduction` | `1.2847797897990112` | `1.6147619047619048` | `0` | `0` | `measured` |
| `Rational` | `B7a-RationalKAT-lite-safe-den-K4` | `L1-vectorized-or-stream-autograd` | `3.2770811492015985` | `3.580952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7a-RationalKAT-lite-safe-den-K4` | `L3-analytic-manual-ce-torch-reduction` | `1.8814606729722343` | `3.5752380952380953` | `0` | `0` | `measured` |
| `RBF` | `B2r-FastKAN-RBF-stream-K2-repair` | `L1-vectorized-or-stream-autograd` | `2.660630602966512` | `1.4857142857142858` | `0` | `0` | `measured` |
| `RBF` | `B2r-FastKAN-RBF-stream-K2-repair` | `L3-analytic-manual-ce-torch-reduction` | `1.4373694229492568` | `1.6147619047619048` | `0` | `0` | `measured` |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L1-vectorized-or-stream-autograd` | `2.9408618740776924` | `4.019047619047619` | `0` | `0` | `measured` |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L3-analytic-manual-ce-torch-reduction` | `1.4375357660203898` | `1.5342857142857143` | `0` | `0` | `measured` |
| `Chebyshev` | `B3a-ChebyKAN-K4` | `L1-vectorized-or-stream-autograd` | `1.4897917487207102` | `1.4804761904761905` | `0` | `0` | `measured` |
| `Chebyshev` | `B3a-ChebyKAN-K4` | `L3-analytic-manual-ce-torch-reduction` | `1.6729868495556501` | `2.460952380952381` | `0` | `0` | `measured` |
| `Chebyshev` | `B3d-ChebyKAN-K6-stream` | `L1-vectorized-or-stream-autograd` | `6.273140747031064` | `14.74047619047619` | `0` | `0` | `measured` |
| `Chebyshev` | `B3d-ChebyKAN-K6-stream` | `L3-analytic-manual-ce-torch-reduction` | `1.6035576021646296` | `3.487142857142857` | `0` | `0` | `measured` |
| `Fourier` | `B4b-FourierKAN-lowfreq-K2-stream` | `L1-vectorized-or-stream-autograd` | `1.811430089352145` | `2.0623809523809524` | `0` | `0` | `measured` |
| `Fourier` | `B4b-FourierKAN-lowfreq-K2-stream` | `L3-analytic-manual-ce-torch-reduction` | `1.493457172535433` | `1.6114285714285714` | `0` | `0` | `measured` |
| `Fourier` | `B4c-FourierKAN-lowfreq-K2-flatgemm-manual` | `L1-vectorized-or-stream-autograd` | `2.053787875820076` | `2.068095238095238` | `0` | `0` | `measured` |
| `Fourier` | `B4c-FourierKAN-lowfreq-K2-flatgemm-manual` | `L3-analytic-manual-ce-torch-reduction` | `1.3667689937720793` | `1.9052380952380952` | `0` | `0` | `measured` |
| `Fourier` | `B4d-FourierKAN-lowfreq-K2-flatgemm-recompute` | `L1-vectorized-or-stream-autograd` | `2.518454437819182` | `2.068095238095238` | `0` | `0` | `measured` |
| `Fourier` | `B4d-FourierKAN-lowfreq-K2-flatgemm-recompute` | `L3-analytic-manual-ce-torch-reduction` | `1.260721820444106` | `2.282857142857143` | `0` | `0` | `measured` |
| `Fourier` | `B4e-FourierKAN-lowfreq-K2-tritonL3` | `L1-vectorized-or-stream-autograd` | `2.3274083659113627` | `2.068095238095238` | `0` | `0` | `measured` |
| `Fourier` | `B4e-FourierKAN-lowfreq-K2-tritonL3` | `L3-analytic-manual-ce-torch-reduction` | `2.122127003537502` | `0.9990476190476191` | `0` | `0` | `measured` |
| `Fourier` | `B4a-FourierKAN-lowfreq-K4` | `L1-vectorized-or-stream-autograd` | `2.387483376993367` | `3.4752380952380952` | `0` | `0` | `measured` |
| `Fourier` | `B4a-FourierKAN-lowfreq-K4` | `L3-analytic-manual-ce-torch-reduction` | `1.3778253837718473` | `3.931904761904762` | `0` | `0` | `measured` |
| `Wavelet` | `B5h-HatWaveletKAN-local-K4` | `L1-vectorized-or-stream-autograd` | `5.331162084146089` | `2.0633333333333335` | `0` | `0` | `measured` |
| `Wavelet` | `B5h-HatWaveletKAN-local-K4` | `L3-analytic-manual-ce-torch-reduction` | `2.4062474479748484` | `3.9604761904761903` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `BSpline` | `B6r-BSpline-order1-stream-K2-repair` | `L2_torch_compile_forward_attempt` | `1.9393339844046493` | `0` | `measured` |
| `Rational` | `B7a-RationalKAT-lite-safe-den-K4` | `L2_torch_compile_forward_attempt` | `2.6389607147616085` | `0` | `measured` |
| `RBF` | `B2r-FastKAN-RBF-stream-K2-repair` | `L2_torch_compile_forward_attempt` | `2.439500125660137` | `0` | `measured` |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L2_torch_compile_forward_attempt` | `2857.6157110592726` | `0` | `measured` |
| `Chebyshev` | `B3a-ChebyKAN-K4` | `L2_torch_compile_forward_attempt` | `1.8401603052276303` | `0` | `measured` |
| `Chebyshev` | `B3d-ChebyKAN-K6-stream` | `L2_torch_compile_forward_attempt` | `3707.308491420533` | `0` | `measured` |
| `Fourier` | `B4b-FourierKAN-lowfreq-K2-stream` | `L2_torch_compile_forward_attempt` | `3743.6533331983965` | `0` | `measured` |
| `Fourier` | `B4c-FourierKAN-lowfreq-K2-flatgemm-manual` | `L2_torch_compile_forward_attempt` | `3509.161877244383` | `0` | `measured` |
| `Fourier` | `B4d-FourierKAN-lowfreq-K2-flatgemm-recompute` | `L2_torch_compile_forward_attempt` | `3529.6478429467556` | `0` | `measured` |
| `Fourier` | `B4e-FourierKAN-lowfreq-K2-tritonL3` | `L2_torch_compile_forward_attempt` | `3965.137615560942` | `0` | `measured` |
| `Fourier` | `B4a-FourierKAN-lowfreq-K4` | `L2_torch_compile_forward_attempt` | `1.8244148370044648` | `0` | `measured` |
| `Wavelet` | `B5h-HatWaveletKAN-local-K4` | `L2_torch_compile_forward_attempt` | `2.8769610149965676` | `0` | `measured` |
...
| `v1283_modification_audit.csv` | `30` | `0` | `0` | `0` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `40704d2ce9f4` |
| `v1283_b109_auc_autopsy_trace.csv` | `c38fdf1a62ed` |
| `v1283_b109_fullstep_profile.csv` | `9299adc2397a` |
| `v1283_b109_fused_backward_correctness.csv` | `7e3fcb0e8f36` |
| `v1283_b109_task_autopsy_final.csv` | `7f2281e3ead3` |
| `v1283_family_component_profile.csv` | `4237ec733b3a` |
| `v1283_family_efficiency.csv` | `ac88447827f3` |
| `v1283_family_expression.csv` | `76c9544dff8d` |
| `v1283_family_failure_table.csv` | `73616814a69b` |
...
| `v1283_family_status.json` | `3546108793be` |
| `v1283_family_task_triage.csv` | `79b35448eb0d` |
| `v1283_modification_audit.csv` | `1bd74636c1ae` |
| `v1283_provenance_audit.csv` | `69f3df91dd91` |
| `v1283_route_decision.json` | `fa5b462e8981` |
| `v1283_run_manifest.csv` | `9c788b71c90d` |
