...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b236_b237_globalfixedgain_20260523T014000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.2921445538451577` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.845726605976743` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7982874844622322` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8770417939940561` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8386088796588116` | `0.13` | `1` | `1` | `1` |
| `B236b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.2964107966285623` | `2.719047619047619` | `0` | `0` | `0` |
| `B236b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8276307583323612` | `0.5961904761904762` | `1` | `1` | `1` |
| `B236b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7780170229109901` | `0.1295238095238095` | `1` | `1` | `1` |
| `B237b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp065` | `B48a-existing-manual-ce-torch-reduction` | `1.299539888111298` | `2.719047619047619` | `0` | `0` | `0` |
| `B237b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp065` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8293893660629195` | `0.5961904761904762` | `1` | `1` | `1` |
| `B237b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp065` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7999032065488899` | `0.1295238095238095` | `1` | `1` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `b8a5c24d6873` |
| `v1283_b109_auc_autopsy_trace.csv` | `bffe3530e838` |
| `v1283_b109_fullstep_profile.csv` | `1c2aa5a7ba22` |
| `v1283_b109_functional_control_matrix.csv` | `ebdfb57c606e` |
| `v1283_b109_functional_direction_audit.csv` | `617bc7783f7f` |
| `v1283_b109_functional_five_step.csv` | `c80720717c3b` |
| `v1283_b109_functional_one_step.csv` | `1e957869281d` |
| `v1283_b109_functional_route.json` | `3407756e97cc` |
| `v1283_b109_fused_backward_correctness.csv` | `164fc9b442c5` |
| `v1283_b109_linec_coupling.csv` | `0232a18f90ea` |
| `v1283_b109_linec_diagnostics.csv` | `849e3571ea20` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `9b190e989068` |
| `v1283_b109_linec_noise_leak.csv` | `48c189545d0f` |
| `v1283_b109_linec_signal_reservoir.csv` | `260013024488` |
| `v1283_b109_task_autopsy_final.csv` | `32cb2530cbfb` |
