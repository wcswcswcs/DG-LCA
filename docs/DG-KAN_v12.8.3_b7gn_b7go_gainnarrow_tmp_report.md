...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7gn_b7go_gainnarrow_20260522T163000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.5592464304192688` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.1451821726865652` | `0.5961904761904762` | `0` | `1` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9418647104738838` | `0.1295238095238095` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.0284402928278618` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `1.005983753625625` | `0.13` | `0` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `1.6058168202807435` | `1.5119277655549863` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7gn-RationalKAT-flashgroup-G16-h32-linearresGain18800-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.6058168202807435` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7gn-RationalKAT-flashgroup-G16-h32-linearresGain18800-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.7893321032741931` | `0.7638095238095238` | `0` | `0` | `measured` |
| `Rational` | `B7go-RationalKAT-flashgroup-G16-h32-linearresGain19000-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.6358265370927938` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7go-RationalKAT-flashgroup-G16-h32-linearresGain19000-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.5119277655549863` | `0.7638095238095238` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7gn-RationalKAT-flashgroup-G16-h32-linearresGain18800-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7go-RationalKAT-flashgroup-G16-h32-linearresGain19000-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `7465f0014ca8` |
| `v1283_b109_auc_autopsy_trace.csv` | `6c661b8e5ae3` |
| `v1283_b109_fullstep_profile.csv` | `4eeb88fe1f53` |
...
| `v1283_b109_fused_backward_correctness.csv` | `41d6d1da1d92` |
| `v1283_b109_linec_coupling.csv` | `89230d633f67` |
| `v1283_b109_linec_diagnostics.csv` | `bb8f63afcbb2` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `e431e3db59bc` |
| `v1283_b109_task_autopsy_final.csv` | `831abc8d4cfb` |
| `v1283_family_component_profile.csv` | `3866c437a729` |
| `v1283_family_efficiency.csv` | `2ea26dce8a81` |
| `v1283_family_expression.csv` | `4f4f32c95a50` |
| `v1283_family_failure_table.csv` | `aff7d8818d2e` |
| `v1283_family_functional_diagnostic.csv` | `a858055e703c` |
