...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7gl_b7gm_gaininterp_20260522T160000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `0.972277724574174` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.6268125001023415` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.5905029825157828` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.6624553176851339` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.6403991735590279` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `TaskBlocked` | `1.8491873696342387` | `1.2413074538062652` | `False` | `True` | `family-specific fused L3 efficiency and A4 expression passed; A5 fused task triage failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7gl-RationalKAT-flashgroup-G16-h32-linearresGain18400-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `2.753621394601069` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7gl-RationalKAT-flashgroup-G16-h32-linearresGain18400-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.2485340586604625` | `0.7638095238095238` | `1` | `1` | `measured` |
| `Rational` | `B7gm-RationalKAT-flashgroup-G16-h32-linearresGain17600-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.8491873696342387` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7gm-RationalKAT-flashgroup-G16-h32-linearresGain17600-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.2413074538062652` | `0.7638095238095238` | `1` | `1` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7gl-RationalKAT-flashgroup-G16-h32-linearresGain18400-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7gm-RationalKAT-flashgroup-G16-h32-linearresGain17600-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `bcd16c9fe7c7` |
| `v1283_b109_auc_autopsy_trace.csv` | `e06149cba2ca` |
| `v1283_b109_fullstep_profile.csv` | `833d274e9580` |
...
| `v1283_b109_fused_backward_correctness.csv` | `9a3579190eee` |
| `v1283_b109_linec_coupling.csv` | `7c64589093f2` |
| `v1283_b109_linec_diagnostics.csv` | `6ecc1d2154d0` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `646f6709ffd6` |
| `v1283_b109_task_autopsy_final.csv` | `3a1aaf9dcad8` |
| `v1283_family_component_profile.csv` | `1d2e6dab24b4` |
| `v1283_family_efficiency.csv` | `2f2c96da039e` |
| `v1283_family_expression.csv` | `fe6bbda4cbd1` |
| `v1283_family_failure_table.csv` | `15b9af39772f` |
| `v1283_family_functional_diagnostic.csv` | `ad18d9f44012` |
