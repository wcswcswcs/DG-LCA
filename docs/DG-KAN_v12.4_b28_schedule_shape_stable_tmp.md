...
|---|---|---:|---:|---:|
| `B28a-GatedLegendreQuadratic-h228-lowboost-temp050-cosine-lr-final050` | `GatedHybrid` | `4.269811711594891` | `1.0781890193936083` | `0` |
| `B28a-GatedLegendreQuadratic-h228-lowboost-temp050-cosine-lr-final050` | `GatedHybrid` | `1.9158250576881404` | `0.4808795411089866` | `0` |
| `B28b-GatedLegendreQuadratic-h228-lowboost-temp050-cosine-lr-final075` | `GatedHybrid` | `4.7465648405641545` | `1.118700491668943` | `0` |
| `B28b-GatedLegendreQuadratic-h228-lowboost-temp050-cosine-lr-final075` | `GatedHybrid` | `1.559771730163763` | `0.48125512155148864` | `0` |
...
| `v124_efficiency_microbench.csv` | `143fd5758561f04b7bf8c54d9f7c3650601c4cf92769d70ea8cf6684b4c49396` |
| `v124_expression_battery.csv` | `381a5976eecd5600991849715303f80f6327a2421ebb206620c118376b8661b5` |
