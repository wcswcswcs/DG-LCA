...
B109_A5_best_candidate = B302b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-quadRamp010-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b302_b304_quadramp_short_20260522T071000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.1444246037362766` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7277235959479005` | `0.5966666666666667` | `1` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6354069403341704` | `0.5966666666666667` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.6405370171930135` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.6574939413981391` | `0.13` | `1` | `1` | `1` |
| `B302b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-quadRamp010-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.1461826035400764` | `2.719047619047619` | `0` | `0` | `0` |
...
| `B303b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-quadRamp015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.3403069355341584` | `2.719047619047619` | `0` | `0` | `0` |
| `B303b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-quadRamp015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.860002414353418` | `0.5961904761904762` | `0` | `1` | `1` |
| `B303b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-quadRamp015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.8218495510431657` | `0.1295238095238095` | `1` | `1` | `1` |
| `B304b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-quadRamp020-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.1507225767033213` | `2.719047619047619` | `0` | `0` | `0` |
...
| `B302b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-quadRamp010-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.033203125` | `-0.00390625` | `1.0` | `1` | `1` | `1` | `1` |
| `B303b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-quadRamp015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.031901041666666664` | `-0.00390625` | `1.0` | `1` | `1` | `1` | `1` |
| `B304b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-quadRamp020-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.033203125` | `0.0` | `1.0` | `1` | `1` | `1` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `9633ec50c193` |
| `v1283_b109_auc_autopsy_trace.csv` | `91fca43b586d` |
| `v1283_b109_fullstep_profile.csv` | `e690125a299e` |
| `v1283_b109_functional_control_matrix.csv` | `43d83b69bdc6` |
| `v1283_b109_functional_direction_audit.csv` | `6bf3ac9c33c0` |
| `v1283_b109_functional_five_step.csv` | `a7ca70e6202c` |
| `v1283_b109_functional_one_step.csv` | `0141fd6d58d1` |
| `v1283_b109_functional_route.json` | `7a967a6ed2ef` |
| `v1283_b109_fused_backward_correctness.csv` | `5f62420add2e` |
| `v1283_b109_linec_coupling.csv` | `f5a781d46631` |
| `v1283_b109_linec_diagnostics.csv` | `feaec5193779` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `e4d766916a35` |
| `v1283_b109_linec_noise_leak.csv` | `9f809f5f2a41` |
| `v1283_b109_linec_signal_reservoir.csv` | `934d17418c74` |
| `v1283_b109_task_autopsy_final.csv` | `d460a63491db` |
