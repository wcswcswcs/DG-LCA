...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7em_b7en_pairfeature_conditioning_20260522T003800Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.4850441628485989` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.9318941409503699` | `0.5961904761904762` | `0` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `1.10002255148356` | `0.1295238095238095` | `0` | `1` | `0` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.9801681382566889` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.942230332256631` | `0.13` | `0` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `1.7081905374380328` | `1.6351049391686687` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7em-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-pairStd-crossZero-b32-freezeBackbone-hiddenBias-L3` | `L1-vectorized-or-stream-autograd` | `1.7081905374380328` | `0.9195238095238095` | `0` | `0` | `measured` |
| `Rational` | `B7em-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-pairStd-crossZero-b32-freezeBackbone-hiddenBias-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.673353899674263` | `0.7547619047619047` | `0` | `0` | `measured` |
| `Rational` | `B7en-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-pairNorm-crossZero-b32-freezeBackbone-hiddenBias-L3` | `L1-vectorized-or-stream-autograd` | `1.817650210832238` | `0.9195238095238095` | `0` | `0` | `measured` |
| `Rational` | `B7en-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-pairNorm-crossZero-b32-freezeBackbone-hiddenBias-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.6351049391686687` | `0.7547619047619047` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7em-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-pairStd-crossZero-b32-freezeBackbone-hiddenBias-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7en-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-pairNorm-crossZero-b32-freezeBackbone-hiddenBias-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `f8cb5c7f703f` |
| `v1283_b109_auc_autopsy_trace.csv` | `f4016ec41548` |
| `v1283_b109_fullstep_profile.csv` | `9cc0b4a2d345` |
...
| `v1283_b109_fused_backward_correctness.csv` | `250b9b02b863` |
| `v1283_b109_linec_coupling.csv` | `b34d37626553` |
| `v1283_b109_linec_diagnostics.csv` | `0a7daf709352` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `2afd7b9195b5` |
| `v1283_b109_task_autopsy_final.csv` | `b8467cce4a80` |
| `v1283_family_component_profile.csv` | `f798b396fec3` |
| `v1283_family_efficiency.csv` | `5311f020a88c` |
| `v1283_family_expression.csv` | `fe85e88e8877` |
| `v1283_family_failure_table.csv` | `243f2221e372` |
| `v1283_family_functional_diagnostic.csv` | `b703e2922f74` |
