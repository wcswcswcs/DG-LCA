...
|---|---|---:|---:|---:|
| `B47a-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final075` | `GatedHybrid` | `5.806861456720137` | `1.046759765091505` | `0` |
| `B47a-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final075` | `GatedHybrid` | `None` | `None` | `0` |
| `B47b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final050` | `GatedHybrid` | `4.12779053734397` | `1.0817570335973778` | `0` |
| `B47b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final050` | `GatedHybrid` | `None` | `None` | `0` |
...
| `v124_efficiency_microbench.csv` | `7bcd4f7b0d903671d2fafcfee28534b79f119314d7b25c68ab2967d0780d8ba7` |
| `v124_expression_battery.csv` | `33e8bb6aaefeb6ad319f5dd0e73719a4b2333b47924223b89d2a73d52005a9cc` |
