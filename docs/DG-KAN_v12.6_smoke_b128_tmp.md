...
artifact = results/v12_6_lowerlevel_fhq_functional_geometry/v126_smoke_b128_20260520T001500Z
...
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `torch-reference-simple-fast` | `4.7189704480457575` | `0.0` | `0.0` | `0` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `FHQ0-triton-two-kernel-forward-exact-B48a` | `2.447447025571555` | `4.76837158203125e-07` | `3.5817950561067846e-07` | `0` |
...
|---|---|---|---|---|---|---|
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.7925913663083564` | `2.0357142857142856` | `1` | `0` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.3618110263310959` | `0.09857142857142857` | `1` | `0` | `` |
...
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-fixedP-readout-grad` | `quad_readout` | `0.0006664894171990454` | `1.0` | `1` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-fixedP-readout-grad` | `branch_scale` | `9.140109225036497e-10` | `1.0` | `1` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-fixedP-readout-grad` | `logit_gain` | `7.403858859333923e-08` | `1.0` | `1` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-fixedP-readout-grad` | `bias` | `6.948613417989691e-08` | `1.0000001192092896` | `1` | `` |
...
| `v126_fused_backward_correctness.csv` | `b40a37b09203` |
| `v126_fused_forward_profile.csv` | `2cb54ab6124a` |
| `v126_manifold_channel_diagnostics.csv` | `22f7a6a69d77` |
