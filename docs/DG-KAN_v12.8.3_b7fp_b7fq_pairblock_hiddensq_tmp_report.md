...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7fp_b7fq_pairblock_hiddensq_20260522T032000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.2018894182275166` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7539978136475748` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7331861276500936` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.7832374277516604` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.7637683135131504` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `ExpressionBlocked` | `1.7116050887765937` | `0.9476625666317503` | `False` | `True` | `family-specific fused L3 efficiency passed but A4 expression failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fp-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.805081877039031` | `0.8623809523809524` | `0` | `0` | `measured` |
| `Rational` | `B7fp-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `0.9476625666317503` | `0.7652380952380953` | `1` | `1` | `measured` |
| `Rational` | `B7fq-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.7116050887765937` | `0.8623809523809524` | `0` | `0` | `measured` |
| `Rational` | `B7fq-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.0746042236688458` | `0.7652380952380953` | `1` | `1` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fp-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7fq-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `8fb7ead7ade3` |
| `v1283_b109_auc_autopsy_trace.csv` | `3a532ada6b98` |
| `v1283_b109_fullstep_profile.csv` | `45f169ce8d0c` |
...
| `v1283_b109_fused_backward_correctness.csv` | `db16af3f6281` |
| `v1283_b109_linec_coupling.csv` | `5267d3d2a4c9` |
| `v1283_b109_linec_diagnostics.csv` | `5a3f98417829` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `de0782a0c4ec` |
| `v1283_b109_task_autopsy_final.csv` | `cb93e09f3c04` |
| `v1283_family_component_profile.csv` | `62e6683d564c` |
| `v1283_family_efficiency.csv` | `8588d6094efd` |
| `v1283_family_expression.csv` | `1ba0d9fd44aa` |
| `v1283_family_failure_table.csv` | `cbf40b4d49b0` |
| `v1283_family_functional_diagnostic.csv` | `84d343e5a8af` |
