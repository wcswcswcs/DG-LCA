...
B109_functional_delta_score_best_update = F10-TaskPlusBranchScaleDamping-w005
B109_functional_delta_score_gap_vs_best_control = -0.00016585105235089603
...
artifact = results/v12_9_b314_functional_classic_family/v129_b7mg_mh_rational_logitbatchrms_mix_20260522T163726Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.6588794262841828` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.1332051066389408` | `0.5966666666666667` | `0` | `1` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `1.0251234072178947` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.0523764423210777` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.9692866113359089` | `0.13` | `0` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `2.09956044790751` | `1.2815851986408002` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7mg-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-pairNorm-crossZero-b32-hiddenRatResidual005-hiddenResVJPTriton-logitBatchRMSMixSG025-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `2.278439257348158` | `0.9195238095238095` | `0` | `0` | `measured` |
| `Rational` | `B7mg-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-pairNorm-crossZero-b32-hiddenRatResidual005-hiddenResVJPTriton-logitBatchRMSMixSG025-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.2815851986408002` | `0.770952380952381` | `1` | `0` | `measured` |
| `Rational` | `B7mh-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-pairNorm-crossZero-b32-hiddenRatResidual005-hiddenResVJPTriton-logitBatchRMSMixSG050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `2.09956044790751` | `0.9195238095238095` | `0` | `0` | `measured` |
| `Rational` | `B7mh-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-pairNorm-crossZero-b32-hiddenRatResidual005-hiddenResVJPTriton-logitBatchRMSMixSG050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.2828951554159596` | `0.770952380952381` | `1` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7mg-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-pairNorm-crossZero-b32-hiddenRatResidual005-hiddenResVJPTriton-logitBatchRMSMixSG025-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7mh-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-pairNorm-crossZero-b32-hiddenRatResidual005-hiddenResVJPTriton-logitBatchRMSMixSG050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| `v1283_b109_functional_delta_score_control_matrix.csv` | `3` | `0` | `0` | `0` | `1` |
| `v1283_b109_functional_delta_score_repair.csv` | `60` | `0` | `0` | `0` | `1` |
...
| `v1283_family_basis_diagnostics.csv` | `2` | `0` | `0` | `0` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `9cf65ddb39a3` |
| `v1283_b109_auc_autopsy_trace.csv` | `cb92954c0669` |
| `v1283_b109_fullstep_profile.csv` | `69569f04e44d` |
| `v1283_b109_functional_control_matrix.csv` | `5eef77bd89ab` |
| `v1283_b109_functional_delta_score_control_matrix.csv` | `f4706ed92f9e` |
| `v1283_b109_functional_delta_score_repair.csv` | `f89b8c215187` |
| `v1283_b109_functional_delta_score_repair_summary.csv` | `014b1c9e6160` |
...
| `v1283_b109_fused_backward_correctness.csv` | `d0ed8f284765` |
| `v1283_b109_linec_coupling.csv` | `89f73d4f4d80` |
| `v1283_b109_linec_diagnostics.csv` | `c8522ac53507` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `ce8bb0043126` |
| `v1283_b109_linec_noise_leak.csv` | `c41e2b72d266` |
| `v1283_b109_linec_signal_reservoir.csv` | `9967bdb8a11d` |
| `v1283_b109_task_autopsy_final.csv` | `46933f5820a8` |
| `v1283_family_basis_diagnostics.csv` | `e5c8188ea131` |
| `v1283_family_component_profile.csv` | `c15a1069ea6a` |
