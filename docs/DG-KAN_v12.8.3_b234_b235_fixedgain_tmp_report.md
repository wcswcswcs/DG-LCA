...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b234_b235_fixedgain_20260523T013000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.5804162873769556` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7650412360137551` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7209534282739419` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.7935523577375708` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.7865233264687451` | `0.13` | `1` | `1` | `1` |
| `B234b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-classgain-fixedgain-identitytailquad030-hingeamp025-temp065` | `B48a-existing-manual-ce-torch-reduction` | `1.0956958548486142` | `2.719047619047619` | `0` | `0` | `0` |
| `B234b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-classgain-fixedgain-identitytailquad030-hingeamp025-temp065` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.693573275979418` | `0.5961904761904762` | `1` | `1` | `1` |
| `B234b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-classgain-fixedgain-identitytailquad030-hingeamp025-temp065` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6490937415867312` | `0.1295238095238095` | `1` | `1` | `1` |
| `B235b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-classgain-fixedgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.140665998503621` | `2.719047619047619` | `0` | `0` | `0` |
| `B235b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-classgain-fixedgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7028549495558529` | `0.5961904761904762` | `1` | `1` | `1` |
| `B235b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-classgain-fixedgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.651785023531285` | `0.1295238095238095` | `1` | `1` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `6eb8ee2cef7a` |
| `v1283_b109_auc_autopsy_trace.csv` | `02d79d3d08b1` |
| `v1283_b109_fullstep_profile.csv` | `c046158b8b8c` |
| `v1283_b109_functional_control_matrix.csv` | `19bda1e58c68` |
| `v1283_b109_functional_direction_audit.csv` | `d20620589f89` |
| `v1283_b109_functional_five_step.csv` | `9790f622cb51` |
| `v1283_b109_functional_one_step.csv` | `5c37b799ecf9` |
| `v1283_b109_functional_route.json` | `5fc03d135216` |
| `v1283_b109_fused_backward_correctness.csv` | `16400290db70` |
| `v1283_b109_linec_coupling.csv` | `848e673127a5` |
| `v1283_b109_linec_diagnostics.csv` | `b537235ec956` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `a2db9c26609f` |
| `v1283_b109_linec_noise_leak.csv` | `d54e37e14eb9` |
| `v1283_b109_linec_signal_reservoir.csv` | `12163ad2e79e` |
| `v1283_b109_task_autopsy_final.csv` | `6a40d479f299` |
