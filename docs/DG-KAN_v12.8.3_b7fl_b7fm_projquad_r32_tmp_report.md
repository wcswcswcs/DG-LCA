...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7fl_b7fm_projquad_r32_20260522T030000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.681785911663683` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.235204507341195` | `0.5961904761904762` | `0` | `1` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `1.0625411306982897` | `0.1295238095238095` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.1213324812284138` | `0.13` | `0` | `1` | `0` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `1.0783852266093528` | `0.13` | `0` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `1.4122658876972212` | `1.4047600237058084` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fl-RationalKAT-flashgroup-G16-h32-linearresGain19200-projBilinR32-bilinZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.4534278324468415` | `0.7947619047619048` | `0` | `0` | `measured` |
| `Rational` | `B7fl-RationalKAT-flashgroup-G16-h32-linearresGain19200-projBilinR32-bilinZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `2.1187536758971213` | `0.7947619047619048` | `0` | `0` | `measured` |
| `Rational` | `B7fm-RationalKAT-flashgroup-G16-h32-linearresGain19200-projSqR32-sqZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.4122658876972212` | `0.81` | `0` | `0` | `measured` |
| `Rational` | `B7fm-RationalKAT-flashgroup-G16-h32-linearresGain19200-projSqR32-sqZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.4047600237058084` | `0.81` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fl-RationalKAT-flashgroup-G16-h32-linearresGain19200-projBilinR32-bilinZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7fm-RationalKAT-flashgroup-G16-h32-linearresGain19200-projSqR32-sqZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `19c83749d84a` |
| `v1283_b109_auc_autopsy_trace.csv` | `435afec4a65b` |
| `v1283_b109_fullstep_profile.csv` | `674f9576a370` |
...
| `v1283_b109_fused_backward_correctness.csv` | `336c141aa0c5` |
| `v1283_b109_linec_coupling.csv` | `e2611bc8a6e6` |
| `v1283_b109_linec_diagnostics.csv` | `d95e14205ced` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `46cb2c9a78ec` |
| `v1283_b109_task_autopsy_final.csv` | `db56dab45d49` |
| `v1283_family_component_profile.csv` | `b47c90ea92b7` |
| `v1283_family_efficiency.csv` | `d3a7fca305fe` |
| `v1283_family_expression.csv` | `abadfc43d7bf` |
| `v1283_family_failure_table.csv` | `e8b2d464919a` |
| `v1283_family_functional_diagnostic.csv` | `f1cec7886e61` |
