...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7es_b7et_b7eu_w2biasrow_r120_20260522T010000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.759760631948946` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.9598397162690805` | `0.5961904761904762` | `0` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9333003461531113` | `0.1295238095238095` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.9939580968892922` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `1.0194565181941218` | `0.13` | `0` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `1.6142879935282353` | `1.7214424394957417` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7es-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-w2BiasRow-L3` | `L1-vectorized-or-stream-autograd` | `1.8110422237702524` | `0.9195238095238095` | `0` | `0` | `measured` |
| `Rational` | `B7es-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-w2BiasRow-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.8166322105121233` | `0.7557142857142857` | `0` | `0` | `measured` |
| `Rational` | `B7et-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR120-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-L3` | `L1-vectorized-or-stream-autograd` | `1.6142879935282353` | `0.8971428571428571` | `0` | `0` | `measured` |
| `Rational` | `B7et-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR120-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.7214424394957417` | `0.7552380952380953` | `0` | `0` | `measured` |
| `Rational` | `B7eu-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR120-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-w2BiasRow-L3` | `L1-vectorized-or-stream-autograd` | `2.06772926451091` | `0.8971428571428571` | `0` | `0` | `measured` |
| `Rational` | `B7eu-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR120-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-w2BiasRow-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.83470056852655` | `0.7561904761904762` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7es-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-w2BiasRow-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7et-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR120-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7eu-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR120-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-w2BiasRow-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| `v1283_family_component_profile.csv` | `6` | `0` | `0` | `0` | `1` |
| `v1283_family_efficiency.csv` | `7` | `0` | `0` | `0` | `1` |
| `v1283_family_expression.csv` | `3` | `0` | `0` | `0` | `1` |
| `v1283_family_failure_table.csv` | `3` | `0` | `0` | `0` | `1` |
| `v1283_family_functional_diagnostic.csv` | `3` | `0` | `0` | `0` | `1` |

Selected hashes:

| artifact | sha256_prefix |
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `cb83588007ed` |
| `v1283_b109_auc_autopsy_trace.csv` | `dc5d9571bf8b` |
| `v1283_b109_fullstep_profile.csv` | `8c67816be6ca` |
...
| `v1283_b109_fused_backward_correctness.csv` | `74bf4a2270f5` |
| `v1283_b109_linec_coupling.csv` | `c0815bee19c0` |
| `v1283_b109_linec_diagnostics.csv` | `1dc42dbff379` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `160c4b80c2f7` |
| `v1283_b109_task_autopsy_final.csv` | `404ae0b10eef` |
| `v1283_family_component_profile.csv` | `5bcb9ff5fdcc` |
| `v1283_family_efficiency.csv` | `a8f0d01c0c07` |
| `v1283_family_expression.csv` | `081405686e95` |
| `v1283_family_failure_table.csv` | `035e851a9dbe` |
| `v1283_family_functional_diagnostic.csv` | `a2a333268882` |
