...
```text
results/v12_5_2_efficiency_functional_manifold/smoke_v1252_fix
```
...
5. No-fake audit rows checked = `141`，fake/proxy/cpu = `0` / `0` / `0`。
...
|---|---|---:|---:|---:|---:|
| `F0-current-B47-manual-autograd-forward` | `B47b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final050` | `10.44253536636315` | `1.0` | `0.0` | `0` |
| `F0b-current-B42-fastreuse-forward` | `B42b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-final075` | `11.502375280482305` | `1.1014925855585842` | `` | `0` |
| `K2-current-LiteGated-forward` | `B30b-LiteGatedLegendreQuadratic-h256-temp050-cosine-lr-final050` | `7.0385606104623015` | `0.6740279408709955` | `` | `0` |
| `F2-triton-residual-input-norm-plus-legendre-basis` | `B47b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final050` | `1.1416757278706033` | `0.1093293618662857` | `0.0009468495845794678` | `0` |
| `F3-triton-residual-input-norm-legendre-hidden-preactivation` | `B47b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final050` | `1.9084998243094808` | `0.18276211258589772` | `2.047792077064514e-05` | `0` |
...
| `B47b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final050` | `6.26137437812743` | `2.831016598880973` | `3.149348947071653` | `1.044479897894065` | `0` |
...
| artifact | SHA256 |
|---|---|
| `v125_backward_kernel_truth.csv` | `5c0deca6cf0bcf75c8bc1cc0743a5eac0b5e58518331cfa5946d3dc3e3a747e3` |
| `v125_control_matrix.csv` | `382c7c5a42c337374c4a20e8adca5b1b7ed8add7693816f072eada6c515df6a0` |
| `v125_forward_kernel_truth.csv` | `c2bb25d6eccaa42f8ca2b3e9b762b4a01ebd58bd1954e7e7d8f6b84ea3650259` |
| `v125_full_step_efficiency.csv` | `7841a66e3b1cd7db8800584761a2703fdf945687fbfe6cf91973796de47d0c4a` |
| `v125_provenance_audit.csv` | `a7db0fb723cf5640d7ed8adfdf14e82d7fb1abbda5732fb930bf91369e34997f` |
| `v125_route_decision.json` | `cde52e5c97fc094cf0cb64669dfdbf01018fe7b260beaf569cfa680b3b68f055` |
| `v125_signal_reservoir_sketch.csv` | `dbdca157aa6891ec348cf14103de60798d90e8c3324e209345fa661d9644df6f` |
| `v125_train_probe_coupling.csv` | `af54805d70bdd1372882d8349b81bc15be57a50d00d4fab115e05ece1514941d` |
