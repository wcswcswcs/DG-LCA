...
artifact = results/v12_6_lowerlevel_fhq_functional_geometry/v126_b50d_twohinge_h112_fhq_block64_smoke_20260520T055000Z
...
| `B50d-SimpleFastTaskGeometry-h112-twohinge-temp075` | `torch-reference-simple-fast` | `4.273733011558491` | `0.0` | `0.0` | `0` |
| `B50d-SimpleFastTaskGeometry-h112-twohinge-temp075` | `FHQ-triton-two-kernel-forward` | `5.441064397307253` | `3.5762786865234375e-07` | `3.370650176748313e-07` | `0` |
...
|---|---|---|---|---|---|---|
| `B50d-SimpleFastTaskGeometry-h112-twohinge-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.4012174477620212` | `3.487619047619048` | `1` | `0` | `` |
| `B50d-SimpleFastTaskGeometry-h112-twohinge-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.366917345621828` | `0.4828571428571429` | `1` | `0` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.988121333048291` | `0.09857142857142857` | `1` | `1` | `` |
...
|---|---|---|---|---|---|---|
| `B50d-SimpleFastTaskGeometry-h112-twohinge-temp075` | `B48a-existing-manual-ce-torch-reduction` | `direct_readout` | `8.78471269061265e-08` | `1.0` | `1` | `` |
| `B50d-SimpleFastTaskGeometry-h112-twohinge-temp075` | `B48a-existing-manual-ce-torch-reduction` | `quad_proj` | `1.0358921542774624e-07` | `0.9999999403953552` | `1` | `` |
| `B50d-SimpleFastTaskGeometry-h112-twohinge-temp075` | `B48a-existing-manual-ce-torch-reduction` | `quad_readout` | `7.76808306568455e-08` | `1.0000001192092896` | `1` | `` |
| `B50d-SimpleFastTaskGeometry-h112-twohinge-temp075` | `B48a-existing-manual-ce-torch-reduction` | `branch_scale` | `1.3683989497081939e-09` | `0.9999998807907104` | `1` | `` |
| `B50d-SimpleFastTaskGeometry-h112-twohinge-temp075` | `B48a-existing-manual-ce-torch-reduction` | `logit_gain` | `1.6538987779313175e-07` | `1.0` | `1` | `` |
| `B50d-SimpleFastTaskGeometry-h112-twohinge-temp075` | `B48a-existing-manual-ce-torch-reduction` | `bias` | `8.434260934109261e-08` | `1.0` | `1` | `` |
| `B50d-SimpleFastTaskGeometry-h112-twohinge-temp075` | `F2-triton-learnableP-proj-grad` | `direct_readout` | `0.0007472126744687557` | `0.9999998807907104` | `1` | `` |
| `B50d-SimpleFastTaskGeometry-h112-twohinge-temp075` | `F2-triton-learnableP-proj-grad` | `quad_proj` | `0.0015372352208942175` | `0.9999998211860657` | `1` | `` |
| `B50d-SimpleFastTaskGeometry-h112-twohinge-temp075` | `F2-triton-learnableP-proj-grad` | `quad_readout` | `0.0008988238987512887` | `1.0` | `1` | `` |
| `B50d-SimpleFastTaskGeometry-h112-twohinge-temp075` | `F2-triton-learnableP-proj-grad` | `branch_scale` | `4.4176823621455696e-07` | `1.0000001192092896` | `1` | `` |
| `B50d-SimpleFastTaskGeometry-h112-twohinge-temp075` | `F2-triton-learnableP-proj-grad` | `logit_gain` | `1.4371765644227708e-07` | `1.0` | `1` | `` |
| `B50d-SimpleFastTaskGeometry-h112-twohinge-temp075` | `F2-triton-learnableP-proj-grad` | `bias` | `5.14262090689499e-08` | `1.0` | `1` | `` |
...
|---|---|
| `v126_auc_attribution.csv` | `58fc6bf12fb5` |
| `v126_candidate_manifest.csv` | `f810e5780391` |
| `v126_expression_audit.csv` | `67380c5f6cc2` |
| `v126_expression_summary.csv` | `c27ed490ab40` |
| `v126_failure_table.csv` | `4a7aff35f288` |
| `v126_frozen_readout.csv` | `184957fffcf9` |
| `v126_fullstep_profile.csv` | `db09f103802c` |
...
| `v126_fused_backward_correctness.csv` | `66e28c720926` |
| `v126_fused_forward_profile.csv` | `56ac04cf47b3` |
