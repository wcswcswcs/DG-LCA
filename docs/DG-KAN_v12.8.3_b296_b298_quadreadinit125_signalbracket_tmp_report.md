...
B109_A5_best_candidate = B297b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad025-signalBlock020-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b296_b298_quadreadinit125_signalbracket_short_20260522T062000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.9141808252087151` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.915702079421007` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.8731484951779702` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8326434124088854` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `1.0963656033709543` | `0.13` | `0` | `1` | `1` |
| `B296b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad025-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.2318641942690696` | `2.719047619047619` | `0` | `0` | `0` |
| `B296b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad025-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7739003594444276` | `0.5961904761904762` | `1` | `1` | `1` |
| `B296b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad025-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.726771543525629` | `0.1295238095238095` | `1` | `1` | `1` |
| `B297b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad025-signalBlock020-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `0.9078222560116649` | `2.719047619047619` | `0` | `0` | `0` |
| `B297b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad025-signalBlock020-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.586725956579606` | `0.5961904761904762` | `1` | `1` | `1` |
| `B297b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad025-signalBlock020-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.5573338209764285` | `0.1295238095238095` | `1` | `1` | `1` |
| `B298b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock025-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.2513301807843111` | `2.719047619047619` | `0` | `0` | `0` |
...
| `B296b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad025-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.033854166666666664` | `-0.01171875` | `0.8333333333333334` | `1` | `1` | `1` | `0` |
| `B297b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad025-signalBlock020-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.026692708333333332` | `-0.0078125` | `1.0` | `1` | `1` | `1` | `1` |
| `B298b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock025-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.035807291666666664` | `0.0` | `1.0` | `0` | `1` | `1` | `0` |
...
| `Chebyshev` | `KernelBlocked` | `4.372459645591811` | `1.1672916715423145` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L1-vectorized-or-stream-autograd` | `4.372459645591811` | `3.9695238095238095` | `0` | `0` | `measured` |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L3-analytic-manual-ce-torch-reduction` | `1.1672916715423145` | `2.308095238095238` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L2_torch_compile_forward_attempt` | `2231.9670293934582` | `0` | `measured` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `c18da1cf3435` |
| `v1283_b109_auc_autopsy_trace.csv` | `083cc6c8e37f` |
| `v1283_b109_fullstep_profile.csv` | `7c579b342a1a` |
| `v1283_b109_functional_control_matrix.csv` | `9256b451bcc3` |
| `v1283_b109_functional_direction_audit.csv` | `d1ea04cc7e28` |
| `v1283_b109_functional_five_step.csv` | `0233cf8c3095` |
| `v1283_b109_functional_one_step.csv` | `f73eacdfeb86` |
| `v1283_b109_functional_route.json` | `6ff0e67705db` |
| `v1283_b109_fused_backward_correctness.csv` | `09a0f597f5b7` |
| `v1283_b109_linec_coupling.csv` | `2d0b29485044` |
| `v1283_b109_linec_diagnostics.csv` | `363ca24ff7ea` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `aba1abc6e7a7` |
| `v1283_b109_linec_noise_leak.csv` | `d6ac6d043592` |
| `v1283_b109_linec_signal_reservoir.csv` | `c585139459fa` |
| `v1283_b109_task_autopsy_final.csv` | `2a228a347449` |
| `v1283_family_component_profile.csv` | `3261f6499956` |
| `v1283_family_efficiency.csv` | `c7dc5b470cd2` |
| `v1283_family_expression.csv` | `62b9bdfdd290` |
| `v1283_family_failure_table.csv` | `1483dab07b9c` |
