...
B109_A5_best_candidate = B275b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-fixedbranch-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b275_b276_signalblock_fixedbranch_short_20260522T051103Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.2376404544011832` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7869565368284422` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7340348770513268` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8265158221997303` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8981774607876114` | `0.13` | `0` | `1` | `1` |
| `B275b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-fixedbranch-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.1472488743421503` | `2.7195238095238095` | `0` | `0` | `0` |
| `B275b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-fixedbranch-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7709734886164108` | `0.5957142857142858` | `1` | `1` | `1` |
| `B275b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-fixedbranch-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7318570463959099` | `0.12904761904761905` | `1` | `1` | `1` |
| `B276b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-fixedbranch-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.0403224723385347` | `2.7195238095238095` | `0` | `0` | `0` |
| `B276b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-fixedbranch-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7131342984652989` | `0.5957142857142858` | `1` | `1` | `1` |
| `B276b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-fixedbranch-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6797433230895357` | `0.12904761904761905` | `1` | `1` | `1` |
...
| `B275b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-fixedbranch-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.029296875` | `-0.00390625` | `1.0` | `0` | `1` | `1` | `0` |
| `B276b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-fixedbranch-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.028645833333333332` | `-0.00390625` | `1.0` | `0` | `1` | `1` | `0` |
...
| `v1283_b109_fused_backward_correctness.csv` | `44` | `0` | `0` | `0` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `83d4773820e6` |
| `v1283_b109_auc_autopsy_trace.csv` | `72a48c5da1dc` |
| `v1283_b109_fullstep_profile.csv` | `94f41882fd4f` |
| `v1283_b109_functional_control_matrix.csv` | `31cffa614746` |
| `v1283_b109_functional_direction_audit.csv` | `85247e79e75b` |
| `v1283_b109_functional_five_step.csv` | `0111e9e24659` |
| `v1283_b109_functional_one_step.csv` | `90a77f9330b4` |
| `v1283_b109_functional_route.json` | `2dded6657755` |
| `v1283_b109_fused_backward_correctness.csv` | `20a9ffc0876e` |
| `v1283_b109_linec_coupling.csv` | `d0686756a622` |
| `v1283_b109_linec_diagnostics.csv` | `735221c4706b` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `faa22eb3e7fa` |
| `v1283_b109_linec_noise_leak.csv` | `4b160f536e55` |
| `v1283_b109_linec_signal_reservoir.csv` | `69319b968bbc` |
| `v1283_b109_task_autopsy_final.csv` | `218f7139e804` |
