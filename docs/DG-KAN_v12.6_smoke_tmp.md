...
artifact = results/v12_6_lowerlevel_fhq_functional_geometry/v126_smoke_20260520T000000Z
...
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `torch-reference-simple-fast` | `6.01819971115627` | `0.0` | `0.0` | `0` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `FHQ0-triton-two-kernel-forward-exact-B48a` | `2.0445183594698566` | `3.8743019104003906e-07` | `2.957286540095083e-07` | `0` |
...
|---|---|---|---|---|---|---|
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.71374374202882` | `1.001972304689933` | `1` | `0` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.485673386252451` | `0.9087757178151016` | `1` | `0` | `` |
...
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-fixedP-readout-grad` | `quad_readout` | `0.0006664071115665138` | `0.9999999403953552` | `1` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-fixedP-readout-grad` | `branch_scale` | `1.1700767998945594e-07` | `1.0` | `1` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-fixedP-readout-grad` | `logit_gain` | `7.403858859333923e-08` | `1.0` | `1` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-fixedP-readout-grad` | `bias` | `2.975218471590324e-08` | `1.0` | `1` | `` |
...
| `v126_candidate_manifest.csv` | `cec8d16368cc` |
| `v126_expression_audit.csv` | `b0999fdf5812` |
| `v126_failure_table.csv` | `433e200bf0e9` |
| `v126_fullstep_profile.csv` | `98b404df24d1` |
...
| `v126_fused_backward_correctness.csv` | `a36c05f83f40` |
| `v126_fused_forward_profile.csv` | `879590e955ec` |
| `v126_manifold_channel_diagnostics.csv` | `e4ff24be33c8` |
| `v126_provenance_audit.csv` | `d4fe4da0f0be` |
