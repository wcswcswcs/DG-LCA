...
B109_A5_best_candidate = B210b-SimpleFastTaskGeometry-h160-learnableP-fusedProjGradAdamW-logitnormSG150-fixedbranch-fixedgain-manualAdamW-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075
base_qualified = 0
functional_open = 0
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_stopgradlogitnorm_20260521T220000Z
```
...
| `dgkan/kernels/fused_hinge_quadratic.py` | 新增 stop-grad logitnorm effective-delta branch | 让 FHQ fused backward/update 与 B210/B211 的 autograd 语义一致，确保 correctness audit 比对同一个数学 primitive。 |
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.7242360289576149` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.0777727652043936` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `1.05244104794193` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.0051487088536029` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.982255619299139` | `0.13` | `0` | `1` | `1` |
| `B210b-SimpleFastTaskGeometry-h160-learnableP-fusedProjGradAdamW-logitnormSG150-fixedbranch-fixedgain-manualAdamW-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.1582093936385474` | `2.7204761904761905` | `0` | `0` | `0` |
| `B210b-SimpleFastTaskGeometry-h160-learnableP-fusedProjGradAdamW-logitnormSG150-fixedbranch-fixedgain-manualAdamW-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.002516058786997` | `0.5957142857142858` | `0` | `1` | `1` |
| `B210b-SimpleFastTaskGeometry-h160-learnableP-fusedProjGradAdamW-logitnormSG150-fixedbranch-fixedgain-manualAdamW-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9898130407308358` | `0.12904761904761905` | `0` | `1` | `1` |
| `B211b-SimpleFastTaskGeometry-h160-learnableP-warm2PUpdateEvery2-fusedProjGradAdamW-logitnormSG150-fixedbranch-fixedgain-manualAdamW-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `0.8806937702698062` | `2.7204761904761905` | `0` | `0` | `0` |
| `B211b-SimpleFastTaskGeometry-h160-learnableP-warm2PUpdateEvery2-fusedProjGradAdamW-logitnormSG150-fixedbranch-fixedgain-manualAdamW-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7703855436040743` | `0.5957142857142858` | `1` | `1` | `1` |
| `B211b-SimpleFastTaskGeometry-h160-learnableP-warm2PUpdateEvery2-fusedProjGradAdamW-logitnormSG150-fixedbranch-fixedgain-manualAdamW-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7353024260852461` | `0.12904761904761905` | `1` | `1` | `1` |
...
| `B210b-SimpleFastTaskGeometry-h160-learnableP-fusedProjGradAdamW-logitnormSG150-fixedbranch-fixedgain-manualAdamW-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `-0.029296875` | `-0.05078125` | `0.16666666666666666` | `0` | `0` | `0` | `0` |
| `B211b-SimpleFastTaskGeometry-h160-learnableP-warm2PUpdateEvery2-fusedProjGradAdamW-logitnormSG150-fixedbranch-fixedgain-manualAdamW-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `-0.034505208333333336` | `-0.05859375` | `0.16666666666666666` | `0` | `0` | `0` | `0` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `BSpline` | `KernelBlocked` | `2.4644528608575222` | `0.7695797059674971` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
| `Chebyshev` | `KernelBlocked` | `1.019370579924508` | `0.6625224534201902` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
| `Fourier` | `ExpressionBlocked` | `0.9951324641663334` | `0.6066665226882557` | `True` | `True` | `family-specific fused L3 efficiency exists; A4/A5 official family promotion not run in this closed follow-up runner` | `False` |
| `RBF` | `KernelBlocked` | `1.2189089082119697` | `0.6685881807082912` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
| `Rational` | `KernelBlocked` | `1.5280515814871936` | `0.9719553185612003` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
| `Wavelet` | `KernelBlocked` | `2.676552161987875` | `1.2444422839019844` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `BSpline` | `B6r-BSpline-order1-stream-K2-repair` | `L1-vectorized-or-stream-autograd` | `2.4644528608575222` | `1.48` | `0` | `0` | `measured` |
| `BSpline` | `B6r-BSpline-order1-stream-K2-repair` | `L3-analytic-manual-ce-torch-reduction` | `0.7695797059674971` | `1.6147619047619048` | `0` | `0` | `measured` |
| `Rational` | `B7a-RationalKAT-lite-safe-den-K4` | `L1-vectorized-or-stream-autograd` | `1.5280515814871936` | `3.580952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7a-RationalKAT-lite-safe-den-K4` | `L3-analytic-manual-ce-torch-reduction` | `0.9719553185612003` | `3.1019047619047617` | `0` | `0` | `measured` |
| `RBF` | `B2r-FastKAN-RBF-stream-K2-repair` | `L1-vectorized-or-stream-autograd` | `1.2189089082119697` | `1.48` | `0` | `0` | `measured` |
| `RBF` | `B2r-FastKAN-RBF-stream-K2-repair` | `L3-analytic-manual-ce-torch-reduction` | `0.6685881807082912` | `1.6147619047619048` | `0` | `0` | `measured` |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L1-vectorized-or-stream-autograd` | `1.581687255969263` | `4.476666666666667` | `0` | `0` | `measured` |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L3-analytic-manual-ce-torch-reduction` | `0.6625224534201902` | `1.5342857142857143` | `0` | `0` | `measured` |
| `Chebyshev` | `B3a-ChebyKAN-K4` | `L1-vectorized-or-stream-autograd` | `1.019370579924508` | `2.452857142857143` | `0` | `0` | `measured` |
| `Chebyshev` | `B3a-ChebyKAN-K4` | `L3-analytic-manual-ce-torch-reduction` | `0.7126942256418741` | `1.9819047619047618` | `0` | `0` | `measured` |
| `Chebyshev` | `B3d-ChebyKAN-K6-stream` | `L1-vectorized-or-stream-autograd` | `4.662669186652702` | `15.476666666666667` | `0` | `0` | `measured` |
| `Chebyshev` | `B3d-ChebyKAN-K6-stream` | `L3-analytic-manual-ce-torch-reduction` | `0.8273368534235584` | `3.487142857142857` | `0` | `0` | `measured` |
| `Fourier` | `B4b-FourierKAN-lowfreq-K2-stream` | `L1-vectorized-or-stream-autograd` | `1.1634617566182184` | `2.068095238095238` | `0` | `0` | `measured` |
| `Fourier` | `B4b-FourierKAN-lowfreq-K2-stream` | `L3-analytic-manual-ce-torch-reduction` | `0.6693532674302044` | `1.6114285714285714` | `0` | `0` | `measured` |
| `Fourier` | `B4c-FourierKAN-lowfreq-K2-flatgemm-manual` | `L1-vectorized-or-stream-autograd` | `1.1528335769921043` | `2.068095238095238` | `0` | `0` | `measured` |
| `Fourier` | `B4c-FourierKAN-lowfreq-K2-flatgemm-manual` | `L3-analytic-manual-ce-torch-reduction` | `0.6066665226882557` | `1.9052380952380952` | `0` | `0` | `measured` |
| `Fourier` | `B4d-FourierKAN-lowfreq-K2-flatgemm-recompute` | `L1-vectorized-or-stream-autograd` | `1.2657370807119321` | `2.068095238095238` | `0` | `0` | `measured` |
| `Fourier` | `B4d-FourierKAN-lowfreq-K2-flatgemm-recompute` | `L3-analytic-manual-ce-torch-reduction` | `0.704221356047409` | `2.277142857142857` | `0` | `0` | `measured` |
| `Fourier` | `B4e-FourierKAN-lowfreq-K2-tritonL3` | `L1-vectorized-or-stream-autograd` | `1.2991892949920385` | `2.068095238095238` | `0` | `0` | `measured` |
| `Fourier` | `B4e-FourierKAN-lowfreq-K2-tritonL3` | `L3-analytic-manual-ce-torch-reduction` | `1.111850174298341` | `0.9990476190476191` | `1` | `1` | `measured` |
| `Fourier` | `B4a-FourierKAN-lowfreq-K4` | `L1-vectorized-or-stream-autograd` | `0.9951324641663334` | `2.973809523809524` | `0` | `0` | `measured` |
| `Fourier` | `B4a-FourierKAN-lowfreq-K4` | `L3-analytic-manual-ce-torch-reduction` | `0.7003734680430691` | `2.973809523809524` | `0` | `0` | `measured` |
| `Wavelet` | `B5h-HatWaveletKAN-local-K4` | `L1-vectorized-or-stream-autograd` | `2.676552161987875` | `2.0633333333333335` | `0` | `0` | `measured` |
| `Wavelet` | `B5h-HatWaveletKAN-local-K4` | `L3-analytic-manual-ce-torch-reduction` | `1.2444422839019844` | `3.4757142857142855` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `BSpline` | `B6r-BSpline-order1-stream-K2-repair` | `L2_torch_compile_forward_attempt` | `0.9935194740426684` | `0` | `measured` |
| `Rational` | `B7a-RationalKAT-lite-safe-den-K4` | `L2_torch_compile_forward_attempt` | `0.7311928671388568` | `0` | `measured` |
| `RBF` | `B2r-FastKAN-RBF-stream-K2-repair` | `L2_torch_compile_forward_attempt` | `0.8792751647070363` | `0` | `measured` |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L2_torch_compile_forward_attempt` | `1050.2669849598196` | `0` | `measured` |
| `Chebyshev` | `B3a-ChebyKAN-K4` | `L2_torch_compile_forward_attempt` | `0.7311652375248839` | `0` | `measured` |
| `Chebyshev` | `B3d-ChebyKAN-K6-stream` | `L2_torch_compile_forward_attempt` | `1296.7752855865974` | `0` | `measured` |
| `Fourier` | `B4b-FourierKAN-lowfreq-K2-stream` | `L2_torch_compile_forward_attempt` | `1544.5359026111366` | `0` | `measured` |
| `Fourier` | `B4c-FourierKAN-lowfreq-K2-flatgemm-manual` | `L2_torch_compile_forward_attempt` | `1449.8266815037694` | `0` | `measured` |
| `Fourier` | `B4d-FourierKAN-lowfreq-K2-flatgemm-recompute` | `L2_torch_compile_forward_attempt` | `1389.0611084172237` | `0` | `measured` |
| `Fourier` | `B4e-FourierKAN-lowfreq-K2-tritonL3` | `L2_torch_compile_forward_attempt` | `1472.1657424560792` | `0` | `measured` |
| `Fourier` | `B4a-FourierKAN-lowfreq-K4` | `L2_torch_compile_forward_attempt` | `0.823403940811841` | `0` | `measured` |
| `Wavelet` | `B5h-HatWaveletKAN-local-K4` | `L2_torch_compile_forward_attempt` | `1.301531647650585` | `0` | `measured` |

## 7. Provenance / Hash

| artifact | rows_checked | fake_data_used_sum | proxy_row_used_sum | cpu_offload_used_sum | no_fake_pass |
| --- | --- | --- | --- | --- | --- |
| `v1283_b109_auc_attribution.csv` | `28` | `0` | `0` | `0` | `1` |
| `v1283_b109_auc_autopsy_trace.csv` | `90` | `0` | `0` | `0` | `1` |
| `v1283_b109_fullstep_profile.csv` | `12` | `0` | `0` | `0` | `1` |
| `v1283_b109_fused_backward_correctness.csv` | `47` | `0` | `0` | `0` | `1` |
| `v1283_b109_task_autopsy_final.csv` | `30` | `0` | `0` | `0` | `1` |
...
| `v1283_modification_audit.csv` | `10` | `0` | `0` | `0` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `7ab7630d7584` |
| `v1283_b109_auc_autopsy_trace.csv` | `735a6c4b59b0` |
| `v1283_b109_fullstep_profile.csv` | `a2aafd5ef4b2` |
| `v1283_b109_fused_backward_correctness.csv` | `8366a470b8d0` |
| `v1283_b109_task_autopsy_final.csv` | `543d79b10c29` |
| `v1283_family_component_profile.csv` | `879e8192094c` |
| `v1283_family_efficiency.csv` | `2f90591346b3` |
| `v1283_family_expression.csv` | `76c9544dff8d` |
| `v1283_family_failure_table.csv` | `dd32342ecbb4` |
| `v1283_family_functional_diagnostic.csv` | `1d6e4a104e2e` |
| `v1283_family_geometry_lineC.csv` | `638f0fbe6eeb` |
| `v1283_family_gradcheck.csv` | `07187ca6fe7f` |
| `v1283_family_manifest.csv` | `11e329d07a77` |
| `v1283_family_status.json` | `60c5651d835c` |
| `v1283_family_task_triage.csv` | `79b35448eb0d` |
| `v1283_modification_audit.csv` | `c0fac63fbfd7` |
| `v1283_provenance_audit.csv` | `b70302abeed1` |
| `v1283_route_decision.json` | `03b7c5c159b3` |
| `v1283_run_manifest.csv` | `b79f75ddba14` |
...
30. 当前 blocker 已收窄到 Fashion-MNIST NLL/AUC trajectory：不能用 dataset-specific branch 修；下一步应把工程投入放在 classic family L3 kernels，或更细粒度的 block-sparse / fused projection-gradient accumulation；不应靠 dense random pair trajectory 或继续温度/epoch小修。
