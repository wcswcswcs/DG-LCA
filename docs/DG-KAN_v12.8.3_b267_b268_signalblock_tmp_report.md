...
B109_A5_best_candidate = B267b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b267_b268_signalblock_short_20260522T050144Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.1763645454455725` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7663394439043169` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7246637294141453` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8146469559831612` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.7945845383389183` | `0.13` | `1` | `1` | `1` |
| `B267b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.2263377850769528` | `2.719047619047619` | `0` | `0` | `0` |
| `B267b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.767187323646311` | `0.5961904761904762` | `1` | `1` | `1` |
| `B267b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7254126229364967` | `0.1295238095238095` | `1` | `1` | `1` |
| `B268b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock020-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.218284489037402` | `2.719047619047619` | `0` | `0` | `0` |
| `B268b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock020-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7707660868154376` | `0.5961904761904762` | `1` | `1` | `1` |
| `B268b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock020-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7377403136124132` | `0.1295238095238095` | `1` | `1` | `1` |
...
| `B267b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.025390625` | `-0.01171875` | `0.8333333333333334` | `0` | `1` | `1` | `0` |
| `B268b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock020-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.021484375` | `-0.01953125` | `0.8333333333333334` | `1` | `1` | `1` | `0` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `7e3497fa3565` |
| `v1283_b109_auc_autopsy_trace.csv` | `eae1135a6204` |
| `v1283_b109_fullstep_profile.csv` | `663591b40922` |
| `v1283_b109_functional_control_matrix.csv` | `000e89ae0348` |
| `v1283_b109_functional_direction_audit.csv` | `560ed68e000f` |
| `v1283_b109_functional_five_step.csv` | `fadf1efb68df` |
| `v1283_b109_functional_one_step.csv` | `6377e76228a4` |
| `v1283_b109_functional_route.json` | `9c866965090b` |
| `v1283_b109_fused_backward_correctness.csv` | `ab028f432d5c` |
| `v1283_b109_linec_coupling.csv` | `4d0f6c5332ec` |
| `v1283_b109_linec_diagnostics.csv` | `65ba9c3f70ff` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `4ec9779bbc3b` |
| `v1283_b109_linec_noise_leak.csv` | `e2b6233783b8` |
| `v1283_b109_linec_signal_reservoir.csv` | `0d41adc38901` |
| `v1283_b109_task_autopsy_final.csv` | `1f50caf455df` |
