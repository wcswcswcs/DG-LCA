...
|---|---|---:|---:|---:|
| `B39a-GatedLegendreQuadratic-h176-lowboost-temp075-directskip-cosine-lr-final050` | `GatedHybrid` | `6.669866403393774` | `1.0962851679868888` | `0` |
| `B39a-GatedLegendreQuadratic-h176-lowboost-temp075-directskip-cosine-lr-final050` | `GatedHybrid` | `2.2433983063496603` | `0.4423654739142311` | `0` |
