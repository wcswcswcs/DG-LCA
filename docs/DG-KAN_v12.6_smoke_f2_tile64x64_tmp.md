...
artifact = results/v12_6_lowerlevel_fhq_functional_geometry/v126_smoke_f2_tile64x64_20260520T034500Z
...
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `torch-reference-simple-fast` | `4.43670865368886` | `0.0` | `0.0` | `0` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `FHQ0-triton-two-kernel-forward-exact-B48a` | `2.3407524946834615` | `5.364418029785156e-07` | `3.60195059556645e-07` | `0` |
...
|---|---|---|---|---|---|---|
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.316071428048451` | `2.0357142857142856` | `1` | `0` | `` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.9927339564968709` | `0.4719047619047619` | `1` | `1` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.888732009513509` | `0.09857142857142857` | `1` | `1` | `` |
...
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `F2-triton-learnableP-proj-grad` | `quad_readout` | `0.000652758521027863` | `1.0` | `1` | `` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `F2-triton-learnableP-proj-grad` | `branch_scale` | `7.596117939101532e-07` | `0.9999999403953552` | `1` | `` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `F2-triton-learnableP-proj-grad` | `logit_gain` | `7.048337806736527e-07` | `1.0` | `1` | `` |
...
|---|---|---|---|---|
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `1` | `1` | `` | `` |
...
|---|---|---|---|---|---|---|---|---|---|
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `-0.0234375` | `-0.0234375` | `0.0` | `1` | `0` | `1` | `0` | `` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `-0.375` | `-0.375` | `0.0` | `1` | `0` | `0` | `0` | `` | `` |
...
|---|---|---|---|
| `A5_task_gate_fail` | `B48a-SimpleFastTaskGeometry-h128-temp075` | `` | `if AUC-step fails return to Line P/C; if AUC-step passes and AUC-time fails return to Line A` |
...
|---|---|
| `v126_auc_attribution.csv` | `dfc3a095adff` |
| `v126_candidate_manifest.csv` | `1d6365284794` |
| `v126_expression_audit.csv` | `4b18056eb525` |
| `v126_expression_summary.csv` | `f1bb4bcbd10c` |
| `v126_failure_table.csv` | `0e73dae580e7` |
| `v126_frozen_readout.csv` | `5370a8eb6da8` |
| `v126_fullstep_profile.csv` | `bfae33e0d3e8` |
...
| `v126_fused_backward_correctness.csv` | `32a93ce19f37` |
| `v126_fused_forward_profile.csv` | `6bf6b7fd917e` |
