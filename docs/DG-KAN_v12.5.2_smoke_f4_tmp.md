...
```text
results/v12_5_2_efficiency_functional_manifold/smoke_v1252_f4
```
...
5. No-fake audit rows checked = `143`，fake/proxy/cpu = `0` / `0` / `0`。
...
|---|---|---:|---:|---:|---:|
| `F0-current-B47-manual-autograd-forward` | `B47b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final050` | `9.62454407431943` | `1.0` | `0.0` | `0` |
| `F0b-current-B42-fastreuse-forward` | `B42b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-final075` | `10.83444130254906` | `1.1257095628517015` | `` | `0` |
| `K2-current-LiteGated-forward` | `B30b-LiteGatedLegendreQuadratic-h256-temp050-cosine-lr-final050` | `6.47196910918244` | `0.6724442279246443` | `` | `0` |
| `F2-triton-residual-input-norm-plus-legendre-basis` | `B47b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final050` | `1.1264399518490928` | `0.11703826624418523` | `0.0009468495845794678` | `0` |
| `F3-triton-residual-input-norm-legendre-hidden-preactivation` | `B47b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final050` | `1.7637306126867844` | `0.18325341949369184` | `2.047792077064514e-05` | `0` |
| `F4-triton-hybrid-full-forward-with-torch-readouts` | `B47b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final050` | `8.672875418549442` | `0.9011206506592591` | `0.0005792379379272461` | `0` |
...
| `B47b-GatedLegendreQuadratic-h168-lowboost-temp075-directskip-fastreuse-manualbw-final050` | `3.065188929530149` | `2.4892115756769013` | `2.2880245217484867` | `1.044479897894065` | `0` |
...
| artifact | SHA256 |
|---|---|
| `v125_backward_kernel_truth.csv` | `16fa5e7045e429bd5f78b1df409d296feba300e96be73dc908afa75687aed620` |
| `v125_control_matrix.csv` | `382c7c5a42c337374c4a20e8adca5b1b7ed8add7693816f072eada6c515df6a0` |
| `v125_forward_kernel_truth.csv` | `08f998fa9a2ee0a3203538369e21868d5522128ad196c63d8c85ab4c319c24ea` |
| `v125_full_step_efficiency.csv` | `a1e3f100c42863da0d8bd0ae20071c80d8b69cafac52cf34dfaca5ba7e92ca55` |
| `v125_provenance_audit.csv` | `0df64eb5887e5a585391cd3e6df761a17c57cfbb8a27608bc7f5ceeb36003c08` |
| `v125_route_decision.json` | `cde52e5c97fc094cf0cb64669dfdbf01018fe7b260beaf569cfa680b3b68f055` |
| `v125_signal_reservoir_sketch.csv` | `a806f762432cebd6d6d31e0876d0680096a99e27f9aa212b939c28da0f0c001b` |
| `v125_train_probe_coupling.csv` | `98fb6f019eb186772823ccc8c3c55d353b9d1c7a3c6051013ef89bc6a49f7942` |
