...
artifact = results/v12_6_lowerlevel_fhq_functional_geometry/v126_smoke_repair3_20260520T002000Z
...
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `torch-reference-simple-fast` | `4.289608766943938` | `0.0` | `0.0` | `0` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `FHQ0-triton-two-kernel-forward-exact-B48a` | `1.4587916497502667` | `3.5762786865234375e-07` | `2.904331779518543e-07` | `0` |
...
|---|---|---|---|---|---|---|
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.429453231458667` | `0.7819047619047619` | `1` | `0` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.965419370227797` | `0.09857142857142857` | `1` | `1` | `` |
...
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-fixedP-readout-grad` | `bias` | `2.975218471590324e-08` | `1.0000001192092896` | `1` | `` |
...
|---|---|---|---|---|---|---|---|---|---|
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `-0.515625` | `-0.515625` | `0.0` | `1` | `0` | `0` | `0` | `` | `` |
...
|---|---|
| `v126_auc_attribution.csv` | `b36299e1b676` |
| `v126_candidate_manifest.csv` | `6c4a6c4fd991` |
| `v126_expression_audit.csv` | `fb99d14fdc06` |
| `v126_expression_summary.csv` | `917864dd2bd1` |
| `v126_failure_table.csv` | `3dc169ff77f6` |
| `v126_frozen_readout.csv` | `0ba3383be19a` |
| `v126_fullstep_profile.csv` | `a0ee9867d04b` |
...
| `v126_fused_backward_correctness.csv` | `2b3d33d8e1de` |
| `v126_fused_forward_profile.csv` | `8639b9f841c3` |
