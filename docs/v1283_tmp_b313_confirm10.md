...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b313_directfixed135_confirm10_seed0to9_20260522T103000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.4788861728376717` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.9821418319093765` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.918716257153838` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8860642594152377` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8306071128720789` | `0.13` | `1` | `1` | `1` |
| `B313b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp135-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.2485044270287275` | `2.719047619047619` | `0` | `0` | `0` |
| `B313b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp135-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8088550371485489` | `0.5961904761904762` | `1` | `1` | `1` |
| `B313b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp135-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7398743559108928` | `0.1295238095238095` | `1` | `1` | `1` |
...
| `B313b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp135-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.015950520833333332` | `-0.015625` | `0.9666666666666667` | `1` | `0` | `0` | `0` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `9238b987d8fc` |
| `v1283_b109_auc_autopsy_trace.csv` | `dab95cff2939` |
| `v1283_b109_fullstep_profile.csv` | `6685b4d1b4ac` |
...
| `v1283_b109_fused_backward_correctness.csv` | `4e59546c53e3` |
| `v1283_b109_linec_coupling.csv` | `154784e28640` |
| `v1283_b109_linec_diagnostics.csv` | `38b081e58773` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `ececdb9e0117` |
| `v1283_b109_linec_noise_leak.csv` | `ae60b237664e` |
| `v1283_b109_linec_signal_reservoir.csv` | `90eebfd90931` |
| `v1283_b109_task_autopsy_final.csv` | `ec58e0b2f7f3` |
