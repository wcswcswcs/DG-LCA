...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7ft_b7fu_gridpair_hiddensq_20260522T034000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.5398048060966882` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.1088103018416557` | `0.5961904761904762` | `0` | `1` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9520676023080522` | `0.1295238095238095` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.023409784311462` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.9674945333594914` | `0.13` | `0` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `1.6474560751801912` | `1.5871946662131742` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7ft-RationalKAT-flashgroup-G16-h32-linearresGain19200-gridPairCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.9240360729519626` | `0.8623809523809524` | `0` | `0` | `measured` |
| `Rational` | `B7ft-RationalKAT-flashgroup-G16-h32-linearresGain19200-gridPairCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.5871946662131742` | `0.7652380952380953` | `0` | `0` | `measured` |
| `Rational` | `B7fu-RationalKAT-flashgroup-G16-h32-linearresGain19200-gridPairCrossR112-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.6474560751801912` | `0.8847619047619047` | `0` | `0` | `measured` |
| `Rational` | `B7fu-RationalKAT-flashgroup-G16-h32-linearresGain19200-gridPairCrossR112-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.8239350315087361` | `0.7647619047619048` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7ft-RationalKAT-flashgroup-G16-h32-linearresGain19200-gridPairCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7fu-RationalKAT-flashgroup-G16-h32-linearresGain19200-gridPairCrossR112-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `e016343513e4` |
| `v1283_b109_auc_autopsy_trace.csv` | `e7873a1e74c9` |
| `v1283_b109_fullstep_profile.csv` | `e19256520ab8` |
...
| `v1283_b109_fused_backward_correctness.csv` | `8ac6534558a3` |
| `v1283_b109_linec_coupling.csv` | `1a2692456c60` |
| `v1283_b109_linec_diagnostics.csv` | `fed119f8d968` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `0b655a05202e` |
| `v1283_b109_task_autopsy_final.csv` | `b416a7ffa1b8` |
| `v1283_family_component_profile.csv` | `03eb42ceafb6` |
| `v1283_family_efficiency.csv` | `beab0960f2ac` |
| `v1283_family_expression.csv` | `6cb496ba8407` |
| `v1283_family_failure_table.csv` | `6f7aa579b043` |
| `v1283_family_functional_diagnostic.csv` | `66bd0a3c5ae4` |
