...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7fz_b7ga_pairsumsq_r64_20260522T042000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.5276352472543975` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.9956961379896775` | `0.5961904761904762` | `0` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9407666732342123` | `0.1295238095238095` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.0080477543396182` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.9774654269592726` | `0.13` | `0` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `1.4184772255273965` | `1.442150452723367` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fz-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairSumSqCrossR64-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.4184772255273965` | `0.85` | `0` | `0` | `measured` |
| `Rational` | `B7fz-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairSumSqCrossR64-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.8515538037016466` | `0.7576190476190476` | `0` | `0` | `measured` |
| `Rational` | `B7ga-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairSumSqCrossR64-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.4450193737494061` | `0.85` | `0` | `0` | `measured` |
| `Rational` | `B7ga-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairSumSqCrossR64-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.442150452723367` | `0.7576190476190476` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fz-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairSumSqCrossR64-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7ga-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairSumSqCrossR64-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `cc1260bf4114` |
| `v1283_b109_auc_autopsy_trace.csv` | `a790f20863d7` |
| `v1283_b109_fullstep_profile.csv` | `2e249c90e405` |
...
| `v1283_b109_fused_backward_correctness.csv` | `900c6f407fe2` |
| `v1283_b109_linec_coupling.csv` | `7a05f3b41d50` |
| `v1283_b109_linec_diagnostics.csv` | `7bdb89211609` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `49056e37722e` |
| `v1283_b109_task_autopsy_final.csv` | `f3bd185e49d8` |
| `v1283_family_component_profile.csv` | `2e6a6da548f3` |
| `v1283_family_efficiency.csv` | `d0e782259722` |
| `v1283_family_expression.csv` | `27bd83eee943` |
| `v1283_family_failure_table.csv` | `b8b47cd2fcfb` |
| `v1283_family_functional_diagnostic.csv` | `18fd91cbb496` |
