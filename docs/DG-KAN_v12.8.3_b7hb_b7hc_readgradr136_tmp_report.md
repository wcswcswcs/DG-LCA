...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7hb_b7hc_readgradr136_20260522T200000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.5356287145999337` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.1076532962198602` | `0.5961904761904762` | `0` | `1` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9348566308422624` | `0.1295238095238095` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.0916362317952284` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `1.0002391798566639` | `0.13` | `0` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `1.1600169800020128` | `` | `False` | `False` | `L2 forward attempt failed or missing; L3 also missing` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7hb-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-readGradR136-crossZero-b32-hiddenSqReadoutZero-hiddenSqSigned-hiddenSqScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.2811348490432746` | `0.9180952380952381` | `1` | `0` | `measured` |
| `Rational` | `B7hb-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-readGradR136-crossZero-b32-hiddenSqReadoutZero-hiddenSqSigned-hiddenSqScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `` | `` | `` | `0` | `failed` |
| `Rational` | `B7hc-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-readGradR136-crossZero-b32-hiddenSqReadoutZero-hiddenSqScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.1600169800020128` | `0.9180952380952381` | `1` | `0` | `measured` |
| `Rational` | `B7hc-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-readGradR136-crossZero-b32-hiddenSqReadoutZero-hiddenSqScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `` | `` | `` | `0` | `failed` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7hb-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-readGradR136-crossZero-b32-hiddenSqReadoutZero-hiddenSqSigned-hiddenSqScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7hc-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-readGradR136-crossZero-b32-hiddenSqReadoutZero-hiddenSqScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `4a22fe3a2ab4` |
| `v1283_b109_auc_autopsy_trace.csv` | `de2c186a7bab` |
| `v1283_b109_fullstep_profile.csv` | `61af5eaf3d84` |
...
| `v1283_b109_fused_backward_correctness.csv` | `d5cd39576bc3` |
| `v1283_b109_linec_coupling.csv` | `8d87be1f062c` |
| `v1283_b109_linec_diagnostics.csv` | `cfc1b6c3e836` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `393dc4987ffa` |
| `v1283_b109_task_autopsy_final.csv` | `985ce10bdaa7` |
| `v1283_family_component_profile.csv` | `ab9e6329f0b8` |
| `v1283_family_efficiency.csv` | `9a94ac3eaf6e` |
| `v1283_family_expression.csv` | `1b8a173120d6` |
| `v1283_family_failure_table.csv` | `743785d2fa6d` |
| `v1283_family_functional_diagnostic.csv` | `e21574a15920` |
