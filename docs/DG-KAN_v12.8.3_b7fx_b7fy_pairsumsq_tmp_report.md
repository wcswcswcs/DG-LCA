...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7fx_b7fy_pairsumsq_20260522T041000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.2172658604978022` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7867397327023308` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7421424245944096` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8031893851015011` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.7760796270424524` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `1.8880112303899832` | `1.5228533248163734` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fx-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairSumSqCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `2.418530427190935` | `0.9080952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7fx-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairSumSqCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.633392900713917` | `0.7652380952380953` | `0` | `0` | `measured` |
| `Rational` | `B7fy-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairSumSqCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.8880112303899832` | `0.9080952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7fy-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairSumSqCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.5228533248163734` | `0.7652380952380953` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fx-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairSumSqCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7fy-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairSumSqCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `da3a14c86b17` |
| `v1283_b109_auc_autopsy_trace.csv` | `e59003a0e36d` |
| `v1283_b109_fullstep_profile.csv` | `0963566c9750` |
...
| `v1283_b109_fused_backward_correctness.csv` | `5e5820c3311e` |
| `v1283_b109_linec_coupling.csv` | `889a0c76945d` |
| `v1283_b109_linec_diagnostics.csv` | `5e1fbdb01626` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `436055f55319` |
| `v1283_b109_task_autopsy_final.csv` | `c268b56e726a` |
| `v1283_family_component_profile.csv` | `10c2ac1864b2` |
| `v1283_family_efficiency.csv` | `6aa75ab1fdaa` |
| `v1283_family_expression.csv` | `f480accda0a1` |
| `v1283_family_failure_table.csv` | `c176a832173e` |
| `v1283_family_functional_diagnostic.csv` | `bac7870ba958` |
