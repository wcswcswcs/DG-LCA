...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7hh_b7hi_hiddenabs_center_20260522T220000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.3058172703677264` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8360204008849343` | `0.5966666666666667` | `1` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7883596823149298` | `0.5966666666666667` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.7643655936670485` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.7408927568252007` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `TaskBlocked` | `1.8607818186921659` | `1.2482441202980317` | `False` | `True` | `family-specific fused L3 efficiency and A4 expression passed; A5 fused task triage failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7hh-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenAbsReadoutZero-hiddenAbsCenter-hiddenAbsScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `2.4865851414527955` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7hh-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenAbsReadoutZero-hiddenAbsCenter-hiddenAbsScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.2482441202980317` | `0.7747619047619048` | `1` | `1` | `measured` |
| `Rational` | `B7hi-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenAbsReadout-hiddenAbsCenter-hiddenAbsScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.8607818186921659` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7hi-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenAbsReadout-hiddenAbsCenter-hiddenAbsScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.3602581735732309` | `0.7747619047619048` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7hh-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenAbsReadoutZero-hiddenAbsCenter-hiddenAbsScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7hi-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenAbsReadout-hiddenAbsCenter-hiddenAbsScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| `v1283_family_expression.csv` | `82` | `0` | `0` | `0` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `276935ea8a67` |
| `v1283_b109_auc_autopsy_trace.csv` | `d5752e0f93b7` |
| `v1283_b109_fullstep_profile.csv` | `c5288b2a7c61` |
...
| `v1283_b109_fused_backward_correctness.csv` | `5fa15af31277` |
| `v1283_b109_linec_coupling.csv` | `99cd4227f820` |
| `v1283_b109_linec_diagnostics.csv` | `6b3648bd71d0` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `ce8bb0043126` |
| `v1283_b109_linec_noise_leak.csv` | `c41e2b72d266` |
| `v1283_b109_linec_signal_reservoir.csv` | `f1d953c24bf9` |
| `v1283_b109_task_autopsy_final.csv` | `0e293ce79f22` |
| `v1283_family_component_profile.csv` | `c938f52f2c02` |
| `v1283_family_efficiency.csv` | `59bdd56319f6` |
| `v1283_family_expression.csv` | `2da26746d445` |
| `v1283_family_failure_table.csv` | `fa19b0eaa0b3` |
| `v1283_family_functional_diagnostic.csv` | `e14e700b525c` |
