...
artifact = results/v12_6_lowerlevel_fhq_functional_geometry/v126_smoke_f2_tile32x64_20260520T015000Z
...
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `torch-reference-simple-fast` | `4.070181432505741` | `0.0` | `0.0` | `0` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `FHQ0-triton-two-kernel-forward-exact-B48a` | `1.6912141747301686` | `5.364418029785156e-07` | `3.6551779203364276e-07` | `0` |
...
|---|---|---|---|---|---|---|
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.42173328497481` | `2.0357142857142856` | `1` | `0` | `` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.0313057975332711` | `0.4719047619047619` | `1` | `1` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.9573930948217351` | `0.09857142857142857` | `1` | `1` | `` |
...
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `F2-triton-learnableP-proj-grad` | `branch_scale` | `8.861010201144381e-07` | `1.0` | `1` | `` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `F2-triton-learnableP-proj-grad` | `logit_gain` | `8.458005709144345e-07` | `1.0` | `1` | `` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `F2-triton-learnableP-proj-grad` | `bias` | `6.13836945717594e-08` | `1.0` | `1` | `` |
...
|---|---|---|---|---|---|---|---|---|---|
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `-0.0234375` | `-0.0234375` | `0.0` | `1` | `0` | `0` | `0` | `` | `` |
...
|---|---|
| `v126_auc_attribution.csv` | `2e415bddabd4` |
| `v126_candidate_manifest.csv` | `7c647fd15f09` |
| `v126_expression_audit.csv` | `1c3e911ac97e` |
| `v126_expression_summary.csv` | `7cb6ab920b0f` |
| `v126_failure_table.csv` | `1275d967f92d` |
| `v126_frozen_readout.csv` | `9c96921dd1e9` |
| `v126_fullstep_profile.csv` | `285f107c62e6` |
...
| `v126_fused_backward_correctness.csv` | `12104183cc20` |
| `v126_fused_forward_profile.csv` | `242e33d79895` |
