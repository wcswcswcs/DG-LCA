...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7fd_b7fe_lowrank_pairblock_20260522T022000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.4828556960287012` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.2333256087408055` | `0.5961904761904762` | `0` | `1` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `1.007734668083215` | `0.1295238095238095` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.994808476751402` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.9483666964828474` | `0.13` | `0` | `1` | `1` |
...
| `Rational` | `ExpressionBlocked` | `1.2142179700033318` | `1.1846435410851324` | `False` | `True` | `family-specific fused L3 efficiency passed but A4 expression failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fd-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR96-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.2142179700033318` | `0.8638095238095238` | `1` | `0` | `measured` |
| `Rational` | `B7fd-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR96-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.2246425401696097` | `0.7561904761904762` | `1` | `1` | `measured` |
| `Rational` | `B7fe-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR80-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.2203592516791584` | `0.8414285714285714` | `1` | `0` | `measured` |
| `Rational` | `B7fe-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR80-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.1846435410851324` | `0.7566666666666667` | `1` | `1` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fd-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR96-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7fe-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR80-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| `v1283_family_expression.csv` | `134` | `0` | `0` | `0` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `bafb2bbf925f` |
| `v1283_b109_auc_autopsy_trace.csv` | `0bb9c3f0c59a` |
| `v1283_b109_fullstep_profile.csv` | `b58d1581161d` |
...
| `v1283_b109_fused_backward_correctness.csv` | `e98d29165ffb` |
| `v1283_b109_linec_coupling.csv` | `830cb19c0598` |
| `v1283_b109_linec_diagnostics.csv` | `15ceec90c303` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `302c87d5bb5a` |
| `v1283_b109_task_autopsy_final.csv` | `9b8368ca4b28` |
| `v1283_family_component_profile.csv` | `7d405fd60c0c` |
| `v1283_family_efficiency.csv` | `2d7e6c6c9b7d` |
| `v1283_family_expression.csv` | `ee6ec76fe2be` |
| `v1283_family_failure_table.csv` | `0ad39da94e9c` |
| `v1283_family_functional_diagnostic.csv` | `1e3e5c07f01b` |
