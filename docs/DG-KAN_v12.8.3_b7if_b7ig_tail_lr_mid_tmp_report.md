...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7if_b7ig_tail_lr_mid_20260522T130000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.260860852746483` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8342838197361573` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7876950164313958` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8790167751014499` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8176356623708875` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `2.0781936784149226` | `1.3722553914094855` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7if-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale050-hiddenTailReadoutLR125-hiddenTailGradTriton-tritonHiddenTailAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `2.9497029592494086` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7if-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale050-hiddenTailReadoutLR125-hiddenTailGradTriton-tritonHiddenTailAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `2.5395787295285968` | `0.7742857142857142` | `0` | `0` | `measured` |
| `Rational` | `B7ig-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale050-hiddenTailReadoutLR135-hiddenTailGradTriton-tritonHiddenTailAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `2.0781936784149226` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7ig-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale050-hiddenTailReadoutLR135-hiddenTailGradTriton-tritonHiddenTailAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.3722553914094855` | `0.7742857142857142` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7if-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale050-hiddenTailReadoutLR125-hiddenTailGradTriton-tritonHiddenTailAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7ig-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale050-hiddenTailReadoutLR135-hiddenTailGradTriton-tritonHiddenTailAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `30852094400f` |
| `v1283_b109_auc_autopsy_trace.csv` | `d5124810744b` |
| `v1283_b109_fullstep_profile.csv` | `3adcd56a8e83` |
...
| `v1283_b109_fused_backward_correctness.csv` | `6e93121c9438` |
| `v1283_b109_linec_coupling.csv` | `72b28020f74f` |
| `v1283_b109_linec_diagnostics.csv` | `54a657f5846f` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `dd36d4133152` |
| `v1283_b109_task_autopsy_final.csv` | `743e358a6440` |
| `v1283_family_component_profile.csv` | `6c0e61384752` |
| `v1283_family_efficiency.csv` | `e436a0b7b13d` |
| `v1283_family_expression.csv` | `5f81ecd45e1f` |
| `v1283_family_failure_table.csv` | `ae6b762d75e6` |
| `v1283_family_functional_diagnostic.csv` | `2f386df7d3ca` |
