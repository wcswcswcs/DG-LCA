...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7hj_b7hk_hiddenabs_partialcenter_20260522T223000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `2.0152330897531177` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.132569194093222` | `0.5966666666666667` | `0` | `1` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `1.1323018970170988` | `0.5966666666666667` | `0` | `1` | `0` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.0301657749655164` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.9880287064060507` | `0.13` | `0` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `1.4298376838051923` | `1.8230943273637015` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7hj-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenAbsReadoutZero-hiddenAbsCenterMix025-hiddenAbsScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.7233993267943104` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7hj-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenAbsReadoutZero-hiddenAbsCenterMix025-hiddenAbsScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.8230943273637015` | `0.7747619047619048` | `0` | `0` | `measured` |
| `Rational` | `B7hk-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenAbsReadoutZero-hiddenAbsCenterMix010-hiddenAbsScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.4298376838051923` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7hk-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenAbsReadoutZero-hiddenAbsCenterMix010-hiddenAbsScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.8449592995694697` | `0.7747619047619048` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7hj-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenAbsReadoutZero-hiddenAbsCenterMix025-hiddenAbsScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7hk-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenAbsReadoutZero-hiddenAbsCenterMix010-hiddenAbsScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `275d8049dbaa` |
| `v1283_b109_auc_autopsy_trace.csv` | `ba1b9ee23110` |
| `v1283_b109_fullstep_profile.csv` | `822a64fdb2a7` |
...
| `v1283_b109_fused_backward_correctness.csv` | `7d02dfb6d555` |
| `v1283_b109_linec_coupling.csv` | `397f602afbc4` |
| `v1283_b109_linec_diagnostics.csv` | `4bfb076640a3` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `ce8bb0043126` |
| `v1283_b109_linec_noise_leak.csv` | `c41e2b72d266` |
| `v1283_b109_linec_signal_reservoir.csv` | `4c38a4fd316b` |
| `v1283_b109_task_autopsy_final.csv` | `b5546bdf0517` |
| `v1283_family_component_profile.csv` | `04e268279e01` |
| `v1283_family_efficiency.csv` | `a9dfe907e310` |
| `v1283_family_expression.csv` | `b367bfdf3301` |
| `v1283_family_failure_table.csv` | `20ba8ea00f41` |
| `v1283_family_functional_diagnostic.csv` | `ea6879a58f41` |
