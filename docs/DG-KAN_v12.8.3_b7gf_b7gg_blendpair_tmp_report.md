...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7gf_b7gg_blendpair_20260522T045000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.2116084584469813` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7901935944546673` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7598638276293441` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8349254911172883` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.785114008316259` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `ExpressionBlocked` | `1.1797334001270523` | `1.1814856213152591` | `False` | `True` | `family-specific fused L3 efficiency passed but A4 expression failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7gf-RationalKAT-flashgroup-G16-h32-linearresGain19200-blendPairCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `2.376516544176152` | `0.8623809523809524` | `0` | `0` | `measured` |
| `Rational` | `B7gf-RationalKAT-flashgroup-G16-h32-linearresGain19200-blendPairCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.1814856213152591` | `0.7652380952380953` | `1` | `1` | `measured` |
| `Rational` | `B7gg-RationalKAT-flashgroup-G16-h32-linearresGain19200-blendPairCrossR88-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.1797334001270523` | `0.8514285714285714` | `1` | `0` | `measured` |
| `Rational` | `B7gg-RationalKAT-flashgroup-G16-h32-linearresGain19200-blendPairCrossR88-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.1947271366245578` | `0.7657142857142857` | `1` | `1` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7gf-RationalKAT-flashgroup-G16-h32-linearresGain19200-blendPairCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7gg-RationalKAT-flashgroup-G16-h32-linearresGain19200-blendPairCrossR88-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `1c4d2ffc31c2` |
| `v1283_b109_auc_autopsy_trace.csv` | `d5510678793f` |
| `v1283_b109_fullstep_profile.csv` | `afccb3a09acf` |
...
| `v1283_b109_fused_backward_correctness.csv` | `7722e7dfa89c` |
| `v1283_b109_linec_coupling.csv` | `1592d98f52a7` |
| `v1283_b109_linec_diagnostics.csv` | `1086c2090eb2` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `7aa6ed6f9c0f` |
| `v1283_b109_task_autopsy_final.csv` | `15ce52bdcc8a` |
| `v1283_family_component_profile.csv` | `761d9e479305` |
| `v1283_family_efficiency.csv` | `f322ea0f4714` |
| `v1283_family_expression.csv` | `bd9441fc8270` |
| `v1283_family_failure_table.csv` | `7e9932a5a1fe` |
| `v1283_family_functional_diagnostic.csv` | `347142a4d871` |
