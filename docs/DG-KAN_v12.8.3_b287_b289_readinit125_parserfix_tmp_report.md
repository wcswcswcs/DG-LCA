...
B109_A5_best_candidate = B289b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b287_b289_readinit125_parserfix_short_20260522T054500Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.477631389388946` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.9424908957636672` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.8913281624320126` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8768585121419225` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8644283752396291` | `0.13` | `0` | `1` | `1` |
| `B287b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.2503064037500284` | `2.719047619047619` | `0` | `0` | `0` |
| `B287b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7849037643246765` | `0.5961904761904762` | `1` | `1` | `1` |
| `B287b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7338654933317227` | `0.1295238095238095` | `1` | `1` | `1` |
| `B288b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-directReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.2663809643889528` | `2.719047619047619` | `0` | `0` | `0` |
| `B288b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-directReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7921238313475241` | `0.5961904761904762` | `1` | `1` | `1` |
| `B288b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-directReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7518156179248159` | `0.1295238095238095` | `1` | `1` | `1` |
| `B289b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.2416704636157492` | `2.719047619047619` | `0` | `0` | `0` |
...
| `B287b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.020182291666666668` | `-0.0234375` | `0.8333333333333334` | `1` | `0` | `0` | `0` |
| `B288b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-directReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.020182291666666668` | `-0.03125` | `0.8333333333333334` | `1` | `0` | `0` | `0` |
| `B289b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.032552083333333336` | `0.0` | `1.0` | `1` | `1` | `1` | `1` |
...
| `Chebyshev` | `KernelBlocked` | `4.586195808280566` | `1.3443948513914268` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
...
| `Rational` | `KernelBlocked` | `` | `` | `False` | `False` | `L2 forward attempt failed or missing; L3 also missing` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L1-vectorized-or-stream-autograd` | `4.586195808280566` | `3.9695238095238095` | `0` | `0` | `measured` |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L3-analytic-manual-ce-torch-reduction` | `1.3443948513914268` | `2.308095238095238` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L2_torch_compile_forward_attempt` | `2206.4601120084185` | `0` | `measured` |
...
| `v1283_b109_fused_backward_correctness.csv` | `68` | `0` | `0` | `0` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `799fddcdce96` |
| `v1283_b109_auc_autopsy_trace.csv` | `e6e07beb8fb5` |
| `v1283_b109_fullstep_profile.csv` | `0ec1153e67c0` |
| `v1283_b109_functional_control_matrix.csv` | `c79c193bb27d` |
| `v1283_b109_functional_direction_audit.csv` | `964123ef9355` |
| `v1283_b109_functional_five_step.csv` | `b0825dd805eb` |
| `v1283_b109_functional_one_step.csv` | `4e65bea60882` |
| `v1283_b109_functional_route.json` | `47481a5420c5` |
| `v1283_b109_fused_backward_correctness.csv` | `979d23155f77` |
| `v1283_b109_linec_coupling.csv` | `e8a630ea4769` |
| `v1283_b109_linec_diagnostics.csv` | `ebd7502c1444` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `63596e60df17` |
| `v1283_b109_linec_noise_leak.csv` | `c106e025196f` |
| `v1283_b109_linec_signal_reservoir.csv` | `96cddf983fb0` |
| `v1283_b109_task_autopsy_final.csv` | `4c030816abed` |
| `v1283_family_component_profile.csv` | `5f38bbe7a4eb` |
| `v1283_family_efficiency.csv` | `fe6f36929d92` |
| `v1283_family_expression.csv` | `62b9bdfdd290` |
| `v1283_family_failure_table.csv` | `1564da1aa82c` |
| `v1283_family_functional_diagnostic.csv` | `4a1fc9939104` |
