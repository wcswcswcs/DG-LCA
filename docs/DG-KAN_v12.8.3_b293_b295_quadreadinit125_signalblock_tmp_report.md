...
B109_A5_best_candidate = B293b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b293_b295_quadreadinit125_signalblock_short_20260522T060000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.3334857473813362` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8454769988149807` | `0.5966666666666667` | `1` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.8227444435553625` | `0.5966666666666667` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.7734596845791276` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.762717085233746` | `0.13` | `1` | `1` | `1` |
| `B293b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.0319981391447162` | `2.719047619047619` | `0` | `0` | `0` |
| `B293b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.6478815920181618` | `0.5961904761904762` | `1` | `1` | `1` |
| `B293b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.588493830193903` | `0.1295238095238095` | `1` | `1` | `1` |
| `B294b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock020-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `0.9708474802115165` | `2.719047619047619` | `0` | `0` | `0` |
| `B294b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock020-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.6176886159592094` | `0.5961904761904762` | `1` | `1` | `1` |
| `B294b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock020-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.5860485970448593` | `0.1295238095238095` | `1` | `1` | `1` |
| `B295b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock020-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `0.9581476035108679` | `2.719047619047619` | `0` | `0` | `0` |
...
| `B293b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.035807291666666664` | `0.0` | `1.0` | `1` | `1` | `1` | `1` |
| `B294b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock020-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.027994791666666668` | `-0.015625` | `0.8333333333333334` | `1` | `1` | `1` | `0` |
| `B295b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock020-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.025390625` | `-0.01953125` | `0.8333333333333334` | `1` | `1` | `1` | `0` |
...
| `Chebyshev` | `KernelBlocked` | `3.163121279465695` | `1.2133079501758692` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L1-vectorized-or-stream-autograd` | `3.163121279465695` | `3.9695238095238095` | `0` | `0` | `measured` |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L3-analytic-manual-ce-torch-reduction` | `1.2133079501758692` | `2.308095238095238` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L2_torch_compile_forward_attempt` | `2186.4368036208684` | `0` | `measured` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `9bea85c7d4c7` |
| `v1283_b109_auc_autopsy_trace.csv` | `458f8e2e8f3b` |
| `v1283_b109_fullstep_profile.csv` | `d262f69a2465` |
| `v1283_b109_functional_control_matrix.csv` | `86d4a5efdaed` |
| `v1283_b109_functional_direction_audit.csv` | `27bacefcc13c` |
| `v1283_b109_functional_five_step.csv` | `f2a67db64ead` |
| `v1283_b109_functional_one_step.csv` | `4596f9845ada` |
| `v1283_b109_functional_route.json` | `54021e530cef` |
| `v1283_b109_fused_backward_correctness.csv` | `d0260489cadb` |
| `v1283_b109_linec_coupling.csv` | `697e5a4bcb80` |
| `v1283_b109_linec_diagnostics.csv` | `7f13d616f207` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `684219fb9bfe` |
| `v1283_b109_linec_noise_leak.csv` | `44eb1a7bcd3e` |
| `v1283_b109_linec_signal_reservoir.csv` | `e1b39758b2f6` |
| `v1283_b109_task_autopsy_final.csv` | `9d8b493a1109` |
| `v1283_family_component_profile.csv` | `c1d8f11879e0` |
| `v1283_family_efficiency.csv` | `593e8e81d50b` |
| `v1283_family_expression.csv` | `62b9bdfdd290` |
| `v1283_family_failure_table.csv` | `d7614a64268e` |
