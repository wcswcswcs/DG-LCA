...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7ir_b7is_hiddenratresidual_margin_20260522T152000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.967233357439644` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.1240405866309553` | `0.5961904761904762` | `0` | `1` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `1.0802384977708381` | `0.1295238095238095` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.1669534511426674` | `0.13` | `0` | `1` | `0` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `1.096789488283091` | `0.13` | `0` | `1` | `1` |
...
| `Rational` | `TaskBlocked` | `0.8871648022543939` | `0.8350009237655435` | `False` | `True` | `family-specific fused L3 efficiency and A4 expression passed; A5 fused task triage failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7ir-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatResidual015-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `0.8871648022543939` | `0.9195238095238095` | `1` | `0` | `measured` |
| `Rational` | `B7ir-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatResidual015-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `0.8350009237655435` | `0.770952380952381` | `1` | `1` | `measured` |
| `Rational` | `B7is-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatResidual010-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `0.9015366315334981` | `0.9195238095238095` | `1` | `0` | `measured` |
| `Rational` | `B7is-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatResidual010-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `0.8415817663344644` | `0.770952380952381` | `1` | `1` | `measured` |
...
| `Rational` | `B7is-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatResidual010-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| `v1283_family_expression.csv` | `132` | `0` | `0` | `0` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `0634c344f521` |
| `v1283_b109_auc_autopsy_trace.csv` | `7cee5d6cb97e` |
| `v1283_b109_fullstep_profile.csv` | `fc719ea9f49d` |
...
| `v1283_b109_fused_backward_correctness.csv` | `d7cc8a7cc4ef` |
| `v1283_b109_linec_coupling.csv` | `9d428dd749fa` |
| `v1283_b109_linec_diagnostics.csv` | `42e15bf2d823` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `597366eb512f` |
| `v1283_b109_task_autopsy_final.csv` | `2f0c45a5428d` |
| `v1283_family_component_profile.csv` | `a4a8b6253b23` |
| `v1283_family_efficiency.csv` | `c388b3e0c8d6` |
| `v1283_family_expression.csv` | `7ca0254ee46a` |
| `v1283_family_failure_table.csv` | `6530cbdaa260` |
| `v1283_family_functional_diagnostic.csv` | `9c9e9a4a1370` |
