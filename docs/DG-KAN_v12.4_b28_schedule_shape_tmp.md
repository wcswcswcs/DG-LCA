...
```text
results/v12_4_multibasis_functional_dual/v124_multibasis_functional_dual_b28_schedule_shape_20260520T010000Z
```
...
|---|---|---:|---:|---:|
| `B28a-GatedLegendreQuadratic-h228-lowboost-temp050-cosine-lr-final050` | `GatedHybrid` | `7.46403875761044` | `1.0781890193936083` | `0` |
| `B28a-GatedLegendreQuadratic-h228-lowboost-temp050-cosine-lr-final050` | `GatedHybrid` | `1.7564064506855832` | `0.4808795411089866` | `0` |
| `B28b-GatedLegendreQuadratic-h228-lowboost-temp050-cosine-lr-final075` | `GatedHybrid` | `5.3737542169193295` | `1.118700491668943` | `0` |
| `B28b-GatedLegendreQuadratic-h228-lowboost-temp050-cosine-lr-final075` | `GatedHybrid` | `2.2076160887434293` | `0.48125512155148864` | `0` |
...
| artifact | SHA256 |
|---|---|
| `v124_basis_manifest.csv` | `ed852140bcb1291f108b93af14ffb95d0194bf80d40a2bff970b92f6fc918574` |
| `v124_control_matrix.csv` | `006a7aededa28db873fe47ee3f27dd65cfe1e883f7c9029e997e1a607b4eaad6` |
| `v124_efficiency_microbench.csv` | `72a5621d1f8509766f443b2e39ae2144c70f33385b748934899a5e5a3e6b1fd0` |
| `v124_expression_battery.csv` | `63c47c657ba5742cb08a5fc6b346d11f936808b2936cd092d161e67bd67d5dab` |
