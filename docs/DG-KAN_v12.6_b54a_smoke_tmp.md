...
artifact = results/v12_6_lowerlevel_fhq_functional_geometry/v126_b54a_identitytail_learnablep_smoke_20260520T024500Z
...
| `B54a-SimpleFastTaskGeometry-h128-learnableP-identitytail-temp075` | `torch-reference-simple-fast` | `2.4244280837621646` | `0.0` | `0.0` | `0` |
| `B54a-SimpleFastTaskGeometry-h128-learnableP-identitytail-temp075` | `FHQ0-triton-two-kernel-forward-exact-B48a` | `0.9787246431664834` | `1.6763806343078613e-07` | `3.492494045076455e-07` | `1` |
...
|---|---|---|---|---|---|---|
| `B54a-SimpleFastTaskGeometry-h128-learnableP-identitytail-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.5478994630675282` | `2.0357142857142856` | `1` | `0` | `` |
| `B54a-SimpleFastTaskGeometry-h128-learnableP-identitytail-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.106874371107101` | `0.4719047619047619` | `1` | `0` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.0348323506665225` | `0.09857142857142857` | `1` | `1` | `` |
...
|---|---|---|---|---|---|---|
| `B54a-SimpleFastTaskGeometry-h128-learnableP-identitytail-temp075` | `B48a-existing-manual-ce-torch-reduction` | `direct_readout` | `9.029608349919727e-08` | `0.9999999403953552` | `1` | `` |
| `B54a-SimpleFastTaskGeometry-h128-learnableP-identitytail-temp075` | `B48a-existing-manual-ce-torch-reduction` | `quad_proj` | `1.0503832470476482e-07` | `0.9999998807907104` | `1` | `` |
| `B54a-SimpleFastTaskGeometry-h128-learnableP-identitytail-temp075` | `B48a-existing-manual-ce-torch-reduction` | `quad_readout` | `7.486907804832299e-08` | `1.0` | `1` | `` |
| `B54a-SimpleFastTaskGeometry-h128-learnableP-identitytail-temp075` | `B48a-existing-manual-ce-torch-reduction` | `branch_scale` | `2.179395330870193e-09` | `1.0000001192092896` | `1` | `` |
| `B54a-SimpleFastTaskGeometry-h128-learnableP-identitytail-temp075` | `B48a-existing-manual-ce-torch-reduction` | `logit_gain` | `9.795133593115679e-08` | `1.0` | `1` | `` |
| `B54a-SimpleFastTaskGeometry-h128-learnableP-identitytail-temp075` | `B48a-existing-manual-ce-torch-reduction` | `bias` | `5.0510223559285805e-08` | `1.0` | `1` | `` |
| `B54a-SimpleFastTaskGeometry-h128-learnableP-identitytail-temp075` | `F2-triton-learnableP-proj-grad` | `direct_readout` | `0.0007740856963209808` | `0.9999999403953552` | `1` | `` |
| `B54a-SimpleFastTaskGeometry-h128-learnableP-identitytail-temp075` | `F2-triton-learnableP-proj-grad` | `quad_proj` | `0.0015196530148386955` | `0.9999998807907104` | `1` | `` |
| `B54a-SimpleFastTaskGeometry-h128-learnableP-identitytail-temp075` | `F2-triton-learnableP-proj-grad` | `quad_readout` | `0.0008702888735570014` | `1.0` | `1` | `` |
| `B54a-SimpleFastTaskGeometry-h128-learnableP-identitytail-temp075` | `F2-triton-learnableP-proj-grad` | `branch_scale` | `9.361752745462582e-06` | `1.0` | `1` | `` |
| `B54a-SimpleFastTaskGeometry-h128-learnableP-identitytail-temp075` | `F2-triton-learnableP-proj-grad` | `logit_gain` | `2.2258152512222296e-06` | `1.0` | `1` | `` |
| `B54a-SimpleFastTaskGeometry-h128-learnableP-identitytail-temp075` | `F2-triton-learnableP-proj-grad` | `bias` | `8.254210115410388e-08` | `0.9999999403953552` | `1` | `` |
...
|---|---|
| `v126_auc_attribution.csv` | `61b1df6d19c2` |
| `v126_candidate_manifest.csv` | `159eeee936ee` |
| `v126_expression_audit.csv` | `e09a281c0d39` |
| `v126_expression_summary.csv` | `ac91b51a898e` |
| `v126_failure_table.csv` | `4a7aff35f288` |
| `v126_frozen_readout.csv` | `1a7517024962` |
| `v126_fullstep_profile.csv` | `b68881854591` |
...
| `v126_fused_backward_correctness.csv` | `ebf6af738c4c` |
| `v126_fused_forward_profile.csv` | `d890f0d9ccb4` |
