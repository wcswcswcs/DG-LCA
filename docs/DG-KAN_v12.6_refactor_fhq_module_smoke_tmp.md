...
artifact = results/v12_6_lowerlevel_fhq_functional_geometry/v126_refactor_fhq_module_smoke_20260520T050000Z
...
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `torch-reference-simple-fast` | `4.468873292358893` | `0.0` | `0.0` | `0` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `FHQ0-triton-two-kernel-forward-exact-B48a` | `1.8538742317292467` | `4.76837158203125e-07` | `3.6405481296242215e-07` | `0` |
...
|---|---|---|---|---|---|---|
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.4084911078348321` | `2.0357142857142856` | `1` | `0` | `` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.207240895099796` | `0.4719047619047619` | `1` | `0` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.0552786016280684` | `0.09857142857142857` | `1` | `1` | `` |
...
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `F2-triton-learnableP-proj-grad` | `branch_scale` | `6.330702717605163e-07` | `0.9999999403953552` | `1` | `` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `F2-triton-learnableP-proj-grad` | `logit_gain` | `4.2290028545721725e-07` | `1.0` | `1` | `` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `F2-triton-learnableP-proj-grad` | `bias` | `4.0042309024101996e-08` | `1.0` | `1` | `` |
...
|---|---|
| `v126_auc_attribution.csv` | `0844ae096746` |
| `v126_candidate_manifest.csv` | `5822f98214d6` |
| `v126_expression_audit.csv` | `d4a6f0901034` |
| `v126_expression_summary.csv` | `ac08f4cc1ac2` |
| `v126_failure_table.csv` | `4a7aff35f288` |
| `v126_frozen_readout.csv` | `e54ef766e4c7` |
| `v126_fullstep_profile.csv` | `c1a4e2e0ad72` |
...
| `v126_fused_backward_correctness.csv` | `ed224846fbd4` |
| `v126_fused_forward_profile.csv` | `f2a4ceb5bab4` |
