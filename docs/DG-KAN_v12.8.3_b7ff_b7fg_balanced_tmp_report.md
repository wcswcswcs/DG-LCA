...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7ff_b7fg_balanced_pairblock_20260522T023000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.2225021096001927` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8021733973853805` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7484563805496273` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8101304991002277` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.7792624969331285` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `ExpressionBlocked` | `1.5032166450598319` | `1.1024279899096878` | `False` | `True` | `family-specific fused L3 efficiency passed but A4 expression failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7ff-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairCrossR96-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `2.1259191997583127` | `0.8638095238095238` | `0` | `0` | `measured` |
| `Rational` | `B7ff-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairCrossR96-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.1024279899096878` | `0.7561904761904762` | `1` | `1` | `measured` |
| `Rational` | `B7fg-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairCrossR88-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.5032166450598319` | `0.8528571428571429` | `0` | `0` | `measured` |
| `Rational` | `B7fg-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairCrossR88-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.1372513651177714` | `0.7566666666666667` | `1` | `1` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7ff-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairCrossR96-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7fg-RationalKAT-flashgroup-G16-h32-linearresGain19200-balancedPairCrossR88-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `0a893c928afd` |
| `v1283_b109_auc_autopsy_trace.csv` | `a49d7ad16cdc` |
| `v1283_b109_fullstep_profile.csv` | `7e8f96f990b5` |
...
| `v1283_b109_fused_backward_correctness.csv` | `fd4ae582b06f` |
| `v1283_b109_linec_coupling.csv` | `d11206a08ac1` |
| `v1283_b109_linec_diagnostics.csv` | `5c6a4f277b38` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `c596c3407d57` |
| `v1283_b109_task_autopsy_final.csv` | `4a04f8514bdd` |
| `v1283_family_component_profile.csv` | `24800a51dcfe` |
| `v1283_family_efficiency.csv` | `33e895363f52` |
| `v1283_family_expression.csv` | `4d2b9c74c806` |
| `v1283_family_failure_table.csv` | `e6fd44f3b1b6` |
| `v1283_family_functional_diagnostic.csv` | `4c725ffae8bd` |
