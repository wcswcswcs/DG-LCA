...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7ir_epochs5_20260522T154000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.6743101132550486` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.091818221791438` | `0.5961904761904762` | `0` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `1.7280729648258712` | `0.1295238095238095` | `0` | `1` | `0` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.132974686327252` | `0.13` | `0` | `1` | `0` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `1.0769306749611753` | `0.13` | `0` | `1` | `1` |

## 3. B109 AUC Autopsy

| candidate_id | mean_delta | worst_delta | near_pass_rate | ece_ok | auc_step_ok | auc_time_ok | A5_autopsy_pass |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `0.012369791666666666` | `-0.00390625` | `1.0` | `0` | `1` | `1` | `0` |
...
| `Rational` | `TaskBlocked` | `1.179144219584689` | `1.1615529686282526` | `False` | `True` | `family-specific fused L3 efficiency and A4 expression passed; A5 fused task triage failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7ir-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatResidual015-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.179144219584689` | `0.9195238095238095` | `1` | `0` | `measured` |
| `Rational` | `B7ir-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatResidual015-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.1615529686282526` | `0.770952380952381` | `1` | `1` | `measured` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `f0cc865bad80` |
| `v1283_b109_auc_autopsy_trace.csv` | `fa023f329b8d` |
| `v1283_b109_fullstep_profile.csv` | `13b92e66957f` |
...
| `v1283_b109_fused_backward_correctness.csv` | `662a71d35631` |
| `v1283_b109_linec_coupling.csv` | `86871ea8e12d` |
| `v1283_b109_linec_diagnostics.csv` | `5aa3735daaa5` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `33ca74a3f06a` |
| `v1283_b109_task_autopsy_final.csv` | `b9e73871911e` |
| `v1283_family_component_profile.csv` | `9ead47f9f747` |
| `v1283_family_efficiency.csv` | `58e03a758e79` |
| `v1283_family_expression.csv` | `be5668eea2de` |
| `v1283_family_failure_table.csv` | `586c3ea2d0e2` |
| `v1283_family_functional_diagnostic.csv` | `fc9a6b1be1c4` |
