...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b254_temp115_gainramp_20260523T031000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `0.9043903121632677` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.5727362724408109` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.5390407383733147` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.5867598607047381` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.5626504326970861` | `0.13` | `1` | `1` | `1` |
| `B254b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp115` | `B48a-existing-manual-ce-torch-reduction` | `0.9450947375364844` | `2.719047619047619` | `0` | `0` | `0` |
| `B254b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp115` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.5965272338726629` | `0.5961904761904762` | `1` | `1` | `1` |
| `B254b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp115` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.5618648001894307` | `0.1295238095238095` | `1` | `1` | `1` |
...
| `B254b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp115` | `0.016927083333333332` | `-0.01953125` | `0.8333333333333334` | `1` | `0` | `0` | `0` |
...
| `v1283_b109_fused_backward_correctness.csv` | `35` | `0` | `0` | `0` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `346bc6045d7d` |
| `v1283_b109_auc_autopsy_trace.csv` | `74e67dd79db9` |
| `v1283_b109_fullstep_profile.csv` | `72bd20d1afd8` |
| `v1283_b109_functional_control_matrix.csv` | `c7b8819c6646` |
| `v1283_b109_functional_direction_audit.csv` | `229227f3d37b` |
| `v1283_b109_functional_five_step.csv` | `5b1d0d102516` |
| `v1283_b109_functional_one_step.csv` | `3ed6d3a88bea` |
| `v1283_b109_functional_route.json` | `3aa2ba719ba4` |
| `v1283_b109_fused_backward_correctness.csv` | `df733f6f23b5` |
| `v1283_b109_linec_coupling.csv` | `fdccbca348cd` |
| `v1283_b109_linec_diagnostics.csv` | `4c351898be62` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `a8bb1526cae1` |
| `v1283_b109_linec_noise_leak.csv` | `790b0bd65b78` |
| `v1283_b109_linec_signal_reservoir.csv` | `da68dff674fd` |
| `v1283_b109_task_autopsy_final.csv` | `c2a63e293250` |
