...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7hw_hiddentail_linearresramp_rerun_20260522T114500Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.2212643430226926` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8032960311685423` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.781040478904448` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8398395620247152` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.7987169052337112` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `2.7014664048216273` | `2.354752319795281` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7hw-RationalKAT-flashgroup-G16-h32-linearresGain19200-linearResRamp09600-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale050-hiddenTailGradTriton-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `2.7014664048216273` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7hw-RationalKAT-flashgroup-G16-h32-linearresGain19200-linearResRamp09600-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale050-hiddenTailGradTriton-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `2.354752319795281` | `0.7742857142857142` | `0` | `0` | `measured` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `11f374cf1dbd` |
| `v1283_b109_auc_autopsy_trace.csv` | `c4e44c63183b` |
| `v1283_b109_fullstep_profile.csv` | `0b8c99385c4e` |
...
| `v1283_b109_fused_backward_correctness.csv` | `ced25bd392de` |
| `v1283_b109_linec_coupling.csv` | `6c4c5e8f7660` |
| `v1283_b109_linec_diagnostics.csv` | `69371bc5214d` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `d49fd782f4aa` |
| `v1283_b109_task_autopsy_final.csv` | `b452fe436001` |
| `v1283_family_component_profile.csv` | `974c31fd23a1` |
| `v1283_family_efficiency.csv` | `2905280c1a7b` |
| `v1283_family_expression.csv` | `8cdb58af2036` |
| `v1283_family_failure_table.csv` | `0d0976475dec` |
| `v1283_family_functional_diagnostic.csv` | `262b5b51720c` |
