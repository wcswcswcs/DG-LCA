...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7ih_b7ii_tail_lr_schedule_20260522T131500Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.0778135551326564` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7025752717765424` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6624779161011785` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.7219060467815007` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.6919741952175058` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `TaskBlocked` | `1.752823031778051` | `1.137779127462023` | `False` | `True` | `family-specific fused L3 efficiency and A4 expression passed; A5 fused task triage failed` | `False` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `52ddc18f665d` |
| `v1283_b109_auc_autopsy_trace.csv` | `8c8e083f187a` |
| `v1283_b109_fullstep_profile.csv` | `4db4025f078f` |
...
| `v1283_b109_fused_backward_correctness.csv` | `38382dd5e5c5` |
| `v1283_b109_linec_coupling.csv` | `31cdd45d2d38` |
| `v1283_b109_linec_diagnostics.csv` | `08d20ea3e06e` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `d844496cea8a` |
| `v1283_b109_task_autopsy_final.csv` | `16de95b5bef7` |
| `v1283_family_component_profile.csv` | `05fb59e026bb` |
| `v1283_family_efficiency.csv` | `b28d268ad319` |
| `v1283_family_expression.csv` | `306052275e35` |
| `v1283_family_failure_table.csv` | `9672b329f404` |
| `v1283_family_functional_diagnostic.csv` | `ce8ebbfcdb5d` |
