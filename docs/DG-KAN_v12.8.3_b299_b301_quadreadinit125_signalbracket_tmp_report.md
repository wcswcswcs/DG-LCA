...
B109_A5_best_candidate = B300b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad032-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b299_b301_quadreadinit125_signalbracket_short_20260522T064000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.906262556608632` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.2302454616769827` | `0.5966666666666667` | `0` | `1` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `1.153974818199572` | `0.5966666666666667` | `0` | `1` | `0` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.1297272019323938` | `0.13` | `0` | `1` | `0` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `1.0593738654330065` | `0.13` | `0` | `1` | `1` |
| `B299b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad030-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.2446569931748368` | `2.719047619047619` | `0` | `0` | `0` |
| `B299b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad030-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.79485939489842` | `0.5961904761904762` | `1` | `1` | `1` |
| `B299b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad030-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.8651512494647836` | `0.1295238095238095` | `0` | `1` | `1` |
| `B300b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad032-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.208368612903132` | `2.719047619047619` | `0` | `0` | `0` |
| `B300b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad032-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7616997478267709` | `0.5961904761904762` | `1` | `1` | `1` |
| `B300b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad032-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7279379085703792` | `0.1295238095238095` | `1` | `1` | `1` |
| `B301b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock010-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.2216837032620522` | `2.719047619047619` | `0` | `0` | `0` |
...
| `B299b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad030-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.032552083333333336` | `0.0` | `1.0` | `1` | `1` | `1` | `1` |
| `B300b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad032-signalBlock015-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.033854166666666664` | `0.0` | `1.0` | `1` | `1` | `1` | `1` |
| `B301b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock010-quadReadInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.026692708333333332` | `0.015625` | `1.0` | `1` | `1` | `1` | `1` |
...
| `Chebyshev` | `KernelBlocked` | `3.2658356664196355` | `1.342434785171205` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L1-vectorized-or-stream-autograd` | `3.2658356664196355` | `3.9695238095238095` | `0` | `0` | `measured` |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L3-analytic-manual-ce-torch-reduction` | `1.342434785171205` | `2.308095238095238` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L2_torch_compile_forward_attempt` | `2348.2383677172757` | `0` | `measured` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `cdad4fbf2c29` |
| `v1283_b109_auc_autopsy_trace.csv` | `41f77a860a2b` |
| `v1283_b109_fullstep_profile.csv` | `86feb159695f` |
| `v1283_b109_functional_control_matrix.csv` | `fcdfe1572b39` |
| `v1283_b109_functional_direction_audit.csv` | `bdacb12078c9` |
| `v1283_b109_functional_five_step.csv` | `2c198fc7a1ba` |
| `v1283_b109_functional_one_step.csv` | `58a7b916f046` |
| `v1283_b109_functional_route.json` | `5b53f1df01b9` |
| `v1283_b109_fused_backward_correctness.csv` | `3ad598978764` |
| `v1283_b109_linec_coupling.csv` | `f7f9bca78958` |
| `v1283_b109_linec_diagnostics.csv` | `54ab5925cf64` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `9ff4665ce5e5` |
| `v1283_b109_linec_noise_leak.csv` | `396bd32aa3c6` |
| `v1283_b109_linec_signal_reservoir.csv` | `fb779cf1518c` |
| `v1283_b109_task_autopsy_final.csv` | `4ec993c8c4a9` |
| `v1283_family_component_profile.csv` | `9aadfc3dc950` |
| `v1283_family_efficiency.csv` | `465e557195f8` |
| `v1283_family_expression.csv` | `62b9bdfdd290` |
| `v1283_family_failure_table.csv` | `2edf6d9a089d` |
