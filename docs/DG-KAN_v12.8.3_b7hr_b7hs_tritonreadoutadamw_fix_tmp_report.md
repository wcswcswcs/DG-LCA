...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7hr_b7hs_tritonreadoutadamw_20260523T001500Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.2726799535678273` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8239455720316019` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7744342272593174` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8571043016771102` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8466517019126886` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `1.8464373714702547` | `1.311305499694901` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7hr-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale050-hiddenTailGradTriton-tritonReadoutAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `2.8761151354827317` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7hr-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale050-hiddenTailGradTriton-tritonReadoutAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.311305499694901` | `0.7742857142857142` | `1` | `0` | `measured` |
| `Rational` | `B7hs-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenAbsReadoutZero-hiddenAbsScale050-hiddenTailGradTriton-tritonReadoutAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.8464373714702547` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7hs-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenAbsReadoutZero-hiddenAbsScale050-hiddenTailGradTriton-tritonReadoutAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.337025586136708` | `0.7685714285714286` | `1` | `0` | `measured` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `82ed56b1ab5d` |
| `v1283_b109_auc_autopsy_trace.csv` | `32dd40904d7e` |
| `v1283_b109_fullstep_profile.csv` | `97e913189c6d` |
...
| `v1283_b109_fused_backward_correctness.csv` | `d9ab314066cf` |
| `v1283_b109_linec_coupling.csv` | `036169861272` |
| `v1283_b109_linec_diagnostics.csv` | `5bec27b4ef69` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `e0384560bbea` |
| `v1283_b109_task_autopsy_final.csv` | `7e39e2cc0e2a` |
| `v1283_family_component_profile.csv` | `86faab199b04` |
| `v1283_family_efficiency.csv` | `c7b3e6f020fe` |
| `v1283_family_expression.csv` | `97bf34918538` |
| `v1283_family_failure_table.csv` | `f97c5a99f2f1` |
