...
artifact = results/v12_6_lowerlevel_fhq_functional_geometry/v126_b109_h160_absdiag050_classbranch_classgain_identitytailquad030_hingeamp025_f3_workspace_final075_protocolfix_20260520T210000Z
...
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `torch-reference-simple-fast` | `6.390241078575606` | `0.0` | `0.0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `FHQ-triton-two-kernel-forward` | `3.0065095407390254` | `4.76837158203125e-07` | `3.17852652642614e-07` | `0` |
...
|---|---|---|---|---|---|---|
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.266819236602167` | `2.7185714285714284` | `1` | `0` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.0243235142776814` | `0.5966666666666667` | `1` | `1` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9659355274876386` | `0.5966666666666667` | `1` | `1` | `` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.7448759253070407` | `0.13` | `1` | `1` | `` |
...
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-learnableP-proj-grad` | `quad_readout` | `0.0007631803746335208` | `1.0` | `1` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-learnableP-proj-grad` | `branch_scale` | `1.0230585303361295e-06` | `1.0` | `1` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-learnableP-proj-grad` | `logit_gain` | `8.113002536447311e-07` | `1.0` | `1` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-learnableP-proj-grad` | `bias` | `1.0703922725951998e-07` | `0.9999999403953552` | `1` | `` |
...
|---|---|---|---|---|---|---|---|---|---|
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `0.016927083333333332` | `0.00390625` | `1.0` | `1` | `0` | `0` | `0` | `` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `0.016927083333333332` | `0.00390625` | `1.0` | `1` | `0` | `0` | `0` | `` | `` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `-0.12109375` | `-0.1796875` | `0.0` | `0` | `0` | `0` | `0` | `` | `` |
...
|---|---|
| `v126_auc_attribution.csv` | `68ca1b0b6e79` |
| `v126_candidate_manifest.csv` | `e00e37c2700a` |
| `v126_expression_audit.csv` | `66a182938f74` |
| `v126_expression_summary.csv` | `df3cd960a715` |
| `v126_failure_table.csv` | `a27c9d7395e6` |
| `v126_frozen_readout.csv` | `1fce476c872e` |
| `v126_fullstep_profile.csv` | `9999efd39fa0` |
...
| `v126_fused_backward_correctness.csv` | `6d18323328a8` |
| `v126_fused_forward_profile.csv` | `b56ddf674fab` |
