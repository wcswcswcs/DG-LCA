...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b214_b217_b219_nonlogit_directtail_20260523T002500Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.111997468940156` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.6715949852274461` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6689182736926176` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.7475872735422808` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.7437030447266441` | `0.13` | `1` | `1` | `1` |
| `B214b-SimpleFastTaskGeometry-h160-learnableP-fusedProjGradAdamW-absmixsq010-manualAdamW-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.5912507384002705` | `2.7185714285714284` | `0` | `0` | `0` |
| `B214b-SimpleFastTaskGeometry-h160-learnableP-fusedProjGradAdamW-absmixsq010-manualAdamW-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.3625647277502182` | `0.5966666666666667` | `0` | `1` | `0` |
| `B214b-SimpleFastTaskGeometry-h160-learnableP-fusedProjGradAdamW-absmixsq010-manualAdamW-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `1.2782313580389797` | `0.13` | `0` | `1` | `0` |
| `B217b-SimpleFastTaskGeometry-h160-learnableP-fusedProjGradAdamW-sgnsqdiag025-manualAdamW-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.2538020772974965` | `2.7185714285714284` | `0` | `0` | `0` |
| `B217b-SimpleFastTaskGeometry-h160-learnableP-fusedProjGradAdamW-sgnsqdiag025-manualAdamW-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.0814158353906471` | `0.5966666666666667` | `0` | `1` | `1` |
| `B217b-SimpleFastTaskGeometry-h160-learnableP-fusedProjGradAdamW-sgnsqdiag025-manualAdamW-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `1.0173422804983594` | `0.13` | `0` | `1` | `1` |
| `B219b-SimpleFastTaskGeometry-h160-learnableP-fusedProjGradAdamW-absquad050010-manualAdamW-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.3608424646924522` | `3.4357142857142855` | `0` | `0` | `0` |
...
| `Rational` | `KernelBlocked` | `2.8712024476099702` | `1.341037800142798` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7hr-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale050-hiddenTailGradTriton-tritonReadoutAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `2.8712024476099702` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7hr-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale050-hiddenTailGradTriton-tritonReadoutAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.341037800142798` | `0.7742857142857142` | `1` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7hr-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale050-hiddenTailGradTriton-tritonReadoutAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| `v1283_b109_fused_backward_correctness.csv` | `74` | `0` | `0` | `0` | `1` |
...
| `v1283_family_component_profile.csv` | `2` | `0` | `0` | `0` | `1` |
| `v1283_family_efficiency.csv` | `3` | `0` | `0` | `0` | `1` |
| `v1283_family_expression.csv` | `1` | `0` | `0` | `0` | `1` |
| `v1283_family_failure_table.csv` | `1` | `0` | `0` | `0` | `1` |
| `v1283_family_functional_diagnostic.csv` | `1` | `0` | `0` | `0` | `1` |

Selected hashes:

| artifact | sha256_prefix |
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `330eda9d1818` |
| `v1283_b109_auc_autopsy_trace.csv` | `649c712d2b29` |
| `v1283_b109_fullstep_profile.csv` | `2d41694a9591` |
...
| `v1283_b109_fused_backward_correctness.csv` | `a6839a13a6cd` |
| `v1283_b109_linec_coupling.csv` | `9bd79d4c10d2` |
| `v1283_b109_linec_diagnostics.csv` | `9814921ad886` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `f6a46738c6ec` |
| `v1283_b109_task_autopsy_final.csv` | `f907445646a3` |
| `v1283_family_component_profile.csv` | `a2b747d8bfab` |
| `v1283_family_efficiency.csv` | `f25ad13b030a` |
| `v1283_family_expression.csv` | `c5fda75e1705` |
| `v1283_family_failure_table.csv` | `5016b5020f0f` |
| `v1283_family_functional_diagnostic.csv` | `38fd60f2ecb7` |
