...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7gv_b7gw_hiddensqsigned_20260522T183000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.048368621346162` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.6657935773683856` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.5902147682645629` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.6428138297243083` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.6221236359066252` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `TaskBlocked` | `1.5900036006793654` | `1.1779723109117823` | `False` | `True` | `family-specific fused L3 efficiency and A4 expression passed; A5 fused task triage failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7gv-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-hiddenSqSigned-hiddenSqScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `3.126197384675805` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7gv-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-hiddenSqSigned-hiddenSqScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.2463655595396756` | `0.7742857142857142` | `1` | `1` | `measured` |
| `Rational` | `B7gw-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-hiddenSqSigned-hiddenSqScale075-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.5900036006793654` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7gw-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-hiddenSqSigned-hiddenSqScale075-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.1779723109117823` | `0.7742857142857142` | `1` | `1` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7gv-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-hiddenSqSigned-hiddenSqScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7gw-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-hiddenSqSigned-hiddenSqScale075-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `3bc49916ffdf` |
| `v1283_b109_auc_autopsy_trace.csv` | `17805b69286f` |
| `v1283_b109_fullstep_profile.csv` | `e2d9a3034c15` |
...
| `v1283_b109_fused_backward_correctness.csv` | `39b3ad6968ce` |
| `v1283_b109_linec_coupling.csv` | `2c830ddfca5f` |
| `v1283_b109_linec_diagnostics.csv` | `a40882e4c6bc` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `be71444f7f8b` |
| `v1283_b109_task_autopsy_final.csv` | `5bdcb3a0dd7a` |
| `v1283_family_component_profile.csv` | `744f43ef71e6` |
| `v1283_family_efficiency.csv` | `d2084fc212e4` |
| `v1283_family_expression.csv` | `d91e09b44c5b` |
| `v1283_family_failure_table.csv` | `023e74327c9a` |
| `v1283_family_functional_diagnostic.csv` | `4389f6bf0d54` |
