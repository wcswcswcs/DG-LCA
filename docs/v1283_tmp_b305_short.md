...
B109_A5_best_candidate = B305b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-quad020-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad020-hingeamp025-temp090
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b305_quad020_short_20260522T080000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.4607540928885638` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.9448379715508322` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9190983580384157` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8693422705939787` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8242529303577725` | `0.13` | `1` | `1` | `1` |
| `B305b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-quad020-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad020-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.2416712227039766` | `2.719047619047619` | `0` | `0` | `0` |
| `B305b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-quad020-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad020-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8151298121418313` | `0.5961904761904762` | `1` | `1` | `1` |
| `B305b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-quad020-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad020-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7776332190182154` | `0.1295238095238095` | `1` | `1` | `1` |
...
| `B305b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-quad020-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad020-hingeamp025-temp090` | `0.026692708333333332` | `-0.015625` | `0.8333333333333334` | `0` | `0` | `0` | `0` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `8773be4eabcc` |
| `v1283_b109_auc_autopsy_trace.csv` | `d4a86ab76a30` |
| `v1283_b109_fullstep_profile.csv` | `a5a07aab6cdc` |
| `v1283_b109_functional_control_matrix.csv` | `24c5b6a71dad` |
| `v1283_b109_functional_direction_audit.csv` | `d6f23291909b` |
| `v1283_b109_functional_five_step.csv` | `4a168981544d` |
| `v1283_b109_functional_one_step.csv` | `dcf418d6f1b0` |
| `v1283_b109_functional_route.json` | `2969f30ce6a6` |
| `v1283_b109_fused_backward_correctness.csv` | `99c9511463c9` |
| `v1283_b109_linec_coupling.csv` | `2ed5b32a5863` |
| `v1283_b109_linec_diagnostics.csv` | `10404ac22610` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `0af1c3730194` |
| `v1283_b109_linec_noise_leak.csv` | `33962f52d8fd` |
| `v1283_b109_linec_signal_reservoir.csv` | `c0fe6aaa0e34` |
| `v1283_b109_task_autopsy_final.csv` | `8a25371a94e9` |
