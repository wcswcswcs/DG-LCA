...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7gb_b7gc_diagrich_20260522T043000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.5347004750920712` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.0019403818080983` | `0.5961904761904762` | `0` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9477629719476621` | `0.1295238095238095` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.0107872073399367` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `1.013802120599271` | `0.13` | `0` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `1.4000142020749438` | `1.35852047311434` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7gb-RationalKAT-flashgroup-G16-h32-linearresGain19200-diagPairCrossR96-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.4000142020749438` | `0.8638095238095238` | `0` | `0` | `measured` |
| `Rational` | `B7gb-RationalKAT-flashgroup-G16-h32-linearresGain19200-diagPairCrossR96-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.3717319018739536` | `0.7561904761904762` | `0` | `0` | `measured` |
| `Rational` | `B7gc-RationalKAT-flashgroup-G16-h32-linearresGain19200-diagPairCrossR112-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.4775425058840843` | `0.8861904761904762` | `0` | `0` | `measured` |
| `Rational` | `B7gc-RationalKAT-flashgroup-G16-h32-linearresGain19200-diagPairCrossR112-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.35852047311434` | `0.7557142857142857` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7gb-RationalKAT-flashgroup-G16-h32-linearresGain19200-diagPairCrossR96-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7gc-RationalKAT-flashgroup-G16-h32-linearresGain19200-diagPairCrossR112-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `51a3e1e26169` |
| `v1283_b109_auc_autopsy_trace.csv` | `2d218ab2b19b` |
| `v1283_b109_fullstep_profile.csv` | `8930be9758c5` |
...
| `v1283_b109_fused_backward_correctness.csv` | `f6dde754555b` |
| `v1283_b109_linec_coupling.csv` | `81f8e55ab710` |
| `v1283_b109_linec_diagnostics.csv` | `2f7e15c6aa0e` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `7ffcf71d7464` |
| `v1283_b109_task_autopsy_final.csv` | `756b169c62f7` |
| `v1283_family_component_profile.csv` | `ab829040afa4` |
| `v1283_family_efficiency.csv` | `9dbd21b5abf8` |
| `v1283_family_expression.csv` | `589fad5503ee` |
| `v1283_family_failure_table.csv` | `0cbf6e622e35` |
| `v1283_family_functional_diagnostic.csv` | `686b823b51f4` |
