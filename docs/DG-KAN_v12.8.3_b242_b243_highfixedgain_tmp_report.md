...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b242_b243_highfixedgain_20260523T021000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.1862447152988473` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.680898054978365` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6350907651135987` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.717985352055975` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.6860086903586223` | `0.13` | `1` | `1` | `1` |
| `B242b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp100` | `B48a-existing-manual-ce-torch-reduction` | `1.378291398425263` | `2.719047619047619` | `0` | `0` | `0` |
| `B242b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp100` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8783560774067833` | `0.5961904761904762` | `0` | `1` | `1` |
| `B242b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp100` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.8309320615262232` | `0.1295238095238095` | `1` | `1` | `1` |
| `B243b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp125` | `B48a-existing-manual-ce-torch-reduction` | `1.145018228636604` | `2.719047619047619` | `0` | `0` | `0` |
| `B243b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp125` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.729349008234502` | `0.5961904761904762` | `1` | `1` | `1` |
| `B243b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-identitytailquad030-hingeamp025-temp125` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7066014522689142` | `0.1295238095238095` | `1` | `1` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `c12783af418a` |
| `v1283_b109_auc_autopsy_trace.csv` | `848ed42622ee` |
| `v1283_b109_fullstep_profile.csv` | `b4ca91e05944` |
| `v1283_b109_functional_control_matrix.csv` | `9c3a8f276cb8` |
| `v1283_b109_functional_direction_audit.csv` | `2de6ddea600e` |
| `v1283_b109_functional_five_step.csv` | `1154486260fe` |
| `v1283_b109_functional_one_step.csv` | `7df1193cc673` |
| `v1283_b109_functional_route.json` | `e82472c33718` |
| `v1283_b109_fused_backward_correctness.csv` | `47340b55369f` |
| `v1283_b109_linec_coupling.csv` | `ad425d882ffc` |
| `v1283_b109_linec_diagnostics.csv` | `f1ac662e636e` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `0efc41fd5736` |
| `v1283_b109_linec_noise_leak.csv` | `a734830c9a6b` |
| `v1283_b109_linec_signal_reservoir.csv` | `bb2496bbdfcc` |
| `v1283_b109_task_autopsy_final.csv` | `31eca0506a1e` |
