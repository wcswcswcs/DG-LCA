...
raw_dir = results/v12_10_b320_functional_classic_nobspline/v1210_b320_p4_negquad00625_eventgate_tailnoise_reservoir_20260522T000000Z/raw_v1283_reuse
B320_v1210_strict_hardening_pass = 1
B320_strict_fail_reason = 
B320_F3_step_ratio_q90 = 0.7493776435101636
...
B320_max_ECE_delta = 0.019615277647972107
B320_max_AUC_step = 0.9809975872850556
B320_max_AUC_time = 0.9809975872850556
B320_LineC_nontearing_pass = 1
official_functional_success = 0
functional_P3_official_candidate_pass = 0
functional_P3_best_update = 
functional_P3_control_gap = 
...
next_recommended_action = continue functional update re-entry with strong controls on the locked B320 base
artifact_dir = /workspace/DG-LCA/DG-LCA/results/v12_10_b320_functional_classic_nobspline/v1210_b320_p4_negquad00625_eventgate_tailnoise_reservoir_20260522T000000Z
```
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `B320b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp105-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7493776435101636` | `0.1295238095238095` | `0.022526041666666666` | `0.0` | `1.0` | `0.9809975872850556` | `0.9809975872850556` | `0.019615277647972107` | `1` | `` |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `B320b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp105-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp075` | `` | `` | `` | `` | `` | `` | `` | `` | `` | `0` | `` |
...
| --- | --- | --- | --- | --- | --- |
| `Chebyshev` | `ExpressionBlocked` | `` | `` | `1.018006801343154` | `family-specific fused L3 efficiency passed but A4 expression failed` |
| `Fourier` | `ExpressionBlocked` | `` | `` | `1.0953928362286893` | `family-specific fused L3 efficiency passed but A4 expression failed` |
| `RBF` | `ExpressionBlocked` | `` | `` | `1.0891050999207263` | `family-specific fused L3 efficiency passed but A4 expression failed` |
| `Rational` | `TaskBlocked` | `` | `` | `1.1856407750522564` | `family-specific fused L3 efficiency and A4 expression passed; A5 fused task triage failed` |
| `Wavelet` | `KernelBlocked` | `` | `` | `1.0839248867390787` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` |
...
| `V1283_PROVENANCE_AUDIT` | `v1283_b109_auc_attribution.csv` | `155` | `0` | `0` | `0` | `1` |
| `V1283_PROVENANCE_AUDIT` | `v1283_b109_auc_autopsy_trace.csv` | `540` | `0` | `0` | `0` | `1` |
...
| `V1283_PROVENANCE_AUDIT` | `v1283_b109_functional_delta_score_control_matrix.csv` | `4` | `0` | `0` | `0` | `1` |
| `V1283_PROVENANCE_AUDIT` | `v1283_b109_functional_delta_score_repair.csv` | `132` | `0` | `0` | `0` | `1` |
...
| `V1283_PROVENANCE_AUDIT` | `v1283_b109_task_autopsy_final.csv` | `180` | `0` | `0` | `0` | `1` |

Selected hashes:

| artifact | sha256_prefix |
| --- | --- |
| `v1210_b320_auc_attribution.csv` | `6566e4edd921` |
| `v1210_b320_base_hardening.csv` | `b887129d2f6b` |
| `v1210_b320_efficiency_profile.csv` | `de317f76f98b` |
| `v1210_b320_task_final.csv` | `a7c00ed5761e` |
| `v1210_b320_task_trace.csv` | `4cf3acf68159` |
| `v1210_family_component_profile.csv` | `a20c01f7edf4` |
| `v1210_family_efficiency.csv` | `a5041234af08` |
| `v1210_family_expression.csv` | `264042ac4b2a` |
| `v1210_family_failure_table.csv` | `f252ebf01497` |
| `v1210_family_gradcheck.csv` | `01c70aaff9ee` |
...
| `v1210_family_policy.json` | `5ce86de0048a` |
| `v1210_family_status.json` | `0c4889264c58` |
| `v1210_family_task_triage.csv` | `2b09ff45bfff` |
| `v1210_functional_delta_score_repair_summary.csv` | `83307ce7b9ba` |
| `v1210_functional_one_five_step.csv` | `e3b0c44298fc` |
| `v1210_functional_p3_gate.csv` | `d3d72880542a` |
| `v1210_functional_reentry_summary.csv` | `a701e7fd204f` |
