...
B109_A5_best_candidate = B311b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b311_directramp125_short_20260522T093000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.480370928301841` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.9736531888597902` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9095075368874099` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8999204154942742` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8512987235577398` | `0.13` | `0` | `1` | `1` |
| `B311b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.234382862506041` | `2.719047619047619` | `0` | `0` | `0` |
| `B311b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8225414802708472` | `0.5961904761904762` | `1` | `1` | `1` |
...
| `B311b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.03515625` | `0.00390625` | `1.0` | `1` | `1` | `1` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `2caee830aa11` |
| `v1283_b109_auc_autopsy_trace.csv` | `ca5f70cb79a4` |
| `v1283_b109_fullstep_profile.csv` | `aaed949ce720` |
| `v1283_b109_functional_control_matrix.csv` | `5fd0a07417b2` |
| `v1283_b109_functional_direction_audit.csv` | `f04ca9be7450` |
| `v1283_b109_functional_five_step.csv` | `04be20538a42` |
| `v1283_b109_functional_one_step.csv` | `605490c080e7` |
| `v1283_b109_functional_route.json` | `2ab721a6c57f` |
| `v1283_b109_fused_backward_correctness.csv` | `5cdb84bec375` |
| `v1283_b109_linec_coupling.csv` | `3a8d56b10452` |
| `v1283_b109_linec_diagnostics.csv` | `9c5c90275b3c` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `08d1c626a691` |
| `v1283_b109_linec_noise_leak.csv` | `5b1510bff12e` |
| `v1283_b109_linec_signal_reservoir.csv` | `73ea1d8eae31` |
| `v1283_b109_task_autopsy_final.csv` | `7426906cb5d6` |
