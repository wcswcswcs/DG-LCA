...
B109_A5_best_candidate = B281b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit075-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b281_b283_signalblock_readinit_short_20260522T052355Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.2906514330054484` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8162903403826922` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7617418148615157` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8562302039888022` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8308786000729129` | `0.13` | `1` | `1` | `1` |
| `B281b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit075-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.2847329048898974` | `2.719047619047619` | `0` | `0` | `0` |
| `B281b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit075-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.802037741464458` | `0.5961904761904762` | `1` | `1` | `1` |
| `B281b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit075-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7690820087858806` | `0.1295238095238095` | `1` | `1` | `1` |
| `B282b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit050-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.2301608733822382` | `2.719047619047619` | `0` | `0` | `0` |
| `B282b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit050-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7695450259236751` | `0.5961904761904762` | `1` | `1` | `1` |
| `B282b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit050-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7572235079041831` | `0.1295238095238095` | `1` | `1` | `1` |
| `B283b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-quadReadInit050-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.2467293091845615` | `2.719047619047619` | `0` | `0` | `0` |
...
| `B281b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit075-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.027994791666666668` | `0.0` | `1.0` | `0` | `1` | `1` | `0` |
| `B282b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit050-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.018229166666666668` | `-0.015625` | `0.8333333333333334` | `0` | `0` | `0` | `0` |
| `B283b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-quadReadInit050-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.018229166666666668` | `-0.015625` | `0.8333333333333334` | `0` | `0` | `0` | `0` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `9595e949861e` |
| `v1283_b109_auc_autopsy_trace.csv` | `a27bb6430b33` |
| `v1283_b109_fullstep_profile.csv` | `b9c154ec718c` |
| `v1283_b109_functional_control_matrix.csv` | `b622bf4a7e76` |
| `v1283_b109_functional_direction_audit.csv` | `dade918ac04f` |
| `v1283_b109_functional_five_step.csv` | `5237a6984c7f` |
| `v1283_b109_functional_one_step.csv` | `262b896bdd98` |
| `v1283_b109_functional_route.json` | `efaae26c30a0` |
| `v1283_b109_fused_backward_correctness.csv` | `fff1d71759ad` |
| `v1283_b109_linec_coupling.csv` | `0538473c68aa` |
| `v1283_b109_linec_diagnostics.csv` | `1e8a39848385` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `a7a2d759e078` |
| `v1283_b109_linec_noise_leak.csv` | `0000f04f5152` |
| `v1283_b109_linec_signal_reservoir.csv` | `4bc8096d5626` |
| `v1283_b109_task_autopsy_final.csv` | `856d2279f0d1` |
