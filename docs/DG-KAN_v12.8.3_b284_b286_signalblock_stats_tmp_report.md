...
B109_A5_best_candidate = B284b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit075-normAbs010-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b284_b286_signalblock_stats_short_20260522T052858Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.2108615857776373` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7856282188077852` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.735224969775393` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.813789955560565` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.7848498359324575` | `0.13` | `1` | `1` | `1` |
| `B284b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit075-normAbs010-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.2205101346027118` | `2.7195238095238095` | `0` | `0` | `0` |
| `B284b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit075-normAbs010-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.0337524468656694` | `0.5966666666666667` | `0` | `1` | `1` |
| `B284b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit075-normAbs010-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.993325692804496` | `0.13` | `0` | `1` | `1` |
| `B285b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit075-meanStat010-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.639854576280937` | `2.7195238095238095` | `0` | `0` | `0` |
| `B285b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit075-meanStat010-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.407233753387707` | `0.5966666666666667` | `0` | `1` | `0` |
| `B285b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit075-meanStat010-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `1.2871637061515648` | `0.13` | `0` | `1` | `0` |
| `B286b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit075-normAbs010-meanStat010-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `0.8536257290068147` | `2.7204761904761905` | `0` | `0` | `0` |
...
| `B284b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit075-normAbs010-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.027994791666666668` | `0.0` | `1.0` | `0` | `1` | `1` | `0` |
| `B285b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit075-meanStat010-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.027994791666666668` | `0.0` | `1.0` | `0` | `1` | `1` | `0` |
| `B286b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-readInit075-normAbs010-meanStat010-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.027994791666666668` | `0.0` | `1.0` | `0` | `1` | `1` | `0` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `3a5b4f6b4922` |
| `v1283_b109_auc_autopsy_trace.csv` | `44b9ed4187d5` |
| `v1283_b109_fullstep_profile.csv` | `cf627c77fa26` |
| `v1283_b109_functional_control_matrix.csv` | `4f4d5cc60c4c` |
| `v1283_b109_functional_direction_audit.csv` | `44ea6d8f7c3f` |
| `v1283_b109_functional_five_step.csv` | `25891dfa2837` |
| `v1283_b109_functional_one_step.csv` | `572ae4ed2f8d` |
| `v1283_b109_functional_route.json` | `fe8f27199c9b` |
| `v1283_b109_fused_backward_correctness.csv` | `ad5c848a22e9` |
| `v1283_b109_linec_coupling.csv` | `8e4fe665c374` |
| `v1283_b109_linec_diagnostics.csv` | `d09a3c5b8070` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `01746ae71587` |
| `v1283_b109_linec_noise_leak.csv` | `4960627ed1aa` |
| `v1283_b109_linec_signal_reservoir.csv` | `25243f3c2c2a` |
| `v1283_b109_task_autopsy_final.csv` | `f9258d4d68cf` |
