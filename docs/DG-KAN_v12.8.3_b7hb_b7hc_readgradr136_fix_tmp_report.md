...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7hb_b7hc_readgradr136_fix_20260522T203000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.1184009912780444` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7072346314535362` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6657785158920587` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.7350070213589478` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.7069281285613876` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `1.8457960221702754` | `` | `False` | `False` | `L2 forward attempt failed or missing; L3 also missing` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7hb-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-readGradR136-crossZero-b32-hiddenSqReadoutZero-hiddenSqSigned-hiddenSqScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `2.013502319605121` | `0.9180952380952381` | `0` | `0` | `measured` |
...
| `Rational` | `B7hc-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-readGradR136-crossZero-b32-hiddenSqReadoutZero-hiddenSqScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.8457960221702754` | `0.9180952380952381` | `0` | `0` | `measured` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `c54cdd95e114` |
| `v1283_b109_auc_autopsy_trace.csv` | `9f1a2b990447` |
| `v1283_b109_fullstep_profile.csv` | `7bacc71bb73e` |
...
| `v1283_b109_fused_backward_correctness.csv` | `13993c8806d9` |
| `v1283_b109_linec_coupling.csv` | `7e5fb160df68` |
| `v1283_b109_linec_diagnostics.csv` | `043c366b6339` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `c0b201d8a81b` |
| `v1283_b109_task_autopsy_final.csv` | `580e3d9b77d5` |
| `v1283_family_component_profile.csv` | `ea62fd86a2a7` |
| `v1283_family_efficiency.csv` | `0d221295565e` |
| `v1283_family_expression.csv` | `1b8a173120d6` |
| `v1283_family_failure_table.csv` | `839aedbc8a91` |
