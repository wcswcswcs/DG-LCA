...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7hz_b7ia_tail_scale_narrow_20260522T121500Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.124837036847432` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7619806138199656` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6910263205803372` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.7651583413694456` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.7235141197343812` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `TaskBlocked` | `1.6935268001837112` | `1.0893676444829399` | `False` | `True` | `family-specific fused L3 efficiency and A4 expression passed; A5 fused task triage failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7hz-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale025-hiddenTailGradTriton-tritonHiddenTailAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `2.4917353399967728` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7hz-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale025-hiddenTailGradTriton-tritonHiddenTailAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.359498573203816` | `0.7742857142857142` | `0` | `0` | `measured` |
| `Rational` | `B7ia-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale035-hiddenTailGradTriton-tritonHiddenTailAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.6935268001837112` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7ia-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale035-hiddenTailGradTriton-tritonHiddenTailAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.0893676444829399` | `0.7742857142857142` | `1` | `1` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7hz-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale025-hiddenTailGradTriton-tritonHiddenTailAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7ia-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenRatReadoutZero-hiddenRatScale035-hiddenTailGradTriton-tritonHiddenTailAdamW-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `03fbaa9ecc79` |
| `v1283_b109_auc_autopsy_trace.csv` | `960a9293900c` |
| `v1283_b109_fullstep_profile.csv` | `b77d85f19604` |
...
| `v1283_b109_fused_backward_correctness.csv` | `bf4043cdb2d0` |
| `v1283_b109_linec_coupling.csv` | `1202da5264ca` |
| `v1283_b109_linec_diagnostics.csv` | `a8249198d3f8` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `07e207ed9e96` |
| `v1283_b109_task_autopsy_final.csv` | `06e48cd65199` |
| `v1283_family_component_profile.csv` | `0ee6b60fe1d4` |
| `v1283_family_efficiency.csv` | `bb44091d701f` |
| `v1283_family_expression.csv` | `aa575192d46c` |
| `v1283_family_failure_table.csv` | `536a72f002f6` |
| `v1283_family_functional_diagnostic.csv` | `ca75b2661100` |
