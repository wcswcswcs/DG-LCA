...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7fr_b7fs_hybridpair_hiddensq_20260522T033000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.8117935297283572` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.041985441976906` | `0.5961904761904762` | `0` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `1.0069867077131993` | `0.1295238095238095` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.0908489321708268` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `1.0918395935234242` | `0.13` | `0` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `1.8461681653104252` | `1.3620681553908778` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fr-RationalKAT-flashgroup-G16-h32-linearresGain19200-hybridPairCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `2.6935614217105583` | `0.8623809523809524` | `0` | `0` | `measured` |
| `Rational` | `B7fr-RationalKAT-flashgroup-G16-h32-linearresGain19200-hybridPairCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `2.444657837729529` | `0.7652380952380953` | `0` | `0` | `measured` |
| `Rational` | `B7fs-RationalKAT-flashgroup-G16-h32-linearresGain19200-hybridPairCrossR112-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.8461681653104252` | `0.8847619047619047` | `0` | `0` | `measured` |
| `Rational` | `B7fs-RationalKAT-flashgroup-G16-h32-linearresGain19200-hybridPairCrossR112-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.3620681553908778` | `0.7647619047619048` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fr-RationalKAT-flashgroup-G16-h32-linearresGain19200-hybridPairCrossR96-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7fs-RationalKAT-flashgroup-G16-h32-linearresGain19200-hybridPairCrossR112-readblocktriton-crossZero-b32-hiddenSqReadoutZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `ff0e818f66fc` |
| `v1283_b109_auc_autopsy_trace.csv` | `e295a6cbdc2d` |
| `v1283_b109_fullstep_profile.csv` | `65a3ea961c00` |
...
| `v1283_b109_fused_backward_correctness.csv` | `69ddd2963910` |
| `v1283_b109_linec_coupling.csv` | `da2add6ddd53` |
| `v1283_b109_linec_diagnostics.csv` | `6d655a9f5755` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `47c3a567fd01` |
| `v1283_b109_task_autopsy_final.csv` | `2fb261a13bf4` |
| `v1283_family_component_profile.csv` | `48af814a86d0` |
| `v1283_family_efficiency.csv` | `bc6b66b4aa93` |
| `v1283_family_expression.csv` | `1c7eb91a5362` |
| `v1283_family_failure_table.csv` | `3838e59aa90b` |
| `v1283_family_functional_diagnostic.csv` | `0dbc084fafef` |
