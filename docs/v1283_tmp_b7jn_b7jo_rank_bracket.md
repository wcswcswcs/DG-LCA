...
B109_FHQ_efficiency_anchor = B314b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp105-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090 / F2-triton-forward-delta-readout-proj-grad-learnableP
B109_A5_autopsy_pass = 1
B109_A5_best_candidate = B314b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp105-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090
B109_LineC_measured = 1
B109_LineC_nontearing_pass = 1
B109_functional_reentry_measured = 1
B109_functional_beats_controls = 0
B109_functional_delta_score_repair_measured = 1
B109_functional_delta_score_beats_controls = 1
B109_functional_delta_score_best_update = F7-TaskPlusSNRGeometryResidual-w025
B109_functional_delta_score_gap_vs_best_control = 0.0011694759443608982
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b7jn_b7jo_rank_bracket_20260522T221500Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `2.0035301416545543` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.268973506785756` | `0.5966666666666667` | `0` | `1` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `1.2041540764030936` | `0.5966666666666667` | `0` | `1` | `0` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.1829659736998663` | `0.13` | `0` | `1` | `0` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `1.1067816394997936` | `0.13` | `0` | `1` | `0` |
| `B314b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp105-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.1082776583381186` | `2.719047619047619` | `0` | `0` | `0` |
| `B314b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp105-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7129734801027278` | `0.5961904761904762` | `1` | `1` | `1` |
| `B314b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp105-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6554244379048937` | `0.1295238095238095` | `1` | `1` | `1` |

## 3. B109 AUC Autopsy

| candidate_id | mean_delta | worst_delta | near_pass_rate | ece_ok | auc_step_ok | auc_time_ok | A5_autopsy_pass |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `0.009440104166666666` | `-0.01953125` | `0.9` | `0` | `0` | `0` | `0` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `-0.18671875` | `-0.28125` | `0.0` | `0` | `0` | `0` | `0` |
| `B314b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp105-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.023502604166666666` | `0.00390625` | `1.0` | `1` | `1` | `1` | `1` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `BSpline` | `KernelBlocked` | `` | `` | `False` | `False` | `L2 forward attempt failed or missing; L3 also missing` | `False` |
| `Chebyshev` | `KernelBlocked` | `` | `` | `False` | `False` | `L2 forward attempt failed or missing; L3 also missing` | `False` |
| `Fourier` | `KernelBlocked` | `` | `` | `False` | `False` | `L2 forward attempt failed or missing; L3 also missing` | `False` |
| `RBF` | `KernelBlocked` | `` | `` | `False` | `False` | `L2 forward attempt failed or missing; L3 also missing` | `False` |
| `Rational` | `ExpressionBlocked` | `1.7277440804473998` | `1.237324888092068` | `False` | `True` | `family-specific fused L3 efficiency passed but A4 expression failed` | `False` |
| `Wavelet` | `KernelBlocked` | `` | `` | `False` | `False` | `L2 forward attempt failed or missing; L3 also missing` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7jn-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR96-readblocktriton-crossZero-b32-hiddenTanhResidual010-hiddenResVJPTriton-crossBatchSGCap150-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.7277440804473998` | `0.8638095238095238` | `0` | `0` | `measured` |
| `Rational` | `B7jn-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR96-readblocktriton-crossZero-b32-hiddenTanhResidual010-hiddenResVJPTriton-crossBatchSGCap150-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.237324888092068` | `0.7819047619047619` | `1` | `1` | `measured` |
| `Rational` | `B7jo-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR80-readblocktriton-crossZero-b32-hiddenTanhResidual010-hiddenResVJPTriton-crossBatchSGCap150-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.8603863965323686` | `0.8414285714285714` | `0` | `0` | `measured` |
| `Rational` | `B7jo-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR80-readblocktriton-crossZero-b32-hiddenTanhResidual010-hiddenResVJPTriton-crossBatchSGCap150-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.2622641168972277` | `0.7823809523809524` | `1` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7jn-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR96-readblocktriton-crossZero-b32-hiddenTanhResidual010-hiddenResVJPTriton-crossBatchSGCap150-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7jo-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR80-readblocktriton-crossZero-b32-hiddenTanhResidual010-hiddenResVJPTriton-crossBatchSGCap150-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| `v1283_b109_auc_autopsy_trace.csv` | `360` | `0` | `0` | `0` | `1` |
| `v1283_b109_fullstep_profile.csv` | `9` | `0` | `0` | `0` | `1` |
| `v1283_b109_functional_control_matrix.csv` | `4` | `0` | `0` | `0` | `1` |
| `v1283_b109_functional_delta_score_control_matrix.csv` | `4` | `0` | `0` | `0` | `1` |
| `v1283_b109_functional_delta_score_repair.csv` | `28` | `0` | `0` | `0` | `1` |
| `v1283_b109_functional_delta_score_repair_summary.csv` | `1` | `0` | `0` | `0` | `1` |
...
| `v1283_family_component_profile.csv` | `4` | `0` | `0` | `0` | `1` |
| `v1283_family_efficiency.csv` | `5` | `0` | `0` | `0` | `1` |

Selected hashes:

| artifact | sha256_prefix |
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `e571e74c1f15` |
| `v1283_b109_auc_autopsy_trace.csv` | `bde83c059b64` |
| `v1283_b109_fullstep_profile.csv` | `d0933881607c` |
| `v1283_b109_functional_control_matrix.csv` | `cb67e09c2a0c` |
| `v1283_b109_functional_delta_score_control_matrix.csv` | `92492d837633` |
| `v1283_b109_functional_delta_score_repair.csv` | `7ff86f988067` |
| `v1283_b109_functional_delta_score_repair_summary.csv` | `32fcea3bcb5e` |
| `v1283_b109_functional_direction_audit.csv` | `c119f08336ec` |
| `v1283_b109_functional_five_step.csv` | `60ee03f7e66a` |
| `v1283_b109_functional_one_step.csv` | `badb5cd7eda8` |
| `v1283_b109_functional_route.json` | `d7b1d56a3900` |
| `v1283_b109_fused_backward_correctness.csv` | `3c50d2df5a75` |
| `v1283_b109_linec_coupling.csv` | `01c01ac68a92` |
| `v1283_b109_linec_diagnostics.csv` | `2fe91d57ecc4` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `a701e7fd204f` |
| `v1283_b109_linec_noise_leak.csv` | `a796fb45bb4c` |
| `v1283_b109_linec_signal_reservoir.csv` | `17aab882dc6f` |
| `v1283_b109_task_autopsy_final.csv` | `21ed00bf5614` |
| `v1283_family_component_profile.csv` | `990f6c2bc028` |
| `v1283_family_efficiency.csv` | `88cd87108815` |
