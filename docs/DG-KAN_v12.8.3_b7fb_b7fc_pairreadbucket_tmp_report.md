...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7fb_b7fc_pairreadbucket_wide_20260522T021000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.75485609639765` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.9988511658125161` | `0.5961904761904762` | `0` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9437603170334836` | `0.1295238095238095` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.021599967024749` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.9851318911895233` | `0.13` | `0` | `1` | `1` |
...
| `Rational` | `ExpressionBlocked` | `1.4795554777103315` | `1.2344088458066855` | `False` | `True` | `family-specific fused L3 efficiency passed but A4 expression failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fb-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairReadBucketR136G96-crossZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.7352323995185028` | `0.8019047619047619` | `0` | `0` | `measured` |
| `Rational` | `B7fb-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairReadBucketR136G96-crossZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.2344088458066855` | `0.8019047619047619` | `1` | `1` | `measured` |
| `Rational` | `B7fc-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairReadBucketR136G112-crossZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.4795554777103315` | `0.809047619047619` | `0` | `0` | `measured` |
| `Rational` | `B7fc-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairReadBucketR136G112-crossZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.5399414092793358` | `0.809047619047619` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fb-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairReadBucketR136G96-crossZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7fc-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairReadBucketR136G112-crossZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `cf8dfce6b49c` |
| `v1283_b109_auc_autopsy_trace.csv` | `cec9b76da270` |
| `v1283_b109_fullstep_profile.csv` | `83a7aadc2ef2` |
...
| `v1283_b109_fused_backward_correctness.csv` | `caff68c801f1` |
| `v1283_b109_linec_coupling.csv` | `b15dc6f4f33d` |
| `v1283_b109_linec_diagnostics.csv` | `8d1a46937561` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `387b677ad0ea` |
| `v1283_b109_task_autopsy_final.csv` | `e61c95d778db` |
| `v1283_family_component_profile.csv` | `9a10a0e8b1f1` |
| `v1283_family_efficiency.csv` | `cc3b14d31965` |
| `v1283_family_expression.csv` | `ccdcba30a163` |
| `v1283_family_failure_table.csv` | `950c400974b5` |
| `v1283_family_functional_diagnostic.csv` | `a6adab52c121` |
