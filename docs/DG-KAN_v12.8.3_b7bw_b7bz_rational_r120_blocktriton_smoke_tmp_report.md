...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_flashkat_b7bw_b7bz_r120_blocktriton_smoke_tmp
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.6731091442091741` | `1.0609523809523809` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.3203107854276481` | `0.5966666666666667` | `0` | `1` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9183189879859557` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8687445774233507` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.855247993977958` | `0.13` | `0` | `1` | `1` |

## 3. B109 AUC Autopsy

| candidate_id | mean_delta | worst_delta | near_pass_rate | ece_ok | auc_step_ok | auc_time_ok | A5_autopsy_pass |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `0.015625` | `0.015625` | `1.0` | `0` | `0` | `0` | `0` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `-0.3515625` | `-0.3515625` | `0.0` | `1` | `0` | `0` | `0` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `BSpline` | `KernelBlocked` | `3.245327181291257` | `2.4651309809727984` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
| `Chebyshev` | `ExpressionBlocked` | `2.391042213813749` | `0.9014698547485461` | `True` | `True` | `family-specific fused L3 efficiency exists; A4/A5 official family promotion not run in this closed follow-up runner` | `False` |
| `Fourier` | `ExpressionBlocked` | `1.9499526983382511` | `0.9648531217017209` | `True` | `True` | `family-specific fused L3 efficiency exists; A4/A5 official family promotion not run in this closed follow-up runner` | `False` |
| `RBF` | `KernelBlocked` | `1.8470689446114656` | `1.4232959644340133` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
| `Rational` | `ExpressionBlocked` | `1.322206058643823` | `1.2330341880478604` | `True` | `True` | `family-specific fused L3 efficiency exists; A4/A5 official family promotion not run in this closed follow-up runner` | `False` |
| `Wavelet` | `KernelBlocked` | `3.399938509439377` | `2.6670574079329223` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `BSpline` | `B6r-BSpline-order1-stream-K2-repair` | `L1-vectorized-or-stream-autograd` | `3.245327181291257` | `1.48` | `0` | `0` | `measured` |
| `BSpline` | `B6r-BSpline-order1-stream-K2-repair` | `L3-analytic-manual-ce-torch-reduction` | `2.4651309809727984` | `1.0723809523809524` | `0` | `0` | `measured` |
| `Rational` | `B7b-RationalKAT-flashgroup-G16-h112-linearres-tritonL3` | `L1-vectorized-or-stream-autograd` | `2.1977343831732137` | `0.5861904761904762` | `0` | `0` | `measured` |
| `Rational` | `B7b-RationalKAT-flashgroup-G16-h112-linearres-tritonL3` | `L3-analytic-manual-ce-torch-reduction` | `3.15317068301552` | `0.4319047619047619` | `0` | `0` | `measured` |
| `Rational` | `B7c-RationalKAT-flashgroup-G16-h80-linearres-tritonL3` | `L1-vectorized-or-stream-autograd` | `2.0497206530540684` | `0.5785714285714286` | `0` | `0` | `measured` |
| `Rational` | `B7c-RationalKAT-flashgroup-G16-h80-linearres-tritonL3` | `L3-analytic-manual-ce-torch-reduction` | `1.3820662555991763` | `0.4166666666666667` | `0` | `0` | `measured` |
| `Rational` | `B7d-RationalKAT-flashgroup-G16-h64-linearres-tritonL3` | `L1-vectorized-or-stream-autograd` | `1.8133051240320917` | `0.5747619047619048` | `0` | `0` | `measured` |
| `Rational` | `B7d-RationalKAT-flashgroup-G16-h64-linearres-tritonL3` | `L3-analytic-manual-ce-torch-reduction` | `1.5191390169764496` | `0.40904761904761905` | `0` | `0` | `measured` |
| `Rational` | `B7e-RationalKAT-flashgroup-G16-h64-linearres-inputcrossR64-tritonL3` | `L1-vectorized-or-stream-autograd` | `2.412290369816773` | `0.5747619047619048` | `0` | `0` | `measured` |
| `Rational` | `B7e-RationalKAT-flashgroup-G16-h64-linearres-inputcrossR64-tritonL3` | `L3-analytic-manual-ce-torch-reduction` | `1.3092568888143807` | `0.40904761904761905` | `1` | `0` | `measured` |
| `Rational` | `B7f-RationalKAT-flashgroup-G16-h64-linearres-inputcrossR128-tritonL3` | `L1-vectorized-or-stream-autograd` | `2.187966917950413` | `0.5747619047619048` | `0` | `0` | `measured` |
| `Rational` | `B7f-RationalKAT-flashgroup-G16-h64-linearres-inputcrossR128-tritonL3` | `L3-analytic-manual-ce-torch-reduction` | `1.5223466359192535` | `0.40904761904761905` | `0` | `0` | `measured` |
| `Rational` | `B7g-RationalKAT-flashgroup-G16-h64-linearres-inputcrossR96-tritonL3` | `L1-vectorized-or-stream-autograd` | `2.2018979531833525` | `0.5747619047619048` | `0` | `0` | `measured` |
| `Rational` | `B7g-RationalKAT-flashgroup-G16-h64-linearres-inputcrossR96-tritonL3` | `L3-analytic-manual-ce-torch-reduction` | `1.5983661810874614` | `0.40904761904761905` | `0` | `0` | `measured` |
| `Rational` | `B7h-RationalKAT-flashgroup-G16-h64-linearres-inputcrossR112-tritonL3` | `L1-vectorized-or-stream-autograd` | `1.6418555560496697` | `0.5747619047619048` | `0` | `0` | `measured` |
| `Rational` | `B7h-RationalKAT-flashgroup-G16-h64-linearres-inputcrossR112-tritonL3` | `L3-analytic-manual-ce-torch-reduction` | `1.3348634522438776` | `0.40904761904761905` | `1` | `0` | `measured` |
| `Rational` | `B7i-RationalKAT-flashgroup-G16-h64-linearres-paircrossR136-tritonL3` | `L1-vectorized-or-stream-autograd` | `2.2666287656169866` | `0.5747619047619048` | `0` | `0` | `measured` |
| `Rational` | `B7i-RationalKAT-flashgroup-G16-h64-linearres-paircrossR136-tritonL3` | `L3-analytic-manual-ce-torch-reduction` | `1.3032066911455833` | `0.40904761904761905` | `1` | `0` | `measured` |
| `Rational` | `B7j-RationalKAT-flashgroup-G16-h64-linearres-paircrossR96-tritonL3` | `L1-vectorized-or-stream-autograd` | `2.326599658378665` | `0.5747619047619048` | `0` | `0` | `measured` |
| `Rational` | `B7j-RationalKAT-flashgroup-G16-h64-linearres-paircrossR96-tritonL3` | `L3-analytic-manual-ce-torch-reduction` | `1.3118128101922044` | `0.40904761904761905` | `1` | `0` | `measured` |
| `Rational` | `B7k-RationalKAT-flashgroup-G16-h64-linearres-paircrossR88-tritonL3` | `L1-vectorized-or-stream-autograd` | `2.5337508634112926` | `0.5747619047619048` | `0` | `0` | `measured` |
| `Rational` | `B7k-RationalKAT-flashgroup-G16-h64-linearres-paircrossR88-tritonL3` | `L3-analytic-manual-ce-torch-reduction` | `1.3545737043711725` | `0.40904761904761905` | `0` | `0` | `measured` |
| `Rational` | `B7l-RationalKAT-flashgroup-G16-h64-linearres-paircrossR80-tritonL3` | `L1-vectorized-or-stream-autograd` | `2.67963449908388` | `0.5747619047619048` | `0` | `0` | `measured` |
| `Rational` | `B7l-RationalKAT-flashgroup-G16-h64-linearres-paircrossR80-tritonL3` | `L3-analytic-manual-ce-torch-reduction` | `1.3700170490737544` | `0.40904761904761905` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `BSpline` | `B6r-BSpline-order1-stream-K2-repair` | `L2_torch_compile_forward_attempt` | `2.6913066296910637` | `0` | `measured` |
...
| --- | --- | --- | --- | --- | --- |
| `v1283_b109_auc_attribution.csv` | `4` | `0` | `0` | `0` | `1` |
| `v1283_b109_auc_autopsy_trace.csv` | `3` | `0` | `0` | `0` | `1` |
...
| `v1283_b109_task_autopsy_final.csv` | `3` | `0` | `0` | `0` | `1` |
| `v1283_family_component_profile.csv` | `250` | `0` | `0` | `0` | `1` |
| `v1283_family_efficiency.csv` | `251` | `0` | `0` | `0` | `1` |
| `v1283_family_expression.csv` | `125` | `0` | `0` | `0` | `1` |
| `v1283_family_failure_table.csv` | `125` | `0` | `0` | `0` | `1` |
| `v1283_family_functional_diagnostic.csv` | `125` | `0` | `0` | `0` | `1` |

Selected hashes:

| artifact | sha256_prefix |
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `e44ddcf184da` |
| `v1283_b109_auc_autopsy_trace.csv` | `dd7b77fd9f3b` |
| `v1283_b109_fullstep_profile.csv` | `54e2962f2d2b` |
| `v1283_b109_functional_control_matrix.csv` | `43845c5e0d0f` |
| `v1283_b109_functional_direction_audit.csv` | `3745c9477bd5` |
| `v1283_b109_functional_five_step.csv` | `d20ef04059fd` |
| `v1283_b109_functional_one_step.csv` | `d24d56f87dae` |
| `v1283_b109_functional_route.json` | `2de54dd1ee62` |
| `v1283_b109_fused_backward_correctness.csv` | `5a35770c33ba` |
| `v1283_b109_linec_coupling.csv` | `f683fce6d293` |
| `v1283_b109_linec_diagnostics.csv` | `d1d5d40fd7dd` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6979ccd741e0` |
| `v1283_b109_linec_noise_leak.csv` | `d755067998f1` |
| `v1283_b109_linec_signal_reservoir.csv` | `ed1e7cb2938b` |
| `v1283_b109_task_autopsy_final.csv` | `94ba296d0b17` |
| `v1283_family_component_profile.csv` | `83d009ce0103` |
| `v1283_family_efficiency.csv` | `d814c245b1ff` |
| `v1283_family_expression.csv` | `81439c31d9a1` |
| `v1283_family_failure_table.csv` | `97497acc97e8` |
| `v1283_family_functional_diagnostic.csv` | `c19f40fb275a` |
