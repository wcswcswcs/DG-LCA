...
artifact = results/v12_6_lowerlevel_fhq_functional_geometry/v126_smoke_repair2_20260520T001000Z
...
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `torch-reference-simple-fast` | `4.2947589454260084` | `0.0` | `0.0` | `0` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `FHQ0-triton-two-kernel-forward-exact-B48a` | `1.432580167197428` | `3.5762786865234375e-07` | `2.964765712931694e-07` | `0` |
...
|---|---|---|---|---|---|---|
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.7799116775455655` | `0.7819047619047619` | `1` | `0` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.1941071878207985` | `0.09857142857142857` | `1` | `0` | `` |
...
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-fixedP-readout-grad` | `bias` | `6.530710550123331e-08` | `1.0000001192092896` | `1` | `` |
...
| `v126_candidate_manifest.csv` | `006ce994633d` |
| `v126_expression_audit.csv` | `b0999fdf5812` |
| `v126_failure_table.csv` | `433e200bf0e9` |
| `v126_fullstep_profile.csv` | `75b28d1bcb64` |
...
| `v126_fused_backward_correctness.csv` | `e9a2be67b65b` |
| `v126_fused_forward_profile.csv` | `0ab18669d029` |
| `v126_manifold_channel_diagnostics.csv` | `3788ea244cbf` |
