...
B109_A5_best_candidate = B269b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b269_b270_signalblockmix_short_20260522T050319Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.120397156472016` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7087812157011248` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6652224430370313` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.7412905359481291` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.7124833222112174` | `0.13` | `1` | `1` | `1` |
| `B269b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.126867119529923` | `2.719047619047619` | `0` | `0` | `0` |
| `B269b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7106387072318627` | `0.5961904761904762` | `1` | `1` | `1` |
| `B269b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6738543177904478` | `0.1295238095238095` | `1` | `1` | `1` |
| `B270b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.1452211252801539` | `2.719047619047619` | `0` | `0` | `0` |
| `B270b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7326140164376844` | `0.5961904761904762` | `1` | `1` | `1` |
| `B270b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7106202033703682` | `0.1295238095238095` | `1` | `1` | `1` |
...
| `B269b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.027994791666666668` | `-0.00390625` | `1.0` | `0` | `1` | `1` | `0` |
| `B270b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.027994791666666668` | `-0.00390625` | `1.0` | `0` | `1` | `1` | `0` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `02887014c4b6` |
| `v1283_b109_auc_autopsy_trace.csv` | `02abb013af17` |
| `v1283_b109_fullstep_profile.csv` | `ea2006b55453` |
| `v1283_b109_functional_control_matrix.csv` | `e61e4cbf9553` |
| `v1283_b109_functional_direction_audit.csv` | `2fd86434159d` |
| `v1283_b109_functional_five_step.csv` | `1beb18fe03b4` |
| `v1283_b109_functional_one_step.csv` | `c88106fdf8a4` |
| `v1283_b109_functional_route.json` | `dca5255e2070` |
| `v1283_b109_fused_backward_correctness.csv` | `dd785f1a2246` |
| `v1283_b109_linec_coupling.csv` | `658b726181d5` |
| `v1283_b109_linec_diagnostics.csv` | `67bdf4397c69` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `30146f5f4d92` |
| `v1283_b109_linec_noise_leak.csv` | `edc420ca25de` |
| `v1283_b109_linec_signal_reservoir.csv` | `02e7416c8cb8` |
| `v1283_b109_task_autopsy_final.csv` | `982258f5b5e2` |
