...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b250_b251_lowgainramp_20260523T025000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.322267003322223` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8270299760061668` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7890257730139946` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8773493396267384` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8427745719652143` | `0.13` | `1` | `1` | `1` |
| `B250b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp065-identitytailquad030-hingeamp025-temp107` | `B48a-existing-manual-ce-torch-reduction` | `1.3342948321687305` | `2.719047619047619` | `0` | `0` | `0` |
| `B250b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp065-identitytailquad030-hingeamp025-temp107` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8320994337101434` | `0.5961904761904762` | `1` | `1` | `1` |
| `B250b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp065-identitytailquad030-hingeamp025-temp107` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7813718441845713` | `0.1295238095238095` | `1` | `1` | `1` |
| `B251b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp050-identitytailquad030-hingeamp025-temp107` | `B48a-existing-manual-ce-torch-reduction` | `1.3009198476423656` | `2.719047619047619` | `0` | `0` | `0` |
| `B251b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp050-identitytailquad030-hingeamp025-temp107` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8194098313226787` | `0.5961904761904762` | `1` | `1` | `1` |
| `B251b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp050-identitytailquad030-hingeamp025-temp107` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7752991900318266` | `0.1295238095238095` | `1` | `1` | `1` |
...
| `v1283_b109_fused_backward_correctness.csv` | `50` | `0` | `0` | `0` | `1` |
...
| `v1283_family_component_profile.csv` | `1` | `0` | `0` | `0` | `1` |
| `v1283_family_efficiency.csv` | `1` | `0` | `0` | `0` | `1` |
| `v1283_family_expression.csv` | `0` | `0` | `0` | `0` | `1` |
| `v1283_family_failure_table.csv` | `1` | `0` | `0` | `0` | `1` |
| `v1283_family_functional_diagnostic.csv` | `0` | `0` | `0` | `0` | `1` |

Selected hashes:

| artifact | sha256_prefix |
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `5462f2571189` |
| `v1283_b109_auc_autopsy_trace.csv` | `80d61f822843` |
| `v1283_b109_fullstep_profile.csv` | `a92cbd9bc57e` |
| `v1283_b109_functional_control_matrix.csv` | `1ed948b5b83c` |
| `v1283_b109_functional_direction_audit.csv` | `d54308e73b33` |
| `v1283_b109_functional_five_step.csv` | `9e0b9f0eb9d7` |
| `v1283_b109_functional_one_step.csv` | `a59fad3e574e` |
| `v1283_b109_functional_route.json` | `32f141b2942c` |
| `v1283_b109_fused_backward_correctness.csv` | `9f130cd01c61` |
| `v1283_b109_linec_coupling.csv` | `d6174a5e3b8d` |
| `v1283_b109_linec_diagnostics.csv` | `30197964a055` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `5ac7a3d9e3a1` |
| `v1283_b109_linec_noise_leak.csv` | `008580af3b2a` |
| `v1283_b109_linec_signal_reservoir.csv` | `ec0edad5025f` |
| `v1283_b109_task_autopsy_final.csv` | `3ed685b46792` |
| `v1283_family_component_profile.csv` | `c8865a700f0e` |
| `v1283_family_efficiency.csv` | `d92802d981e5` |
| `v1283_family_expression.csv` | `7eb70257593d` |
| `v1283_family_failure_table.csv` | `a1b59d09cc14` |
| `v1283_family_functional_diagnostic.csv` | `7eb70257593d` |
