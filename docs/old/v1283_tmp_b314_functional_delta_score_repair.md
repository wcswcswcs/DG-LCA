...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b314_functional_delta_score_repair_20260522T193000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.4797471750617155` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.9727269736239598` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9218777453135907` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8975626194370407` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8662452691569043` | `0.13` | `0` | `1` | `1` |
| `B314b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp105-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.24982549446429` | `2.719047619047619` | `0` | `0` | `0` |
| `B314b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp105-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8199711305323765` | `0.5961904761904762` | `1` | `1` | `1` |
| `B314b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp105-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.745794260887812` | `0.1295238095238095` | `1` | `1` | `1` |
...
| `Rational` | `TaskBlocked` | `2.8716310816788626` | `1.1157145028801778` | `False` | `True` | `family-specific fused L3 efficiency and A4 expression passed; A5 fused task triage failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7jf-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-crossBatchCap150-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `2.8716310816788626` | `0.9195238095238095` | `0` | `0` | `measured` |
| `Rational` | `B7jf-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-crossBatchCap150-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.1157145028801778` | `0.7647619047619048` | `1` | `1` | `measured` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `f6f25fe80d59` |
| `v1283_b109_auc_autopsy_trace.csv` | `f636abd37384` |
| `v1283_b109_fullstep_profile.csv` | `378f349b7565` |
...
| `v1283_b109_fused_backward_correctness.csv` | `3f5929299c57` |
| `v1283_b109_linec_coupling.csv` | `35099a60f25a` |
| `v1283_b109_linec_diagnostics.csv` | `41df19093358` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `a701e7fd204f` |
| `v1283_b109_linec_noise_leak.csv` | `a796fb45bb4c` |
| `v1283_b109_linec_signal_reservoir.csv` | `c3bbc53156a2` |
| `v1283_b109_task_autopsy_final.csv` | `230c41eeecfc` |
| `v1283_family_component_profile.csv` | `7b31d990e018` |
| `v1283_family_efficiency.csv` | `be45c99abae8` |
