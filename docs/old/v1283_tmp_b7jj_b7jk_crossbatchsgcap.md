...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b7jj_b7jk_crossbatchsgcap_20260522T211000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.47466308337878` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.9553899659049846` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9052921610799466` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.874440305721749` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8157784117349789` | `0.13` | `1` | `1` | `1` |
| `B314b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp105-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.2737469773985615` | `2.719047619047619` | `0` | `0` | `0` |
| `B314b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp105-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8224216598980024` | `0.5961904761904762` | `1` | `1` | `1` |
| `B314b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp105-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.756822189008975` | `0.1295238095238095` | `1` | `1` | `1` |
...
| `Rational` | `TaskBlocked` | `1.1224252559852514` | `1.0663679877302523` | `False` | `True` | `family-specific fused L3 efficiency and A4 expression passed; A5 fused task triage failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7jj-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-crossBatchSGCap150-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `2.1947499854975883` | `0.9195238095238095` | `0` | `0` | `measured` |
| `Rational` | `B7jj-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-crossBatchSGCap150-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.0663679877302523` | `0.7652380952380953` | `1` | `1` | `measured` |
| `Rational` | `B7jk-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-crossBatchSGCap200-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.1224252559852514` | `0.9195238095238095` | `1` | `0` | `measured` |
| `Rational` | `B7jk-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-crossBatchSGCap200-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.1592220481932825` | `0.7652380952380953` | `1` | `1` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7jj-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-crossBatchSGCap150-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7jk-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-crossBatchSGCap200-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `0b3b979e5310` |
| `v1283_b109_auc_autopsy_trace.csv` | `51ed3f1f7593` |
| `v1283_b109_fullstep_profile.csv` | `835cc79cd2eb` |
...
| `v1283_b109_fused_backward_correctness.csv` | `9df28288cc44` |
| `v1283_b109_linec_coupling.csv` | `22db697a3b89` |
| `v1283_b109_linec_diagnostics.csv` | `144cbb58c91d` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `a701e7fd204f` |
| `v1283_b109_linec_noise_leak.csv` | `a796fb45bb4c` |
| `v1283_b109_linec_signal_reservoir.csv` | `89f9459494bb` |
| `v1283_b109_task_autopsy_final.csv` | `9e34c74f3b71` |
| `v1283_family_component_profile.csv` | `3c3d8f47e140` |
| `v1283_family_efficiency.csv` | `8b6131ef05c1` |
