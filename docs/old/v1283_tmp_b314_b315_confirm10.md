...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b314_b315_directramp_confirm10_20260522T184500Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.3969449839137094` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.9002855657369584` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.8572292486532843` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8360491387987234` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.7789951421459218` | `0.13` | `1` | `1` | `1` |
| `B314b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp105-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.1842054882816853` | `2.719047619047619` | `0` | `0` | `0` |
| `B314b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp105-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7671081714775821` | `0.5961904761904762` | `1` | `1` | `1` |
| `B314b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp105-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7029370517485489` | `0.1295238095238095` | `1` | `1` | `1` |
| `B315b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp110-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.1723508706322026` | `2.719047619047619` | `0` | `0` | `0` |
| `B315b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp110-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7694653754741743` | `0.5961904761904762` | `1` | `1` | `1` |
| `B315b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp110-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7019445390606336` | `0.1295238095238095` | `1` | `1` | `1` |
...
| `B315b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp110-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.0234375` | `0.001953125` | `1.0` | `1` | `1` | `1` | `1` |
...
| `Rational` | `TaskBlocked` | `3.1874047694195005` | `1.2128866619667948` | `False` | `True` | `family-specific fused L3 efficiency and A4 expression passed; A5 fused task triage failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7jf-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-crossBatchCap150-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `3.1874047694195005` | `0.9195238095238095` | `0` | `0` | `measured` |
| `Rational` | `B7jf-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-crossBatchCap150-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.2128866619667948` | `0.7647619047619048` | `1` | `1` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7jf-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-crossBatchCap150-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| `v1283_b109_auc_autopsy_trace.csv` | `450` | `0` | `0` | `0` | `1` |
...
| `v1283_family_expression.csv` | `81` | `0` | `0` | `0` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `79e4ffa89846` |
| `v1283_b109_auc_autopsy_trace.csv` | `397510f37764` |
| `v1283_b109_fullstep_profile.csv` | `a4bc4fc39072` |
...
| `v1283_b109_fused_backward_correctness.csv` | `9cb208f8a663` |
| `v1283_b109_linec_coupling.csv` | `04e679199999` |
| `v1283_b109_linec_diagnostics.csv` | `4c25e505cbb8` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `a701e7fd204f` |
| `v1283_b109_linec_noise_leak.csv` | `a796fb45bb4c` |
| `v1283_b109_linec_signal_reservoir.csv` | `0680b7cfe8c9` |
| `v1283_b109_task_autopsy_final.csv` | `d3c4aecb3211` |
| `v1283_family_component_profile.csv` | `e2e6e9ac2939` |
| `v1283_family_efficiency.csv` | `5a6a95baa4be` |
| `v1283_family_expression.csv` | `6ec5c0f63dff` |
| `v1283_family_failure_table.csv` | `160dfe50d0d3` |
| `v1283_family_functional_diagnostic.csv` | `b8ab83924e1a` |
