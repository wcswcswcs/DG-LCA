...
B109_A5_best_candidate = B306b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct075-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b306_direct075_short_20260522T081500Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.2869277128281917` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8424612563275898` | `0.5966666666666667` | `1` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.8032260981667603` | `0.5966666666666667` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.7701768886028724` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.762569550035717` | `0.13` | `1` | `1` | `1` |
| `B306b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct075-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.1151264696614698` | `2.719047619047619` | `0` | `0` | `0` |
| `B306b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct075-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7242965974880257` | `0.5961904761904762` | `1` | `1` | `1` |
| `B306b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct075-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6787656535420374` | `0.1295238095238095` | `1` | `1` | `1` |
...
| `B306b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct075-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.017578125` | `-0.02734375` | `0.8333333333333334` | `1` | `0` | `0` | `0` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `54b4bdcf1e4d` |
| `v1283_b109_auc_autopsy_trace.csv` | `5715061088e1` |
| `v1283_b109_fullstep_profile.csv` | `74dfac7128c7` |
| `v1283_b109_functional_control_matrix.csv` | `22fe8efb1314` |
| `v1283_b109_functional_direction_audit.csv` | `43bdf4909365` |
| `v1283_b109_functional_five_step.csv` | `f4c61d7016b2` |
| `v1283_b109_functional_one_step.csv` | `2ce68d00366f` |
| `v1283_b109_functional_route.json` | `4858170fffa9` |
| `v1283_b109_fused_backward_correctness.csv` | `73dd21729581` |
| `v1283_b109_linec_coupling.csv` | `f5bb84001b39` |
| `v1283_b109_linec_diagnostics.csv` | `4b16d692ed53` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `48b580713575` |
| `v1283_b109_linec_noise_leak.csv` | `ffc68110b5a6` |
| `v1283_b109_linec_signal_reservoir.csv` | `43c8ac1737e9` |
| `v1283_b109_task_autopsy_final.csv` | `d5d9882855a4` |
