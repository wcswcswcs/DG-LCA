...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b309_confirm10_seed0to9_20260522T090000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.5023419439242398` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.9677068754060608` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9102526388412618` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.887909154186866` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8360221687890338` | `0.13` | `1` | `1` | `1` |
| `B309b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp100-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.34324463801938` | `2.719047619047619` | `0` | `0` | `0` |
| `B309b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp100-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8343616613846866` | `0.5961904761904762` | `1` | `1` | `1` |
| `B309b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp100-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7614530847952088` | `0.1295238095238095` | `1` | `1` | `1` |
...
| `B309b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp100-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.016080729166666665` | `-0.0078125` | `1.0` | `1` | `0` | `0` | `0` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `e6cf2082174d` |
| `v1283_b109_auc_autopsy_trace.csv` | `a938b3a6254c` |
| `v1283_b109_fullstep_profile.csv` | `e4c2284f7e5e` |
| `v1283_b109_functional_control_matrix.csv` | `89587c10f87e` |
| `v1283_b109_functional_direction_audit.csv` | `84f87008d44a` |
| `v1283_b109_functional_five_step.csv` | `49fccfe2e41c` |
| `v1283_b109_functional_one_step.csv` | `a62972409f90` |
| `v1283_b109_functional_route.json` | `d8547228acfc` |
| `v1283_b109_fused_backward_correctness.csv` | `84f348de36cc` |
| `v1283_b109_linec_coupling.csv` | `be7936df0010` |
| `v1283_b109_linec_diagnostics.csv` | `e8f2865276d4` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `75ab2078197c` |
| `v1283_b109_linec_noise_leak.csv` | `c79bec650e57` |
| `v1283_b109_linec_signal_reservoir.csv` | `dcf2d873e8f5` |
| `v1283_b109_task_autopsy_final.csv` | `fa27de970f6d` |
