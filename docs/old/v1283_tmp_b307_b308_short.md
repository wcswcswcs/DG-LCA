...
B109_A5_best_candidate = B307b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct060-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b307_b308_directbracket_short_20260522T083000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.1154943548188638` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7235361114283605` | `0.5966666666666667` | `1` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6836863635417146` | `0.5966666666666667` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.6615277734835181` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.6325149561175742` | `0.13` | `1` | `1` | `1` |
| `B307b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct060-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `0.796129490535251` | `2.719047619047619` | `1` | `0` | `0` |
| `B307b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct060-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.5208031644103206` | `0.5961904761904762` | `1` | `1` | `1` |
| `B307b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct060-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.4885570519155534` | `0.1295238095238095` | `1` | `1` | `1` |
| `B308b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct065-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.1627245457262896` | `2.719047619047619` | `0` | `0` | `0` |
| `B308b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct065-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7655612685566136` | `0.5961904761904762` | `1` | `1` | `1` |
| `B308b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct065-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6847827882950072` | `0.1295238095238095` | `1` | `1` | `1` |
...
| `B307b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct060-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.0234375` | `-0.015625` | `0.8333333333333334` | `1` | `0` | `0` | `0` |
| `B308b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-direct065-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.021484375` | `-0.0234375` | `0.8333333333333334` | `1` | `0` | `0` | `0` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `991afb0a0028` |
| `v1283_b109_auc_autopsy_trace.csv` | `57d2d61742b4` |
| `v1283_b109_fullstep_profile.csv` | `f5280641006d` |
| `v1283_b109_functional_control_matrix.csv` | `a65ec3321971` |
| `v1283_b109_functional_direction_audit.csv` | `8087ba13a871` |
| `v1283_b109_functional_five_step.csv` | `ff8b12412ace` |
| `v1283_b109_functional_one_step.csv` | `64006d8588ee` |
| `v1283_b109_functional_route.json` | `fa5ff17b265d` |
| `v1283_b109_fused_backward_correctness.csv` | `a1e79f7383ac` |
| `v1283_b109_linec_coupling.csv` | `3b82e01730d0` |
| `v1283_b109_linec_diagnostics.csv` | `22175a9a8219` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `e4f8029b35b6` |
| `v1283_b109_linec_noise_leak.csv` | `c54b3da56550` |
| `v1283_b109_linec_signal_reservoir.csv` | `647b560a7f35` |
| `v1283_b109_task_autopsy_final.csv` | `400bd8b03c41` |
