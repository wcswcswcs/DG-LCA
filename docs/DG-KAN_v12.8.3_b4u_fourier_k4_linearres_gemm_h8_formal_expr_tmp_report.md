...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_fourier_k4_linearres_gemm_h8_formal_expr_20260521T113000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.3804495357416362` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.9008751963682006` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `1.0297400413185793` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8001208636582434` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.7840041428227491` | `0.13` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.1676129587766655` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7376471752993008` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6822786614004324` | `0.1295238095238095` | `1` | `1` | `1` |

## 3. B109 AUC Autopsy

| candidate_id | mean_delta | worst_delta | near_pass_rate | ece_ok | auc_step_ok | auc_time_ok | A5_autopsy_pass |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `-0.083984375` | `-0.083984375` | `0.0` | `0` | `0` | `0` | `0` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `-0.37890625` | `-0.37890625` | `0.0` | `0` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `0.04296875` | `0.04296875` | `1.0` | `1` | `1` | `1` | `1` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `BSpline` | `KernelBlocked` | `2.2511144470911115` | `0.9397851370644832` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
| `Chebyshev` | `KernelBlocked` | `1.1293165236859728` | `0.9322242405010235` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
| `Fourier` | `ExpressionBlocked` | `1.0669556694624` | `0.6482926745781791` | `True` | `True` | `family-specific fused L3 efficiency passed but A4 expression failed` | `False` |
| `RBF` | `KernelBlocked` | `1.2438329458172628` | `0.9267308472784795` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
| `Rational` | `KernelBlocked` | `2.2430981024121635` | `1.3163699804096265` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
| `Wavelet` | `KernelBlocked` | `4.9564237097698856` | `1.7692961255405995` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `BSpline` | `B6r-BSpline-order1-stream-K2-repair` | `L1-vectorized-or-stream-autograd` | `2.2511144470911115` | `1.48` | `0` | `0` | `measured` |
| `BSpline` | `B6r-BSpline-order1-stream-K2-repair` | `L3-analytic-manual-ce-torch-reduction` | `0.9397851370644832` | `1.5585714285714285` | `0` | `0` | `measured` |
| `Rational` | `B7a-RationalKAT-lite-safe-den-K4` | `L1-vectorized-or-stream-autograd` | `2.2430981024121635` | `3.954285714285714` | `0` | `0` | `measured` |
| `Rational` | `B7a-RationalKAT-lite-safe-den-K4` | `L3-analytic-manual-ce-torch-reduction` | `1.3163699804096265` | `3.580952380952381` | `0` | `0` | `measured` |
| `RBF` | `B2r-FastKAN-RBF-stream-K2-repair` | `L1-vectorized-or-stream-autograd` | `1.2438329458172628` | `1.48` | `0` | `0` | `measured` |
| `RBF` | `B2r-FastKAN-RBF-stream-K2-repair` | `L3-analytic-manual-ce-torch-reduction` | `0.9267308472784795` | `1.6147619047619048` | `0` | `0` | `measured` |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L1-vectorized-or-stream-autograd` | `2.3765576995967574` | `3.966666666666667` | `0` | `0` | `measured` |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L3-analytic-manual-ce-torch-reduction` | `0.9322242405010235` | `2.434285714285714` | `0` | `0` | `measured` |
| `Chebyshev` | `B3a-ChebyKAN-K4` | `L1-vectorized-or-stream-autograd` | `1.1293165236859728` | `2.355238095238095` | `0` | `0` | `measured` |
| `Chebyshev` | `B3a-ChebyKAN-K4` | `L3-analytic-manual-ce-torch-reduction` | `0.997673813466635` | `1.4804761904761905` | `0` | `0` | `measured` |
| `Chebyshev` | `B3d-ChebyKAN-K6-stream` | `L1-vectorized-or-stream-autograd` | `4.598005664867585` | `15.101904761904763` | `0` | `0` | `measured` |
| `Chebyshev` | `B3d-ChebyKAN-K6-stream` | `L3-analytic-manual-ce-torch-reduction` | `1.2732056428909597` | `3.487142857142857` | `0` | `0` | `measured` |
| `Fourier` | `B4b-FourierKAN-lowfreq-K2-stream` | `L1-vectorized-or-stream-autograd` | `1.7168094911114036` | `2.4414285714285713` | `0` | `0` | `measured` |
| `Fourier` | `B4b-FourierKAN-lowfreq-K2-stream` | `L3-analytic-manual-ce-torch-reduction` | `0.9477033718095058` | `1.6114285714285714` | `0` | `0` | `measured` |
| `Fourier` | `B4c-FourierKAN-lowfreq-K2-flatgemm-manual` | `L1-vectorized-or-stream-autograd` | `1.7403467183262706` | `1.6942857142857144` | `0` | `0` | `measured` |
| `Fourier` | `B4c-FourierKAN-lowfreq-K2-flatgemm-manual` | `L3-analytic-manual-ce-torch-reduction` | `0.8662990523779505` | `1.9052380952380952` | `0` | `0` | `measured` |
| `Fourier` | `B4d-FourierKAN-lowfreq-K2-flatgemm-recompute` | `L1-vectorized-or-stream-autograd` | `1.7366541874464416` | `2.4414285714285713` | `0` | `0` | `measured` |
| `Fourier` | `B4d-FourierKAN-lowfreq-K2-flatgemm-recompute` | `L3-analytic-manual-ce-torch-reduction` | `0.8823120107380232` | `2.277142857142857` | `0` | `0` | `measured` |
| `Fourier` | `B4e-FourierKAN-lowfreq-K2-tritonL3` | `L1-vectorized-or-stream-autograd` | `1.3299328066864755` | `2.4414285714285713` | `0` | `0` | `measured` |
| `Fourier` | `B4e-FourierKAN-lowfreq-K2-tritonL3` | `L3-analytic-manual-ce-torch-reduction` | `1.6102934980475578` | `0.9990476190476191` | `0` | `0` | `measured` |
| `Fourier` | `B4f-FourierKAN-lowfreq-K2-tritonL3-blockH` | `L1-vectorized-or-stream-autograd` | `1.4521261131253325` | `2.4414285714285713` | `0` | `0` | `measured` |
| `Fourier` | `B4f-FourierKAN-lowfreq-K2-tritonL3-blockH` | `L3-analytic-manual-ce-torch-reduction` | `0.7919410974119363` | `0.9990476190476191` | `1` | `1` | `measured` |
| `Fourier` | `B4g-FourierKAN-lowfreq-K2-tritonL3-matmulTile` | `L1-vectorized-or-stream-autograd` | `1.731837752767981` | `2.4414285714285713` | `0` | `0` | `measured` |
| `Fourier` | `B4g-FourierKAN-lowfreq-K2-tritonL3-matmulTile` | `L3-analytic-manual-ce-torch-reduction` | `0.6482926745781791` | `0.9990476190476191` | `1` | `1` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `BSpline` | `B6r-BSpline-order1-stream-K2-repair` | `L2_torch_compile_forward_attempt` | `1.1265515237425836` | `0` | `measured` |
| `Rational` | `B7a-RationalKAT-lite-safe-den-K4` | `L2_torch_compile_forward_attempt` | `1.034593923877661` | `0` | `measured` |
| `RBF` | `B2r-FastKAN-RBF-stream-K2-repair` | `L2_torch_compile_forward_attempt` | `1.1180061177449945` | `0` | `measured` |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L2_torch_compile_forward_attempt` | `1577.461117175628` | `0` | `measured` |
| `Chebyshev` | `B3a-ChebyKAN-K4` | `L2_torch_compile_forward_attempt` | `0.9421101508232255` | `0` | `measured` |
| `Chebyshev` | `B3d-ChebyKAN-K6-stream` | `L2_torch_compile_forward_attempt` | `1822.3792569963364` | `0` | `measured` |
| `Fourier` | `B4b-FourierKAN-lowfreq-K2-stream` | `L2_torch_compile_forward_attempt` | `1967.7176982671624` | `0` | `measured` |
| `Fourier` | `B4c-FourierKAN-lowfreq-K2-flatgemm-manual` | `L2_torch_compile_forward_attempt` | `1989.792136066816` | `0` | `measured` |
| `Fourier` | `B4d-FourierKAN-lowfreq-K2-flatgemm-recompute` | `L2_torch_compile_forward_attempt` | `2136.2432461351796` | `0` | `measured` |
| `Fourier` | `B4e-FourierKAN-lowfreq-K2-tritonL3` | `L2_torch_compile_forward_attempt` | `2320.419667293624` | `0` | `measured` |
| `Fourier` | `B4f-FourierKAN-lowfreq-K2-tritonL3-blockH` | `L2_torch_compile_forward_attempt` | `2348.9924922153855` | `0` | `measured` |
| `Fourier` | `B4g-FourierKAN-lowfreq-K2-tritonL3-matmulTile` | `L2_torch_compile_forward_attempt` | `2206.8015983492296` | `0` | `measured` |
| `Fourier` | `B4h-FourierKAN-lowfreq-K3-tritonL3-matmulTile` | `L2_torch_compile_forward_attempt` | `2434.1282125032885` | `0` | `measured` |
| `Fourier` | `B4i-FourierKAN-lowfreq-K3-h96-tritonL3-matmulTile` | `L2_torch_compile_forward_attempt` | `2595.1196661156246` | `0` | `measured` |
| `Fourier` | `B4j-FourierKAN-lowfreq-K3-h80-tritonL3-matmulTile` | `L2_torch_compile_forward_attempt` | `2799.7638434595497` | `0` | `measured` |
| `Fourier` | `B4k-FourierKAN-lowfreq-K3-h64-tritonL3-matmulTile` | `L2_torch_compile_forward_attempt` | `2793.0551932115804` | `0` | `measured` |
| `Fourier` | `B4l-FourierKAN-lowfreq-K4-h64-tritonL3-matmulTile` | `L2_torch_compile_forward_attempt` | `2969.6096187600374` | `0` | `measured` |
| `Fourier` | `B4m-FourierKAN-lowfreq-K4-h48-tritonL3-matmulTile` | `L2_torch_compile_forward_attempt` | `3160.4101863595492` | `0` | `measured` |
| `Fourier` | `B4n-FourierKAN-lowfreq-K4-h64-linearres-tritonL3-matmulTile` | `L2_torch_compile_forward_attempt` | `3313.3530543568318` | `0` | `measured` |
| `Fourier` | `B4o-FourierKAN-lowfreq-K4-h48-linearres-tritonL3-matmulTile` | `L2_torch_compile_forward_attempt` | `3537.946833929532` | `0` | `measured` |
| `Fourier` | `B4p-FourierKAN-lowfreq-K4-h64-linearres-gemmDirectL3` | `L2_torch_compile_forward_attempt` | `3431.2516246578894` | `0` | `measured` |
| `Fourier` | `B4q-FourierKAN-lowfreq-K4-h48-linearres-gemmDirectL3` | `L2_torch_compile_forward_attempt` | `3554.2181841920296` | `0` | `measured` |
| `Fourier` | `B4r-FourierKAN-lowfreq-K4-h32-linearres-gemmDirectL3` | `L2_torch_compile_forward_attempt` | `3784.6925469923704` | `0` | `measured` |
| `Fourier` | `B4s-FourierKAN-lowfreq-K4-h24-linearres-gemmDirectL3` | `L2_torch_compile_forward_attempt` | `3942.9248033722206` | `0` | `measured` |
...
| `v1283_b109_auc_autopsy_trace.csv` | `4` | `0` | `0` | `0` | `1` |
...
| `v1283_family_component_profile.csv` | `56` | `0` | `0` | `0` | `1` |
| `v1283_family_efficiency.csv` | `57` | `0` | `0` | `0` | `1` |
| `v1283_family_expression.csv` | `874` | `0` | `0` | `0` | `1` |
| `v1283_family_failure_table.csv` | `28` | `0` | `0` | `0` | `1` |
| `v1283_family_functional_diagnostic.csv` | `28` | `0` | `0` | `0` | `1` |

Selected hashes:

| artifact | sha256_prefix |
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `752b307670c9` |
| `v1283_b109_auc_autopsy_trace.csv` | `d8c623aba1f2` |
| `v1283_b109_fullstep_profile.csv` | `7e57de3efca7` |
...
| `v1283_b109_fused_backward_correctness.csv` | `48fe6fbe6408` |
| `v1283_b109_linec_coupling.csv` | `b4322ce731a0` |
| `v1283_b109_linec_diagnostics.csv` | `b705a4b735ea` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `54f23e72d6ba` |
| `v1283_b109_linec_noise_leak.csv` | `4b5b8749f4d9` |
| `v1283_b109_linec_signal_reservoir.csv` | `a4a1095f286d` |
| `v1283_b109_task_autopsy_final.csv` | `49e90a7c29b9` |
| `v1283_family_component_profile.csv` | `6ade851b1993` |
| `v1283_family_efficiency.csv` | `2dbb3a7ff379` |
| `v1283_family_expression.csv` | `9433feebfcaa` |
| `v1283_family_failure_table.csv` | `e81135e13cea` |
| `v1283_family_functional_diagnostic.csv` | `74c977e2a687` |
