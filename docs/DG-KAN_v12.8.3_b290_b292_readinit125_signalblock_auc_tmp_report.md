...
B109_A5_best_candidate = B290b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-readInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b290_b292_readinit125_signalblock_auc_short_20260522T054000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.2637000253284674` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8048736252171649` | `0.5966666666666667` | `1` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7650003389020288` | `0.5966666666666667` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.7207016342212567` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.6977725931713025` | `0.13` | `1` | `1` | `1` |
| `B290b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-readInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.0495319589504324` | `2.719047619047619` | `0` | `0` | `0` |
| `B290b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-readInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.6425180314185429` | `0.5961904761904762` | `1` | `1` | `1` |
| `B290b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-readInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.605950635647633` | `0.1295238095238095` | `1` | `1` | `1` |
| `B291b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock020-readInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.0734825171988989` | `2.719047619047619` | `0` | `0` | `0` |
| `B291b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock020-readInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.6786488619407084` | `0.5961904761904762` | `1` | `1` | `1` |
| `B291b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock020-readInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6386717374760528` | `0.1295238095238095` | `1` | `1` | `1` |
| `B292b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock020-readInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.19993494362681` | `2.719047619047619` | `0` | `0` | `0` |
...
| `B290b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-readInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.021484375` | `-0.0234375` | `0.8333333333333334` | `1` | `0` | `0` | `0` |
| `B291b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock020-readInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.014973958333333334` | `-0.02734375` | `0.8333333333333334` | `1` | `0` | `0` | `0` |
| `B292b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad040-signalBlock020-readInit125-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.018880208333333332` | `-0.02734375` | `0.8333333333333334` | `1` | `0` | `0` | `0` |
...
| `Chebyshev` | `KernelBlocked` | `3.298591615677635` | `1.3057693813432218` | `True` | `True` | `L3 manual analytic attempted; fused family-specific backward/update kernel missing` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L1-vectorized-or-stream-autograd` | `3.298591615677635` | `3.9695238095238095` | `0` | `0` | `measured` |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L3-analytic-manual-ce-torch-reduction` | `1.3057693813432218` | `2.308095238095238` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Chebyshev` | `B3c-ChebyKAN-K3-stream` | `L2_torch_compile_forward_attempt` | `1913.8064166970598` | `0` | `measured` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `efb6d4d002e4` |
| `v1283_b109_auc_autopsy_trace.csv` | `0809cfa74d81` |
| `v1283_b109_fullstep_profile.csv` | `3351a8d1f178` |
| `v1283_b109_functional_control_matrix.csv` | `2fa4a0a195de` |
| `v1283_b109_functional_direction_audit.csv` | `dff47ecf8224` |
| `v1283_b109_functional_five_step.csv` | `2529c5f89e88` |
| `v1283_b109_functional_one_step.csv` | `7bb7dc9fb8c1` |
| `v1283_b109_functional_route.json` | `77520e0d1239` |
| `v1283_b109_fused_backward_correctness.csv` | `90bfd50e7dc3` |
| `v1283_b109_linec_coupling.csv` | `1cd375b5b53b` |
| `v1283_b109_linec_diagnostics.csv` | `12fe385a0f4a` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `f12af667d011` |
| `v1283_b109_linec_noise_leak.csv` | `c0369d26a193` |
| `v1283_b109_linec_signal_reservoir.csv` | `b02beb3f6a81` |
| `v1283_b109_task_autopsy_final.csv` | `c4f6d73733f9` |
| `v1283_family_component_profile.csv` | `54f89399fbc0` |
| `v1283_family_efficiency.csv` | `203c41d1c516` |
| `v1283_family_expression.csv` | `62b9bdfdd290` |
| `v1283_family_failure_table.csv` | `79589c532d7c` |
