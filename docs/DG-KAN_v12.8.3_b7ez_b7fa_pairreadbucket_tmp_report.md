...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7ez_b7fa_pairreadbucket_hiddenbias_20260522T020000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.1524090195259133` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.762034680913995` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6950469837886563` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.7620616763458984` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.749852405410354` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `ExpressionBlocked` | `1.5257641308837155` | `1.0313344118049528` | `False` | `True` | `family-specific fused L3 efficiency passed but A4 expression failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7ez-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairReadBucketR136G64-crossZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.5257641308837155` | `0.7880952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7ez-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairReadBucketR136G64-crossZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.0313344118049528` | `0.7880952380952381` | `1` | `1` | `measured` |
| `Rational` | `B7fa-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairReadBucketR136G32-crossZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.6597037764627005` | `0.7738095238095238` | `0` | `0` | `measured` |
| `Rational` | `B7fa-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairReadBucketR136G32-crossZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.1919681044830304` | `0.7738095238095238` | `1` | `1` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7ez-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairReadBucketR136G64-crossZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7fa-RationalKAT-flashgroup-G16-h32-linearresGain19200-pairReadBucketR136G32-crossZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `49343ecfc675` |
| `v1283_b109_auc_autopsy_trace.csv` | `45cbfac30d5b` |
| `v1283_b109_fullstep_profile.csv` | `ce7011873302` |
...
| `v1283_b109_fused_backward_correctness.csv` | `8bdd045c1263` |
| `v1283_b109_linec_coupling.csv` | `9619438b6251` |
| `v1283_b109_linec_diagnostics.csv` | `b6c11a1a7d4d` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `5a13bb58c34d` |
| `v1283_b109_task_autopsy_final.csv` | `6a70caee7aec` |
| `v1283_family_component_profile.csv` | `63d3d512bc4b` |
| `v1283_family_efficiency.csv` | `96161baa301b` |
| `v1283_family_expression.csv` | `0e6ddeb4cc18` |
| `v1283_family_failure_table.csv` | `48e0da219f87` |
| `v1283_family_functional_diagnostic.csv` | `6c50f64f5afd` |
