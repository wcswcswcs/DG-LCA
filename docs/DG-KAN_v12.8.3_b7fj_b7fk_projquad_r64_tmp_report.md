...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7fj_b7fk_projquad_r64_20260522T025000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.3222229412065838` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8402554350571556` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.8208862779431724` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8627610159620723` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8477797096493351` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `1.4663712656159023` | `1.4431206850426803` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fj-RationalKAT-flashgroup-G16-h32-linearresGain19200-projBilinR64-bilinZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.4663712656159023` | `0.8395238095238096` | `0` | `0` | `measured` |
| `Rational` | `B7fj-RationalKAT-flashgroup-G16-h32-linearresGain19200-projBilinR64-bilinZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.4431206850426803` | `0.8395238095238096` | `0` | `0` | `measured` |
| `Rational` | `B7fk-RationalKAT-flashgroup-G16-h32-linearresGain19200-projSqR64-sqZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.5934310359944157` | `0.87` | `0` | `0` | `measured` |
| `Rational` | `B7fk-RationalKAT-flashgroup-G16-h32-linearresGain19200-projSqR64-sqZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.459303222209483` | `0.87` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7fj-RationalKAT-flashgroup-G16-h32-linearresGain19200-projBilinR64-bilinZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7fk-RationalKAT-flashgroup-G16-h32-linearresGain19200-projSqR64-sqZero-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `acf36746e5c0` |
| `v1283_b109_auc_autopsy_trace.csv` | `4fadd0d44e47` |
| `v1283_b109_fullstep_profile.csv` | `4a0a5002ba51` |
...
| `v1283_b109_fused_backward_correctness.csv` | `a549f7799752` |
| `v1283_b109_linec_coupling.csv` | `4224ea5d598c` |
| `v1283_b109_linec_diagnostics.csv` | `3b351131de41` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `e2ecb00f1426` |
| `v1283_b109_task_autopsy_final.csv` | `7a46ff2219fd` |
| `v1283_family_component_profile.csv` | `90261e0e551f` |
| `v1283_family_efficiency.csv` | `3d6e67285ee2` |
| `v1283_family_expression.csv` | `35836b53736c` |
| `v1283_family_failure_table.csv` | `91ed313f0f90` |
| `v1283_family_functional_diagnostic.csv` | `92858639d3f2` |
