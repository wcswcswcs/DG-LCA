...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7in_b7io_hiddenratresidual_20260522T150000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.4313167359227614` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.9847028213192756` | `0.5961904761904762` | `0` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.952292171585335` | `0.1295238095238095` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.0912098877046734` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.9417307939903536` | `0.13` | `0` | `1` | `1` |
...
| `Rational` | `TaskBlocked` | `0.95247346342001` | `0.9089805331578509` | `False` | `True` | `family-specific fused L3 efficiency and A4 expression passed; A5 fused task triage failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7in-RationalKAT-flashgroup-G16-h40-linearres-paircrossR136-readblocktriton-crossZero-b32-hiddenRatResidual050-freezeBackbone-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `0.95247346342001` | `0.9233333333333333` | `1` | `0` | `measured` |
| `Rational` | `B7in-RationalKAT-flashgroup-G16-h40-linearres-paircrossR136-readblocktriton-crossZero-b32-hiddenRatResidual050-freezeBackbone-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `0.9089805331578509` | `0.7861904761904762` | `1` | `1` | `measured` |
| `Rational` | `B7io-RationalKAT-flashgroup-G16-h32-linearres-paircrossR136-readblocktriton-crossZero-b32-hiddenRatResidual050-freezeBackbone-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `0.9655051146006942` | `0.92` | `1` | `0` | `measured` |
| `Rational` | `B7io-RationalKAT-flashgroup-G16-h32-linearres-paircrossR136-readblocktriton-crossZero-b32-hiddenRatResidual050-freezeBackbone-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `0.978814731642497` | `0.7714285714285715` | `1` | `1` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7in-RationalKAT-flashgroup-G16-h40-linearres-paircrossR136-readblocktriton-crossZero-b32-hiddenRatResidual050-freezeBackbone-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7io-RationalKAT-flashgroup-G16-h32-linearres-paircrossR136-readblocktriton-crossZero-b32-hiddenRatResidual050-freezeBackbone-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `f9e6c543579b` |
| `v1283_b109_auc_autopsy_trace.csv` | `177f5caaaeb5` |
| `v1283_b109_fullstep_profile.csv` | `fb2b3fcf143d` |
...
| `v1283_b109_fused_backward_correctness.csv` | `8bf2806d7385` |
| `v1283_b109_linec_coupling.csv` | `8c36607d56fe` |
| `v1283_b109_linec_diagnostics.csv` | `d3a93bd61c81` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `d9f0ec0dcd4b` |
| `v1283_b109_task_autopsy_final.csv` | `8fc54b537e2e` |
| `v1283_family_component_profile.csv` | `6f4b68f86296` |
| `v1283_family_efficiency.csv` | `ed5b7cf94d07` |
| `v1283_family_expression.csv` | `09d83281d195` |
| `v1283_family_failure_table.csv` | `21f557ee990f` |
| `v1283_family_functional_diagnostic.csv` | `919c79a9a7be` |
