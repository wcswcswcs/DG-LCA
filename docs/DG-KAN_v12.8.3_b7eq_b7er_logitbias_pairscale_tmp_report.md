...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7eq_b7er_logitbias_pairscale_20260522T005200Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.3288004584144668` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8408970009514981` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.8147553894908716` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8655909180690102` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8374868728196215` | `0.13` | `1` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `1.4974564126087564` | `1.318559468442145` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7eq-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-logitBias-L3` | `L1-vectorized-or-stream-autograd` | `1.4974564126087564` | `0.919047619047619` | `0` | `0` | `measured` |
| `Rational` | `B7eq-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-logitBias-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.318559468442145` | `0.7542857142857143` | `1` | `0` | `measured` |
| `Rational` | `B7er-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-readscale050-freezeBackbone-hiddenBias-logitBias-L3` | `L1-vectorized-or-stream-autograd` | `1.875728266017781` | `0.919047619047619` | `0` | `0` | `measured` |
| `Rational` | `B7er-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-readscale050-freezeBackbone-hiddenBias-logitBias-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.6227985771924658` | `0.7542857142857143` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7eq-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-freezeBackbone-hiddenBias-logitBias-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7er-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-readscale050-freezeBackbone-hiddenBias-logitBias-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `c74f1785ee0c` |
| `v1283_b109_auc_autopsy_trace.csv` | `3480278cf8c9` |
| `v1283_b109_fullstep_profile.csv` | `f4e88a444061` |
...
| `v1283_b109_fused_backward_correctness.csv` | `72186b0be217` |
| `v1283_b109_linec_coupling.csv` | `b663b2ca032d` |
| `v1283_b109_linec_diagnostics.csv` | `cd665ef7812e` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `4ae70ed61892` |
| `v1283_b109_task_autopsy_final.csv` | `aeb1786d5fe8` |
| `v1283_family_component_profile.csv` | `b1ab782dd361` |
| `v1283_family_efficiency.csv` | `9b493df6475f` |
| `v1283_family_expression.csv` | `d48fda1ea9b7` |
| `v1283_family_failure_table.csv` | `86806fa351f3` |
| `v1283_family_functional_diagnostic.csv` | `375300ef8432` |
