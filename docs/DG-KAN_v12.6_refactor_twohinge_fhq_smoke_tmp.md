...
artifact = results/v12_6_lowerlevel_fhq_functional_geometry/v126_refactor_twohinge_fhq_smoke_20260520T051000Z
...
| `B50b-SimpleFastTaskGeometry-h96-twohinge-temp075` | `torch-reference-simple-fast` | `4.233102866190502` | `0.0` | `0.0` | `0` |
| `B50b-SimpleFastTaskGeometry-h96-twohinge-temp075` | `FHQ0-triton-two-kernel-forward-exact-B48a` | `4.9642876407631755` | `4.76837158203125e-07` | `3.5554381838664995e-07` | `0` |
...
|---|---|---|---|---|---|---|
| `B50b-SimpleFastTaskGeometry-h96-twohinge-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.494193462439223` | `3.505238095238095` | `1` | `0` | `` |
| `B50b-SimpleFastTaskGeometry-h96-twohinge-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.5177883689334188` | `0.43476190476190474` | `1` | `0` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.036213305920392` | `0.09857142857142857` | `1` | `1` | `` |
...
| `B50b-SimpleFastTaskGeometry-h96-twohinge-temp075` | `F2-triton-learnableP-proj-grad` | `branch_scale` | `3.1215770945891563e-07` | `1.0000001192092896` | `1` | `` |
| `B50b-SimpleFastTaskGeometry-h96-twohinge-temp075` | `F2-triton-learnableP-proj-grad` | `logit_gain` | `2.1296260399594757e-07` | `1.0` | `1` | `` |
| `B50b-SimpleFastTaskGeometry-h96-twohinge-temp075` | `F2-triton-learnableP-proj-grad` | `bias` | `1.0169534903070598e-07` | `1.0` | `1` | `` |
...
|---|---|
| `v126_auc_attribution.csv` | `a12b2dee64c3` |
| `v126_candidate_manifest.csv` | `d346a1b688f3` |
| `v126_expression_audit.csv` | `5cbce502d26b` |
| `v126_expression_summary.csv` | `5de4081566cf` |
| `v126_failure_table.csv` | `4a7aff35f288` |
| `v126_frozen_readout.csv` | `1d383ed55397` |
| `v126_fullstep_profile.csv` | `0703179ab634` |
...
| `v126_fused_backward_correctness.csv` | `fe554d7bc6fe` |
| `v126_fused_forward_profile.csv` | `1e917b1d0c6d` |
