...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b257_rational_b7gt_b7gu_hiddensqcenter_20260522T180000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.5767380144142356` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.1727740281365124` | `0.5961904761904762` | `0` | `1` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9443087843376234` | `0.1295238095238095` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `1.0519438904621101` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `1.0000214576618873` | `0.13` | `0` | `1` | `1` |
...
| `Rational` | `KernelBlocked` | `1.9262634193292567` | `1.7846495186947087` | `False` | `True` | `family-specific fused L3 kernel exists, but full-step efficiency gate failed` | `False` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Rational` | `B7gt-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-hiddenSqCenter-hiddenSqScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.9478974736697032` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7gt-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-hiddenSqCenter-hiddenSqScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.7846495186947087` | `0.7747619047619048` | `0` | `0` | `measured` |
| `Rational` | `B7gu-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-hiddenSqCenter-hiddenSqScale075-freezeBackbone-hiddenBias-manualAdamW-L3` | `L1-vectorized-or-stream-autograd` | `1.9262634193292567` | `0.9180952380952381` | `0` | `0` | `measured` |
| `Rational` | `B7gu-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-hiddenSqCenter-hiddenSqScale075-freezeBackbone-hiddenBias-manualAdamW-L3` | `L3-analytic-manual-ce-torch-reduction` | `1.8001432449499941` | `0.7747619047619048` | `0` | `0` | `measured` |

## 6. L2 Component Profile

| family | candidate_id | component | ratio_vs_mlp_forward_q90 | official_l2_kernel | status |
| --- | --- | --- | --- | --- | --- |
| `Rational` | `B7gt-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-hiddenSqCenter-hiddenSqScale050-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
| `Rational` | `B7gu-RationalKAT-flashgroup-G16-h32-linearresGain19200-paircrossR136-readblocktriton-crossZero-b32-hiddenSqReadoutZero-hiddenSqCenter-hiddenSqScale075-freezeBackbone-hiddenBias-manualAdamW-L3` | `L2_torch_compile_forward_attempt` | `` | `0` | `failed` |
...
| `v1283_family_expression.csv` | `2` | `0` | `0` | `0` | `1` |
| `v1283_family_failure_table.csv` | `2` | `0` | `0` | `0` | `1` |
| `v1283_family_functional_diagnostic.csv` | `2` | `0` | `0` | `0` | `1` |

Selected hashes:

| artifact | sha256_prefix |
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `ff05a8a03bf0` |
| `v1283_b109_auc_autopsy_trace.csv` | `3c1cf055c561` |
| `v1283_b109_fullstep_profile.csv` | `0e11c9078bde` |
...
| `v1283_b109_fused_backward_correctness.csv` | `e19ac0d7bae3` |
| `v1283_b109_linec_coupling.csv` | `41d66e12879a` |
| `v1283_b109_linec_diagnostics.csv` | `14b7d2d5d80e` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `6c7d5abc0898` |
| `v1283_b109_linec_noise_leak.csv` | `a03436cf0bab` |
| `v1283_b109_linec_signal_reservoir.csv` | `84be28b6df6e` |
| `v1283_b109_task_autopsy_final.csv` | `8190cecdc6c6` |
| `v1283_family_component_profile.csv` | `42e8c1832e2e` |
| `v1283_family_efficiency.csv` | `38745b2920c5` |
| `v1283_family_expression.csv` | `da7b7f512d12` |
| `v1283_family_failure_table.csv` | `ddfe6555e360` |
| `v1283_family_functional_diagnostic.csv` | `de49ef0d9453` |
