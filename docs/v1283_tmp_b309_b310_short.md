...
B109_A5_best_candidate = B309b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp100-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b309_b310_directramp_short_20260522T084500Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.4678198956371824` | `2.7185714285714284` | `0` | `0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `1.0043445284156869` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9223473329857038` | `0.5966666666666667` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8935033288719758` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.8968663250214916` | `0.13` | `0` | `1` | `1` |
| `B309b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp100-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.2466192099474673` | `2.719047619047619` | `0` | `0` | `0` |
| `B309b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp100-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8093051415722624` | `0.5961904761904762` | `1` | `1` | `1` |
| `B309b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp100-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7604832598387691` | `0.1295238095238095` | `1` | `1` | `1` |
| `B310b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp115-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.2074448301117728` | `2.719047619047619` | `0` | `0` | `0` |
| `B310b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp115-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7923719071426297` | `0.5961904761904762` | `1` | `1` | `1` |
...
| `B309b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp100-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.033854166666666664` | `0.0` | `1.0` | `1` | `1` | `1` | `1` |
| `B310b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad035-signalBlock015-quadReadInit125-directRamp115-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.032552083333333336` | `0.0` | `1.0` | `1` | `1` | `1` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `3fbfecb9f0ed` |
| `v1283_b109_auc_autopsy_trace.csv` | `972317124e7a` |
| `v1283_b109_fullstep_profile.csv` | `f8781b301dd0` |
| `v1283_b109_functional_control_matrix.csv` | `0e2136d43f9d` |
| `v1283_b109_functional_direction_audit.csv` | `d02ed3ea3146` |
| `v1283_b109_functional_five_step.csv` | `a71e5cc33d08` |
| `v1283_b109_functional_one_step.csv` | `a73342a7d331` |
| `v1283_b109_functional_route.json` | `c06e194ce6fe` |
| `v1283_b109_fused_backward_correctness.csv` | `eeb1f6fc7fd5` |
| `v1283_b109_linec_coupling.csv` | `20ad8a5f834a` |
| `v1283_b109_linec_diagnostics.csv` | `e7e07c6b53e8` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `122c1e9f4b23` |
| `v1283_b109_linec_noise_leak.csv` | `10f373aa2b4b` |
| `v1283_b109_linec_signal_reservoir.csv` | `ff8e26ff31b0` |
| `v1283_b109_task_autopsy_final.csv` | `748f9cdc9ce1` |
