...
artifact = results/v12_6_lowerlevel_fhq_functional_geometry/v126_b109_h160_absdiag050_classbranch_classgain_identitytailquad030_hingeamp025_f3_workspace_final025_protocolfix_20260520T211000Z
...
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `torch-reference-simple-fast` | `5.265917362823569` | `0.0` | `0.0` | `0` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `FHQ-triton-two-kernel-forward` | `2.6668532153412965` | `7.152557373046875e-07` | `3.271443915764394e-07` | `0` |
...
|---|---|---|---|---|---|---|
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.4398232355459297` | `2.7185714285714284` | `1` | `0` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.8531056287333151` | `0.5966666666666667` | `1` | `1` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.8765515598612795` | `0.5966666666666667` | `1` | `1` | `` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.7732715393927079` | `0.13` | `1` | `1` | `` |
...
|---|---|---|---|---|---|---|
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `direct_readout` | `9.079624874175352e-08` | `1.0` | `1` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `quad_proj` | `1.04654525046044e-07` | `0.9999998807907104` | `1` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `quad_readout` | `6.650651585005107e-08` | `0.9999998807907104` | `1` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `branch_scale` | `1.0246331072494286e-07` | `1.0` | `1` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `logit_gain` | `7.026348924910053e-08` | `1.0` | `1` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `bias` | `4.598686942358654e-08` | `1.0` | `1` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-learnableP-proj-grad` | `direct_readout` | `0.0007360783056356013` | `0.9999999403953552` | `1` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-learnableP-proj-grad` | `quad_proj` | `0.001492111012339592` | `1.0` | `1` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-learnableP-proj-grad` | `quad_readout` | `0.0007631804328411818` | `1.0` | `1` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-learnableP-proj-grad` | `branch_scale` | `8.285705916932784e-07` | `1.0` | `1` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-learnableP-proj-grad` | `logit_gain` | `7.129621621970728e-07` | `1.0` | `1` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-learnableP-proj-grad` | `bias` | `7.75185426959979e-08` | `1.0000001192092896` | `1` | `` |
...
|---|---|---|---|---|
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `1` | `1` | `` | `` |
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `1` | `1` | `` | `` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `1` | `1` | `` | `` |
...
|---|---|---|---|---|---|---|---|---|---|
| `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `0.003472222222222222` | `-0.015625` | `0.7777777777777778` | `1` | `0` | `0` | `0` | `` | `` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `-0.15928819444444445` | `-0.2109375` | `0.0` | `0` | `0` | `0` | `0` | `` | `` |
...
|---|---|---|---|
| `A5_task_gate_fail` | `B109b-SimpleFastTaskGeometry-h160-learnableP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `` | `if AUC-step fails return to Line P/C; if AUC-step passes and AUC-time fails return to Line A` |
| `A5_task_gate_fail` | `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `` | `if AUC-step fails return to Line P/C; if AUC-step passes and AUC-time fails return to Line A` |
...
|---|---|
| `v126_auc_attribution.csv` | `d231b59faccb` |
| `v126_candidate_manifest.csv` | `1e401d570ba3` |
| `v126_expression_audit.csv` | `5f5d446bbe23` |
| `v126_expression_summary.csv` | `9fccc87965cf` |
| `v126_failure_table.csv` | `fbc24913f793` |
| `v126_frozen_readout.csv` | `d159f8052622` |
| `v126_fullstep_profile.csv` | `f4c5dbc67759` |
...
| `v126_fused_backward_correctness.csv` | `ee422c33e7cc` |
| `v126_fused_forward_profile.csv` | `993db05fdeed` |
