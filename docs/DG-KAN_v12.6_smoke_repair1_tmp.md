...
artifact = results/v12_6_lowerlevel_fhq_functional_geometry/v126_smoke_repair1_20260520T000500Z
...
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `torch-reference-simple-fast` | `4.377886794796162` | `0.0` | `0.0` | `0` |
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `FHQ0-triton-two-kernel-forward-exact-B48a` | `1.4610053715030893` | `3.5762786865234375e-07` | `2.9702863457714557e-07` | `0` |
...
|---|---|---|---|---|---|---|
| `B48a-SimpleFastTaskGeometry-h128-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.2315088961507126` | `1.001972304689933` | `1` | `0` | `` |
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8140417960608789` | `0.9087757178151016` | `1` | `0` | `` |
...
| `B51a-SimpleFastTaskGeometry-h128-fixedP-temp075` | `F1-triton-fixedP-readout-grad` | `bias` | `6.149948461597887e-08` | `1.0` | `1` | `` |
...
| `v126_candidate_manifest.csv` | `a8bce69a0839` |
| `v126_expression_audit.csv` | `b0999fdf5812` |
| `v126_failure_table.csv` | `433e200bf0e9` |
| `v126_fullstep_profile.csv` | `7317ac8574ba` |
...
| `v126_fused_backward_correctness.csv` | `bc13e1540a90` |
| `v126_fused_forward_profile.csv` | `e8f1c6febb49` |
| `v126_manifold_channel_diagnostics.csv` | `ea684b9fcb68` |
