...
B109_A5_best_candidate = B265b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock025-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090
...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b265_b266_signalblock_short_20260522T050015Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.230594253474676` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7774819218559599` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7293876612020357` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8224267262023085` | `0.13` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.7840763004090894` | `0.13` | `1` | `1` | `1` |
| `B265b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock025-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.5087778516632462` | `2.719047619047619` | `0` | `0` | `0` |
| `B265b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock025-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.9568426840785016` | `0.5961904761904762` | `0` | `1` | `1` |
| `B265b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock025-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.9053654145758632` | `0.1295238095238095` | `0` | `1` | `1` |
| `B266b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock050-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `B48a-existing-manual-ce-torch-reduction` | `1.1454002201413784` | `2.719047619047619` | `0` | `0` | `0` |
| `B266b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock050-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7272395695584303` | `0.5961904761904762` | `1` | `1` | `1` |
| `B266b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock050-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6962484479488427` | `0.1295238095238095` | `1` | `1` | `1` |
...
| `B265b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock025-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.025390625` | `-0.015625` | `0.8333333333333334` | `1` | `1` | `1` | `0` |
| `B266b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-signalBroad050-signalBlock050-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp090` | `0.01953125` | `-0.01953125` | `0.8333333333333334` | `1` | `1` | `1` | `0` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `92db18324ebe` |
| `v1283_b109_auc_autopsy_trace.csv` | `2ccbafbf9f97` |
| `v1283_b109_fullstep_profile.csv` | `e9dd6a5ee1ef` |
| `v1283_b109_functional_control_matrix.csv` | `d0a2879d6455` |
| `v1283_b109_functional_direction_audit.csv` | `3fa9b9cdd7e9` |
| `v1283_b109_functional_five_step.csv` | `cbb2e5bd0f8f` |
| `v1283_b109_functional_one_step.csv` | `3b5530133191` |
| `v1283_b109_functional_route.json` | `7a12e739f701` |
| `v1283_b109_fused_backward_correctness.csv` | `1ad6df18277c` |
| `v1283_b109_linec_coupling.csv` | `3105242a22c5` |
| `v1283_b109_linec_diagnostics.csv` | `b52f39044bf8` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `08a60f2cd076` |
| `v1283_b109_linec_noise_leak.csv` | `8eb756052e72` |
| `v1283_b109_linec_signal_reservoir.csv` | `62d7fb89eede` |
| `v1283_b109_task_autopsy_final.csv` | `bbf3e9334808` |
