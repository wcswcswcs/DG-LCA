...
artifact = results/v12_8_3_b109_classic_family_functional_geometry/v1283_b109_b230_b231_trainprobe_centroid_20260523T011000Z
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `B48a-existing-manual-ce-torch-reduction` | `1.2132035259731242` | `2.719047619047619` | `0` | `0` | `0` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7840264651765165` | `0.5961904761904762` | `1` | `1` | `1` |
| `B257b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-fixedgain-gainramp075-identitytailquad030-hingeamp025-temp095` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7517723448059865` | `0.1295238095238095` | `1` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F1-triton-forward-delta-readout-grad-fixedP` | `0.8510476373804315` | `0.13` | `0` | `1` | `1` |
| `B109a-SimpleFastTaskGeometry-h160-fixedP-absdiag050-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F4-triton-workspace-forward-delta-readout-grad-fixedP` | `0.790392892625359` | `0.13` | `1` | `1` | `1` |
| `B230b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct025-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.2878168202071654` | `2.7185714285714284` | `0` | `0` | `0` |
| `B230b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct025-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.765385945527827` | `0.5966666666666667` | `1` | `1` | `1` |
| `B230b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct025-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.7749607422581809` | `0.13` | `1` | `1` | `1` |
| `B231b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `B48a-existing-manual-ce-torch-reduction` | `1.1351388628486065` | `2.7185714285714284` | `0` | `0` | `0` |
| `B231b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F2-triton-forward-delta-readout-proj-grad-learnableP` | `0.7143858550792024` | `0.5966666666666667` | `1` | `1` | `1` |
| `B231b-SimpleFastTaskGeometry-h160-learnableP-trainProbeP-direct050-fusedProjGradAdamW-absdiag050-manualAdamW-classbranch-classgain-identitytailquad030-hingeamp025-temp075` | `F3-triton-workspace-forward-delta-readout-proj-grad-learnableP` | `0.6918858709369353` | `0.13` | `1` | `1` | `1` |
...
| --- | --- |
| `v1283_b109_auc_attribution.csv` | `61b56676e0f8` |
| `v1283_b109_auc_autopsy_trace.csv` | `42cb8249a9d5` |
| `v1283_b109_fullstep_profile.csv` | `a616f8b614ba` |
| `v1283_b109_functional_control_matrix.csv` | `a9cac846e069` |
| `v1283_b109_functional_direction_audit.csv` | `b2c1676579db` |
| `v1283_b109_functional_five_step.csv` | `f85217d6aacf` |
| `v1283_b109_functional_one_step.csv` | `995ee2e274e5` |
| `v1283_b109_functional_route.json` | `f57b48d161e6` |
| `v1283_b109_fused_backward_correctness.csv` | `8bbedc61976a` |
| `v1283_b109_linec_coupling.csv` | `0b2471db79b8` |
| `v1283_b109_linec_diagnostics.csv` | `5e85be94e813` |
| `v1283_b109_linec_functional_reentry_summary.csv` | `16cd635b6f45` |
| `v1283_b109_linec_noise_leak.csv` | `6e05b8274a34` |
| `v1283_b109_linec_signal_reservoir.csv` | `eebacd6651d4` |
| `v1283_b109_task_autopsy_final.csv` | `b3405c761e78` |
